 ...
 ** ------------------------------------------------------------------------------------------------------------- */
void CompressedCarryManager::writeCurrentCarryOutSummary(BuilderRef b) {
 ...
 * @brief analyse
 ** ------------------------------------------------------------------------------------------------------------- */
StructType * CompressedCarryManager::analyse(BuilderRef b, const PabloBlock * const entryScope) {
