...
PabloSourceKernel::PabloSourceKernel(VirtualDriver &driver,
...
: PabloKernel(driver, std::string(kernelName), inputStreamBindings, outputStreamBindings, inputScalarBindings, outputScalarBindings)
, mParser(parser)
, mSource(sourceFile)
