...
namespace UCD {
  namespace BLK_ns {
    const unsigned independent_prop_values = 329;
    /** Code Point Ranges for NB
    [2fe0, 2fef], [10200, 1027f], [103e0, 103ff], [105c0, 105ff],
    [107c0, 107ff], [108b0, 108df], [10940, 1097f], [10aa0, 10abf],
    [10bb0, 10bff], [10c50, 10c7f], [10d40, 10e5f], [11250, 1127f],
    [11380, 113ff], [114e0, 1157f], [116d0, 116ff], [11750, 117ff],
    [11850, 1189f], [11960, 1199f], [11b60, 11bff], [11cc0, 11cff],
    [11db0, 11edf], [11f60, 11faf], [12550, 12f8f], [13460, 143ff],
    [14680, 167ff], [16b90, 16e3f], [16ea0, 16eff], [16fa0, 16fdf],
    [18d80, 1afef], [1b300, 1bbff], [1bcb0, 1ceff], [1cfd0, 1cfff],
    [1d250, 1d2bf], [1d380, 1d3ff], [1dab0, 1deff], [1e090, 1e0ff],
    [1e150, 1e28f], [1e300, 1e4cf], [1e500, 1e7df], [1e8e0, 1e8ff],
    ...
    {Full, 1}, {Empty, 14}, {Full, 2}, {Empty, 14}, {Full, 2}, {Empty, 5},
    {Mixed, 1}, {Full, 1}, {Empty, 3}, {Full, 2}, {Empty, 9}, {Full, 1},
    {Empty, 7}, {Mixed, 1}, {Full, 2}, {Empty, 2}, {Mixed, 1}, {Full, 1},
    {Empty, 6}, {Full, 9}, {Empty, 31}, {Mixed, 1}, {Full, 1}, {Empty, 8},
    {Full, 4}, {Empty, 7}, {Full, 5}, {Empty, 10}, {Mixed, 1}, {Full, 1},
    {Empty, 2}, {Mixed, 1}, {Full, 5}, {Empty, 2}, {Mixed, 1}, {Full, 2},
    {Empty, 6}, {Full, 2}, {Empty, 14}, {Full, 5}, {Empty, 6}, {Full, 2},
    {Empty, 5}, {Mixed, 1}, {Full, 9}, {Empty, 4}, {Full, 2}, {Mixed, 1},
    {Empty, 44}, {Mixed, 1}, {Full, 81}, {Mixed, 1}, {Empty, 38},
    {Full, 125}, {Empty, 20}, {Full, 268}, {Empty, 28}, {Mixed, 1},
    {Full, 21}, {Empty, 3}, {Full, 3}, {Empty, 5}, {Full, 2}, {Empty, 237},
    {Full, 275}, {Mixed, 1}, {Empty, 24}, {Full, 72}, {Empty, 5},
    {Mixed, 1}, {Full, 146}, {Empty, 6}, {Mixed, 1}, {Full, 1}, {Empty, 18},
    {Mixed, 1}, {Full, 3}, {Empty, 6}, {Full, 4}, {Empty, 53}, {Mixed, 1},
    {Full, 34}, {Empty, 12}, {Mixed, 1}, {Full, 3}, {Empty, 2}, {Mixed, 1},
    {Full, 9}, {Mixed, 1}, {Empty, 3}, {Full, 14}, {Mixed, 1}, {Empty, 1},
    {Full, 23}, {Empty, 8}, {Full, 1}, {Empty, 3}, {Full, 24}, {Mixed, 1},
    {Empty, 2}, {Full, 2}, {Empty, 2}, {Mixed, 1}, {Full, 5}, {Empty, 8},
    {Full, 8}, {Empty, 96}, {Full, 32}, {Empty, 1335}, {Full, 1},
    {Empty, 571}, {Full, 77}, {Empty, 17}, {Full, 47}, {Empty, 285},
    {Mixed, 1}, {Full, 22242}, {Empty, 4}, {Full, 4}, {Empty, 7},
    ...
    0xffff0000, 0xffff0000, 0x0000ffff, 0x0000ffff, 0x0000ffff, 0xffff0000,
    0xffff0000, 0xffff0000};
    }

    const static UnicodeSet nb_Set{const_cast<UnicodeSet::run_t *>(__nb_Set_runs), 128, 0, const_cast<UnicodeSet::bitquad_t *>(__nb_Set_quads), 26, 0};
    ...
    static EnumeratedPropertyObject property_object
        ...
        &linear_a_Set, &latin_ext_f_Set, &cypriot_syllabary_Set,
        &imperial_aramaic_Set, &palmyrene_Set, &nabataean_Set, &hatran_Set,
        &phoenician_Set, &lydian_Set, &meroitic_hieroglyphs_Set,
        &meroitic_cursive_Set, &kharoshthi_Set, &old_south_arabian_Set,
        &old_north_arabian_Set, &manichaean_Set, &avestan_Set,
        &inscriptional_parthian_Set, &inscriptional_pahlavi_Set,
        &psalter_pahlavi_Set, &old_turkic_Set, &old_hungarian_Set,
        &hanifi_rohingya_Set, &rumi_Set, &yezidi_Set, &arabic_ext_c_Set,
        &old_sogdian_Set, &sogdian_Set, &old_uyghur_Set, &chorasmian_Set,
        &elymaic_Set, &brahmi_Set, &kaithi_Set, &sora_sompeng_Set,
        &chakma_Set, &mahajani_Set, &sharada_Set,
        ...
        &warang_citi_Set, &dives_akuru_Set, &nandinagari_Set,
        &zanabazar_square_Set, &soyombo_Set, &ucas_ext_a_Set,
        &pau_cin_hau_Set, &devanagari_ext_a_Set, &bhaiksuki_Set,
        &marchen_Set, &masaram_gondi_Set, &gunjala_gondi_Set, &makasar_Set,
        &kawi_Set, &lisu_sup_Set, &tamil_sup_Set, &cuneiform_Set,
        ...
        &anatolian_hieroglyphs_Set, &bamum_sup_Set, &mro_Set, &tangsa_Set,
        &bassa_vah_Set, &pahawh_hmong_Set, &medefaidrin_Set, &miao_Set,
        &ideographic_symbols_Set, &tangut_Set, &tangut_components_Set,
        &khitan_small_script_Set, &tangut_sup_Set, &kana_ext_b_Set,
        &kana_sup_Set, &kana_ext_a_Set, &small_kana_ext_Set, &nushu_Set,
        &duployan_Set, &shorthand_format_controls_Set, &znamenny_music_Set,
        ...
        &nag_mundari_Set, &ethiopic_ext_b_Set, &mende_kikakui_Set,
        &adlam_Set, &indic_siyaq_numbers_Set, &ottoman_siyaq_numbers_Set,
        &arabic_math_Set, &mahjong_Set, &domino_Set, &playing_cards_Set,
        ...
        &chess_symbols_Set, &symbols_and_pictographs_ext_a_Set,
