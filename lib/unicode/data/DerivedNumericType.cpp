...
namespace UCD {
  namespace NT_ns {
    ...
    [11daa, 11f4f], [11f5a, 11fbf], [11fd5, 123ff], [1246f, 16a5f],
    [16a6a, 16abf], [16aca, 16b4f], [16b5a, 16b5a], [16b62, 16e7f],
    [16e97, 1d2bf], [1d2d4, 1d2df], [1d2f4, 1d35f], [1d379, 1d7cd],
    [1d800, 1e13f], [1e14a, 1e2ef], [1e2fa, 1e4ef], [1e4fa, 1e8c6],
    ...
    {Full, 1}, {Mixed, 1}, {Full, 9}, {Mixed, 1}, {Full, 4}, {Mixed, 3},
    ...
    {Full, 3}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 13}, {Mixed, 1},
    {Full, 2}, {Mixed, 1}, {Full, 23}, {Mixed, 2}, {Full, 6}, {Mixed, 1},
    {Full, 2}, {Mixed, 1}, {Full, 12}, {Mixed, 1}, {Full, 3}, {Mixed, 1},
    {Full, 33}, {Empty, 3}, {Mixed, 1}, {Full, 559}, {Mixed, 1}, {Full, 2},
    {Mixed, 1}, {Full, 3}, {Mixed, 2}, {Full, 24}, {Mixed, 1}, {Full, 801},
    {Mixed, 2}, {Full, 3}, {Mixed, 1}, {Full, 34}, {Mixed, 1}, {Empty, 1},
    {Full, 74}, {Mixed, 1}, {Full, 12}, {Mixed, 1}, {Full, 15}, {Mixed, 1},
    {Full, 30}, {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 24}, {Mixed, 1},
    ...
    0x00ffffff, 0x00ffffff, 0xffff01ff, 0x03ffffff, 0xfc00ffff, 0x80000000,
    0x1fffffff, 0xffffff80, 0xffe1ffff, 0xfffff01f, 0x0003ffff, 0xffff0000,
    0xfc00ffff, 0x003fffff, 0xfc00ffff, 0xffe00001, 0xfc00ffff, 0xfc00ffff,
    0xfc00ffff, 0xfc00ffff, 0xfffffc00, 0xf000ffff, 0xfff80000, 0xfc00ffff,
    0x0000ffff, 0xffffe000, 0xfc00ffff, 0xfffffc00, 0xfc00ffff, 0xffe00000,
    0xffff8000, 0xfffffc00, 0xfffffc00, 0x0400ffff, 0xfffffffc, 0xff800000,
    0xfff00000, 0xfff00000, 0xfe000000, 0x00003fff, 0xfffffc00, 0xfc00ffff,
    0xfc00ffff, 0xffff007f, 0xfc00ffff, 0x0001ffff, 0xffe11000, 0x00000001,
    0xc0004000, 0xffffe000, 0xfc00ffff, 0xfffffffd, 0xffffffef, 0xfffffffb,
    0xfffffffd, 0xfffffbff, 0xefffeff7, 0xdffffbff, 0xfdffffff, 0xfffeffff,
    0xfeffffff, 0xf7ffffff, 0xffffdfff, 0xfffeffff};
    }

    const static UnicodeSet none_Set{const_cast<UnicodeSet::run_t *>(__none_Set_runs), 303, 0, const_cast<UnicodeSet::bitquad_t *>(__none_Set_quads), 190, 0};
    ...
    const static UnicodeSet de_Set{const_cast<UnicodeSet::run_t *>(__de_Set_runs), 122, 0, const_cast<UnicodeSet::bitquad_t *>(__de_Set_quads), 62, 0};
