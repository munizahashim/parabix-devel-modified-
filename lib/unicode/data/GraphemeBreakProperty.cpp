...
namespace UCD {
  namespace GCB_ns {
    ...
    [0892, 0897], [08a0, 08c9], [0904, 0939], [093d, 093d], [0950, 0950],
    ...
    [0d4f, 0d56], [0d58, 0d61], [0d64, 0d80], [0d84, 0dc9], [0dcb, 0dce],
    [0dd5, 0dd5], [0dd7, 0dd7], [0de0, 0df1], [0df4, 0e30], [0e32, 0e32],
    [0e3b, 0e46], [0e4f, 0eb0], [0eb2, 0eb2], [0ebd, 0ec7], [0ece, 0f17],
    [0f1a, 0f34], [0f36, 0f36], [0f38, 0f38], [0f3a, 0f3d], [0f40, 0f70],
    [0f85, 0f85], [0f88, 0f8c], [0f98, 0f98], [0fbd, 0fc5], [0fc7, 102c],
    [1038, 1038], [103f, 1055], [105a, 105d], [1061, 1070], [1075, 1081],
    [1083, 1083], [1087, 108c], [108e, 109c], [109e, 10ff], [1200, 135c],
    [1360, 1711], [1716, 1731], [1735, 1751], [1754, 1771], [1774, 17b3],
    [17d4, 17dc], [17de, 180a], [1810, 1884], [1887, 18a8], [18aa, 191f],
    [192c, 192f], [193c, 1a16], [1a1c, 1a54], [1a5f, 1a5f], [1a61, 1a61],
    [1a63, 1a64], [1a7d, 1a7e], [1a80, 1aaf], [1acf, 1aff], [1b05, 1b33],
    [1b45, 1b6a], [1b74, 1b7f], [1b83, 1ba0], [1bae, 1be5], [1bf4, 1c23],
    [1c38, 1ccf], [1cd3, 1cd3], [1ce9, 1cec], [1cee, 1cf3], [1cf5, 1cf6],
    [1cfa, 1dbf], [1e00, 200a], [2010, 2027], [202f, 205f], [2070, 20cf],
    [20f1, 2cee], [2cf2, 2d7e], [2d80, 2ddf], [2e00, 3029], [3030, 3098],
    [309b, a66e], [a673, a673], [a67e, a69d], [a6a0, a6ef], [a6f2, a801],
    [a803, a805], [a807, a80a], [a80c, a822], [a828, a82b], [a82d, a87f],
    [a882, a8b3], [a8c6, a8df], [a8f2, a8fe], [a900, a925], [a92e, a946],
    [a954, a95f], [a97d, a97f], [a984, a9b2], [a9c1, a9e4], [a9e6, aa28],
    [aa37, aa42], [aa44, aa4b], [aa4e, aa7b], [aa7d, aaaf], [aab1, aab1],
    [aab5, aab6], [aab9, aabd], [aac0, aac0], [aac2, aaea], [aaf0, aaf4],
    [aaf7, abe2], [abeb, abeb], [abee, abff], [d7a4, d7af], [d7c7, d7ca],
    [d7fc, fb1d], [fb1f, fdff], [fe10, fe1f], [fe30, fefe], [ff00, ff9d],
    [ffa0, ffef], [fffc, 101fc], [101fe, 102df], [102e1, 10375],
    [1037b, 10a00], [10a04, 10a04], [10a07, 10a0b], [10a10, 10a37],
    [10a3b, 10a3e], [10a40, 10ae4], [10ae7, 10d23], [10d28, 10eaa],
    [10ead, 10f45], [10f51, 10f81], [10f86, 10fff], [11003, 11037],
    [11047, 1106f], [11071, 11072], [11075, 1107e], [11083, 110af],
    [110bb, 110bc], [110be, 110c1], [110c3, 110cc], [110ce, 110ff],
    [11103, 11126], [11135, 11144], [11147, 11172], [11174, 1117f],
    [11183, 111b2], [111c1, 111c1], [111c4, 111c8], [111cd, 111cd],
    [111d0, 1122b], [11238, 1123d], [1123f, 112de], [112eb, 112ff],
    ...
    [116b8, 1171c], [11720, 11721], [1172c, 1182b], [1183b, 1192f],
    [11936, 11936], [11939, 1193a], [11944, 119d0], [119d8, 119d9],
    [119e1, 119e3], [119e5, 11a00], [11a0b, 11a32], [11a3f, 11a46],
    [11a48, 11a50], [11a5c, 11a83], [11a9a, 11c2e], [11c37, 11c37],
    [11c40, 11c91], [11ca8, 11ca8], [11cb7, 11d30], [11d37, 11d39],
    [11d3b, 11d3b], [11d3e, 11d3e], [11d48, 11d89], [11d8f, 11d8f],
    [11d92, 11d92], [11d98, 11ef2], [11ef7, 1342f], [13439, 16aef],
    [16af5, 16b2f], [16b37, 16f4e], [16f50, 16f50], [16f88, 16f8e],
    ...
    [1e022, 1e022], [1e025, 1e025], [1e02b, 1e12f], [1e137, 1e2ad],
    [1e2af, 1e2eb], [1e2f0, 1e8cf], [1e8d7, 1e943], [1e94b, 1f1e5],
    [1f200, 1f3fa], [1f400, dffff], [e1000, 10ffff]**/
    ...
    {Mixed, 1}, {Full, 17}, {Mixed, 1}, {Full, 11}, {Mixed, 1}, {Full, 4},
    {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 3}, {Mixed, 7}, {Full, 1},
    {Mixed, 7}, {Full, 2}, {Mixed, 1}, {Full, 4}, {Mixed, 6}, {Full, 5},
    ...
    {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 10}, {Mixed, 1}, {Full, 169},
    {Mixed, 1}, {Full, 437}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 32},
    {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 612},
    {Mixed, 2}, {Full, 146}, {Empty, 1}, {Mixed, 2}, {Full, 16}, {Mixed, 3},
    {Full, 4}, {Mixed, 1}, {Full, 61}, {Empty, 1}, {Mixed, 1}, {Empty, 1},
    {Mixed, 3}, {Full, 42}, {Mixed, 2}, {Full, 7}, {Mixed, 1}, {Full, 11},
    {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 46}, {Mixed, 1}, {Full, 3},
    ...
    0xffffc110, 0xf1ffffff, 0x00fcffff, 0x000003ff, 0xfffffff0, 0x23ffffff,
    ...
    0xfffffff3, 0xfffffff1, 0x2fffffff, 0xff9fc220, 0xfffffff3, 0xfffffff0,
    0x27ffffff, 0xff7f8220, 0xfffffff3, 0xfffffff1, 0x00a07bff, 0xfff3ffff,
    0xf805ffff, 0xffff807f, 0xe005ffff, 0xffffc0ff, 0xfcffffff, 0x3d5fffff,
    ...
    0xffffffc3, 0xfffffff8, 0x00ffffff, 0xffffff80, 0x7fe6ffff, 0xfffffff8,
    0xd800ffff, 0xffffdffb, 0xfffffff8, 0xffe0007f, 0xffffff9f, 0xfff7ffff,
    0xfffffff8, 0x0007ffff, 0xffff21f2, 0xbf000fff, 0x7fffffff, 0xfffff800,
    0xfffffff0, 0x27ffffff, 0xff7fc660, 0xffe0e033, 0x001fffff, 0xbfffff80,
    ...
    0xff87ffff, 0xfe00ffff, 0xffe0ffff, 0xff80ffff, 0x00017fff, 0xfff87f00,
    0xfffcffef, 0x9fffffff, 0xfffffff0, 0x0000c000, 0xffffff80, 0x00001c1f,
    0xfffff018, 0xffffc3ff, 0xffffffe3, 0x07800000, 0xffdfe000, 0x07ffffef,
    0xffff0001, 0x06000080, 0xfffff824, 0xff80ffff, 0xffffbfff, 0xffff0fff,
    0xff80ffff, 0xfffff80f, 0x0000003f, 0x07ffffff};
    }

    const static UnicodeSet xx_Set{const_cast<UnicodeSet::run_t *>(__xx_Set_runs), 217, 0, const_cast<UnicodeSet::bitquad_t *>(__xx_Set_quads), 226, 0};

    /** Code Point Ranges for PP
    [0600, 0605], [06dd, 06dd], [070f, 070f], [0890, 0891], [08e2, 08e2],
    [0d4e, 0d4e], [110bd, 110bd], [110cd, 110cd], [111c2, 111c3],
    [1193f, 1193f], [11941, 11941], [11a3a, 11a3a], [11a84, 11a89],
    [11d46, 11d46]**/
    ...
    {Empty, 58}, {Mixed, 2}, {Empty, 6}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
    {Empty, 21}, {Mixed, 1}, {Empty, 32533}};
    const static UnicodeSet::bitquad_t  __pp_Set_quads[] = {
    0x0000003f, 0x20000000, 0x00008000, 0x00030000, 0x00000004, 0x00004000,
    0x20000000, 0x00002000, 0x0000000c, 0x80000000, 0x00000002, 0x04000000,
    0x000003f0, 0x00000040};
    }

    const static UnicodeSet pp_Set{const_cast<UnicodeSet::run_t *>(__pp_Set_runs), 25, 0, const_cast<UnicodeSet::bitquad_t *>(__pp_Set_quads), 14, 0};
    ...
    [1a7f, 1a7f], [1ab0, 1ace], [1b00, 1b03], [1b34, 1b3a], [1b3c, 1b3c],
    ...
    [1ced, 1ced], [1cf4, 1cf4], [1cf8, 1cf9], [1dc0, 1dff], [200c, 200c],
    ...
    [a980, a982], [a9b3, a9b3], [a9b6, a9b9], [a9bc, a9bd], [a9e5, a9e5],
    ...
    0x00000002, 0x90000000, 0x00603044, 0x0000000c, 0x00000003, 0x58000000,
    0x0080201e, 0x0000000c, 0x00000002, 0x805c8400, 0x07f20000, 0x00007f80,
    0x1ff20000, 0x00003f00, 0x03000000, 0x02a00000, 0x7ffe0000, 0xfeffe0df,
    ...
    0x7f400000, 0x9ff81fe5, 0xffff0000, 0x00007fff, 0x0000000f, 0x17f00000,
    ...
    0x87000000, 0x00000060, 0x000000f0, 0x00001800, 0x0001ffc0, 0x0000003c,
    ...
    0x00009e00, 0x40d38000, 0x80000000, 0x000007f8, 0x00000003, 0x58000000,
    0x00800001, 0x001f1fc0, 0xff000000, 0x4000005c, 0xa5f90000, 0x0000000d,
    0xb03c8000, 0x30000001, 0xa7f80000, 0x00000001, 0x00bf2800, 0xe0000000,
    0x00000fbc, 0x06ff8000, 0x58010000, 0x00000008, 0x0cf00000, 0x00000001,
    ...
    0x007f0000, 0x00008000, 0x00078000, 0x00000010, 0x60000000, 0xffff3fff,
    0x0000007f, 0xf807c3a0, 0x00000fe7, 0x00003c00, 0x0000001c, 0xf87fffff,
    0x00201fff, 0xf8000010, 0x0000fffe, 0xf9ffff7f, 0x000007db, 0x007f0000,
    0x00004000, 0x0000f000, 0x007f0000, 0x000007f0, 0xf8000000, 0x0000ffff};
    }

    const static UnicodeSet ex_Set{const_cast<UnicodeSet::run_t *>(__ex_Set_runs), 205, 0, const_cast<UnicodeSet::bitquad_t *>(__ex_Set_quads), 210, 0};
    ...
    [1056, 1057], [1084, 1084], [1715, 1715], [1734, 1734], [17b6, 17b6],
    [17be, 17c5], [17c7, 17c8], [1923, 1926], [1929, 192b], [1930, 1931],
    [1933, 1938], [1a19, 1a1a], [1a55, 1a55], [1a57, 1a57], [1a6d, 1a72],
    [1b04, 1b04], [1b3b, 1b3b], [1b3d, 1b41], [1b43, 1b44], [1b82, 1b82],
    [1ba1, 1ba1], [1ba6, 1ba7], [1baa, 1baa], [1be7, 1be7], [1bea, 1bec],
    [1bee, 1bee], [1bf2, 1bf3], [1c24, 1c2b], [1c34, 1c35], [1ce1, 1ce1],
    ...
    [111b3, 111b5], [111bf, 111c0], [111ce, 111ce], [1122c, 1122e],
    [11232, 11233], [11235, 11235], [112e0, 112e2], [11302, 11303],
    ...
    [114c1, 114c1], [115b0, 115b1], [115b8, 115bb], [115be, 115be],
    [11630, 11632], [1163b, 1163c], [1163e, 1163e], [116ac, 116ac],
    [116ae, 116af], [116b6, 116b6], [11726, 11726], [1182c, 1182e],
    ...
    {Empty, 1}, {Mixed, 1}, {Empty, 51}, {Mixed, 2}, {Empty, 3}, {Mixed, 2},
    {Empty, 10}, {Mixed, 1}, {Empty, 6}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
    {Empty, 4}, {Mixed, 3}, {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 1},
    {Empty, 1}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 1113},
    {Mixed, 1}, {Empty, 2}, {Mixed, 3}, {Empty, 3}, {Mixed, 1}, {Empty, 1},
    {Mixed, 3}, {Empty, 2}, {Mixed, 2}, {Empty, 4}, {Mixed, 1}, {Empty, 7},
    {Mixed, 1}, {Empty, 800}, {Mixed, 1}, {Empty, 3}, {Mixed, 2},
    {Empty, 3}, {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Empty, 2}, {Mixed, 1},
    {Empty, 5}, {Mixed, 5}, {Empty, 5}, {Mixed, 2}, {Empty, 2}, {Mixed, 2},
    {Empty, 6}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
    {Empty, 3}, {Mixed, 1}, {Empty, 7}, {Mixed, 1}, {Empty, 7}, {Mixed, 2},
    {Empty, 3}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 1},
    {Empty, 12}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 6}, {Mixed, 1},
    {Empty, 10}, {Mixed, 1}, {Empty, 642}, {Mixed, 1}, {Full, 1},
    ...
    0x80000000, 0x18020000, 0x00c00000, 0x00000010, 0x00200000, 0x00100000,
    0xc0400000, 0x000001bf, 0x01fb0e78, 0x06000000, 0x00a00000, 0x0007e000,
    0x00000010, 0xe8000000, 0x0000001b, 0x00000004, 0x000004c2, 0x000c5c80,
    0x00300ff0, 0x00800002, 0x00000098, 0x00000003, 0xfff00000, 0x0000000f,
    0x000c0000, 0x00000008, 0xcc300000, 0x00000001, 0x00198000, 0x00002000,
    ...
    0x0000000c, 0x80000000, 0x0000399e, 0x0000000c, 0x00e00000, 0x00000023,
    0x5a060000, 0x00000002, 0x4f030000, 0x58070000, 0x0040d000, 0x00000040,
    0x01007000, 0x21be0000, 0x00000005, 0xf00e0000, 0x00000010, 0x02000000,
    0x01800000, 0x00800000, 0x40008000, 0x00120200, 0x00587c00, 0x00600000,
    0xfffe0000, 0x000000ff, 0x00030000, 0x00002040};
    }

    const static UnicodeSet sm_Set{const_cast<UnicodeSet::run_t *>(__sm_Set_runs), 123, 0, const_cast<UnicodeSet::bitquad_t *>(__sm_Set_quads), 100, 0};
