...
namespace UCD {
  namespace GCB_ns {
    ...
    [10d28, 10eaa], [10ead, 10efc], [10f00, 10f45], [10f51, 10f81],
    [10f86, 10fff], [11003, 11037], [11047, 1106f], [11071, 11072],
    [11075, 1107e], [11083, 110af], [110bb, 110bc], [110be, 110c1],
    [110c3, 110cc], [110ce, 110ff], [11103, 11126], [11135, 11144],
    [11147, 11172], [11174, 1117f], [11183, 111b2], [111c1, 111c1],
    [111c4, 111c8], [111cd, 111cd], [111d0, 1122b], [11238, 1123d],
    [1123f, 11240], [11242, 112de], [112eb, 112ff], [11304, 1133a],
    ...
    [11720, 11721], [1172c, 1182b], [1183b, 1192f], [11936, 11936],
    [11939, 1193a], [11944, 119d0], [119d8, 119d9], [119e1, 119e3],
    [119e5, 11a00], [11a0b, 11a32], [11a3f, 11a46], [11a48, 11a50],
    [11a5c, 11a83], [11a9a, 11c2e], [11c37, 11c37], [11c40, 11c91],
    [11ca8, 11ca8], [11cb7, 11d30], [11d37, 11d39], [11d3b, 11d3b],
    [11d3e, 11d3e], [11d48, 11d89], [11d8f, 11d8f], [11d92, 11d92],
    [11d98, 11ef2], [11ef7, 11eff], [11f04, 11f33], [11f3b, 11f3d],
    [11f43, 1342f], [13441, 13446], [13456, 16aef], [16af5, 16b2f],
    [16b37, 16f4e], [16f50, 16f50], [16f88, 16f8e], [16f93, 16fe3],
    [16fe5, 16fef], [16ff2, 1bc9c], [1bc9f, 1bc9f], [1bca4, 1ceff],
    ...
    [1e2af, 1e2eb], [1e2f0, 1e4eb], [1e4f0, 1e8cf], [1e8d7, 1e943],
    ...
    {Mixed, 1}, {Full, 17}, {Mixed, 1}, {Full, 11}, {Mixed, 1}, {Full, 1},
    ...
    {Mixed, 4}, {Full, 166}, {Mixed, 2}, {Full, 436}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Full, 32}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 2},
    ...
    {Full, 1}, {Mixed, 1}, {Full, 15}, {Mixed, 1}, {Full, 30}, {Mixed, 1},
    {Full, 3}, {Mixed, 1}, {Full, 68}, {Mixed, 1}, {Full, 15}, {Mixed, 1},
    ...
    0xffff0f91, 0x78ffffff, 0xffffff9f, 0xffffff0f, 0xffffe7ff, 0x1fffffff,
    0xfffe003f, 0xffffffc3, 0xfffffff8, 0x00ffffff, 0xffffff80, 0x7fe6ffff,
    0xfffffff8, 0xd800ffff, 0xffffdffb, 0xfffffff8, 0xffe0007f, 0xffffff9f,
    0xfff7ffff, 0xfffffff8, 0x0007ffff, 0xffff21f2, 0xbf000fff, 0xfffffffd,
    0x7fffffff, 0xfffff800, 0xfffffff0, 0x27ffffff, 0xff7fc660, 0xffe0e033,
    0x001fffff, 0xbfffff80, 0x0000ffff, 0xfffffff0, 0x00c07fff, 0xcffffffe,
    0x0000ffff, 0xfffffffe, 0xff0007ff, 0x1fffffff, 0xfffff003, 0xf8000fff,
    0x0640ffff, 0xfffffff0, 0x0301ffff, 0xffffffee, 0xfffff801, 0x8007ffff,
    0xf001ff7f, 0xfc00000f, 0x00807fff, 0x0003ffff, 0xff800100, 0x4b81ffff,
    0xffffff00, 0xff0483ff, 0xff87ffff, 0xfffffff0, 0x380fffff, 0xfffffff8,
    0x0000ffff, 0xffc0007e, 0xffe0ffff, 0xff80ffff, 0x00017fff, 0xfff87f00,
    ...
    0xffff0001, 0x06000080, 0xfffff824, 0xffff7fff, 0xff80ffff, 0xffffbfff,
    0xffff0fff, 0xffff0fff, 0xff80ffff, 0xfffff80f, 0x0000003f, 0x07ffffff};
    }

    const static UnicodeSet xx_Set{const_cast<UnicodeSet::run_t *>(__xx_Set_runs), 223, 0, const_cast<UnicodeSet::bitquad_t *>(__xx_Set_quads), 234, 0};
    ...
    {Empty, 21}, {Mixed, 1}, {Empty, 13}, {Mixed, 1}, {Empty, 32519}};
    ...
    const static UnicodeSet pp_Set{const_cast<UnicodeSet::run_t *>(__pp_Set_runs), 27, 0, const_cast<UnicodeSet::bitquad_t *>(__pp_Set_quads), 15, 0};
    ...
    {Mixed, 4}, {Empty, 167}, {Mixed, 1}, {Empty, 436}, {Mixed, 1},
    ...
    0x87000000, 0x00000060, 0x000000f0, 0x00001800, 0xe0000000, 0x0001ffc0,
    0x0000003c, 0x00000002, 0xff000000, 0x0000007f, 0x80190000, 0x00000003,
    0x06780000, 0x00000004, 0x00000007, 0x001fef80, 0x00080000, 0x00000003,
    0x7fc00000, 0x00009e00, 0x40d38000, 0x00000002, 0x80000000, 0x000007f8,
    0x00000003, 0x58000000, 0x00800001, 0x001f1fc0, 0xff000000, 0x4000005c,
    0xa5f90000, 0x0000000d, 0xb03c8000, 0x30000001, 0xa7f80000, 0x00000001,
    0x00bf2800, 0xe0000000, 0x00000fbc, 0x06ff8000, 0x58010000, 0x00000008,
    ...
    0x00180000, 0x00000003, 0x07c00000, 0x00000005, 0x003fff81, 0x001f0000,
    ...
    0x00201fff, 0xf8000010, 0x0000fffe, 0xf9ffff7f, 0x000007db, 0x00008000,
    0x007f0000, 0x00004000, 0x0000f000, 0x0000f000, 0x007f0000, 0x000007f0,
    0xf8000000, 0x0000ffff};
    }

    const static UnicodeSet ex_Set{const_cast<UnicodeSet::run_t *>(__ex_Set_runs), 213, 0, const_cast<UnicodeSet::bitquad_t *>(__ex_Set_quads), 218, 0};
    ...
    [0cca, 0ccb], [0cf3, 0cf3], [0d02, 0d03], [0d3f, 0d40], [0d46, 0d48],
    [0d4a, 0d4c], [0d82, 0d83], [0dd0, 0dd1], [0dd8, 0dde], [0df2, 0df3],
    [0e33, 0e33], [0eb3, 0eb3], [0f3e, 0f3f], [0f7f, 0f7f], [1031, 1031],
    [103b, 103c], [1056, 1057], [1084, 1084], [1715, 1715], [1734, 1734],
    [17b6, 17b6], [17be, 17c5], [17c7, 17c8], [1923, 1926], [1929, 192b],
    [1930, 1931], [1933, 1938], [1a19, 1a1a], [1a55, 1a55], [1a57, 1a57],
    [1a6d, 1a72], [1b04, 1b04], [1b3b, 1b3b], [1b3d, 1b41], [1b43, 1b44],
    ...
    [a8b4, a8c3], [a952, a953], [a983, a983], [a9b4, a9b5], [a9ba, a9bb],
    [a9be, a9c0], [aa2f, aa30], [aa33, aa34], [aa4d, aa4d], [aaeb, aaeb],
    ...
    [116ac, 116ac], [116ae, 116af], [116b6, 116b6], [11726, 11726],
    [1182c, 1182e], [11838, 11838], [11931, 11935], [11937, 11938],
    [1193d, 1193d], [11940, 11940], [11942, 11942], [119d1, 119d3],
    [119dc, 119df], [119e4, 119e4], [11a39, 11a39], [11a57, 11a58],
    ...
    [11f3e, 11f3f], [11f41, 11f41], [16f51, 16f87], [16ff0, 16ff1],
    ...
    0x0000000c, 0x40000000, 0x00000d9b, 0x00080000, 0x0000000c, 0x80000000,
    0x00001dc1, 0x0000000c, 0x7f030000, 0x000c0000, 0x00080000, 0x00080000,
    0xc0000000, 0x80000000, 0x18020000, 0x00c00000, 0x00000010, 0x00200000,
    0x00100000, 0xc0400000, 0x000001bf, 0x01fb0e78, 0x06000000, 0x00a00000,
    0x0007e000, 0x00000010, 0xe8000000, 0x0000001b, 0x00000004, 0x000004c2,
    0x000c5c80, 0x00300ff0, 0x00800002, 0x00000098, 0x00000003, 0xfff00000,
    0x0000000f, 0x000c0000, 0x00000008, 0xcc300000, 0x00000001, 0x00198000,
    0x00002000, 0x0020c800, 0x000016d8, 0x00000005, 0x00000004, 0x01870000,
    0x00001000, 0x00000060, 0x00000004, 0x80380000, 0x00004001, 0x002c7000,
    0x00000007, 0x0000000c, 0x80000000, 0x0000399e, 0x0000000c, 0x00e00000,
    0x00000023, 0x5a060000, 0x00000002, 0x4f030000, 0x58070000, 0x0040d000,
    0x00000040, 0x01007000, 0x21be0000, 0x00000005, 0xf00e0000, 0x00000010,
    0x02000000, 0x01800000, 0x00800000, 0x40008000, 0x00120200, 0x00587c00,
    0x00600000, 0x00000008, 0xc0300000, 0x00000002, 0xfffe0000, 0x000000ff,
    0x00030000, 0x00002040};
    }

    const static UnicodeSet sm_Set{const_cast<UnicodeSet::run_t *>(__sm_Set_runs), 121, 0, const_cast<UnicodeSet::bitquad_t *>(__sm_Set_quads), 104, 0};
