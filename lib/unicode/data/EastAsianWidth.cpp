...
namespace UCD {
  namespace EA_ns {
    ...
    [2b5a, 2e7f], [2e9a, 2e9a], [2ef4, 2eff], [2fd6, 2fef], [303f, 3040],
    [3097, 3098], [3100, 3104], [3130, 3130], [318f, 318f], [31e4, 31ee],
    [321f, 321f], [4dc0, 4dff], [a48d, a48f], [a4c7, a95f], [a97d, abff],
    [d7a4, dfff], [fb00, fdff], [fe1a, fe2f], [fe53, fe53], [fe67, fe67],
    [fe6c, ff00], [ffbf, ffc1], [ffc8, ffc9], [ffd0, ffd1], [ffd8, ffd9],
    [ffdd, ffdf], [ffe7, ffe7], [ffef, fffc], [fffe, 16fdf], [16fe5, 16fef],
    ...
    [1f6d3, 1f6d4], [1f6d8, 1f6db], [1f6e0, 1f6ea], [1f6ed, 1f6f3],
    [1f6fd, 1f7df], [1f7ec, 1f7ef], [1f7f1, 1f90b], [1f93b, 1f93b],
    [1f946, 1f946], [1fa00, 1fa6f], [1fa7d, 1fa7f], [1fa89, 1fa8f],
    [1fabe, 1fabe], [1fac6, 1facd], [1fadc, 1fadf], [1fae9, 1faef],
    [1faf9, 1ffff], [2fffe, 2ffff], [3fffe, e00ff], [e01f0, effff],
    ...
    {Empty, 11}, {Mixed, 1}, {Full, 488}, {Mixed, 1}, {Full, 5}, {Mixed, 1},
    {Full, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
    {Full, 2}, {Mixed, 4}, {Full, 4}, {Empty, 1}, {Mixed, 1}, {Empty, 1},
    {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 4},
    {Mixed, 1}, {Empty, 1}, {Mixed, 5}, {Full, 1}, {Mixed, 1}, {Empty, 2},
    {Mixed, 1}, {Full, 1}, {Empty, 2}, {Mixed, 2}, {Full, 7}, {Mixed, 1},
    {Full, 8}, {Mixed, 3}, {Empty, 5}, {Full, 3}, {Mixed, 5}, {Full, 40},
    {Empty, 2047}, {Mixed, 1}, {Empty, 2047}, {Mixed, 1}, {Full, 20488},
    ...
    0xffc00000, 0x0000ffff, 0x80000000, 0x00000001, 0x01800000, 0x0000001f,
    0x00010000, 0x00008000, 0x00007ff0, 0x80000000, 0x0000e000, 0xffffff80,
    ...
    0xffc00000, 0xfffffe00, 0x9010ffff, 0xfffbfff8, 0xffd8ffff, 0x0000ff0f,
    0xf0000000, 0xffffffef, 0xffff7fff, 0x0000f800, 0x0000c000, 0x0000fc00,
    0xffffe000, 0x0000fff8, 0xf0000000, 0xfffcfe00, 0xffffffc0, 0x00401ffe,
    0x20000000, 0xfff00000, 0xfff07800, 0x00ee0000, 0x80000000, 0x00000002,
    0x60000000, 0xc0000000, 0x000087ff, 0xfbffff00, 0xff9fffff, 0xffffffef,
    0x07ffffff, 0xffff0000, 0x0f18efc0, 0xe00fe7ff, 0xfffef000, 0x00000fff,
    0x08000000, 0x00000040, 0xe000ffff, 0x0000fe00, 0x40000000, 0xf0003fc0,
    0xfe00fe00, 0xc0000000, 0xc0000000, 0xffff0000, 0xc0000000, 0xc0000000};
    }

    const static UnicodeSet n_Set{const_cast<UnicodeSet::run_t *>(__n_Set_runs), 146, 0, const_cast<UnicodeSet::bitquad_t *>(__n_Set_quads), 138, 0};
    ...
    [2e80, 2e99], [2e9b, 2ef3], [2f00, 2fd5], [2ff0, 2fff], [3001, 303e],
    [3041, 3096], [3099, 30ff], [3105, 312f], [3131, 318e], [3190, 31e3],
    [31ef, 321e], [3220, 3247], [3250, 4dbf], [4e00, a48c], [a490, a4c6],
    ...
    [1f6cc, 1f6cc], [1f6d0, 1f6d2], [1f6d5, 1f6d7], [1f6dc, 1f6df],
    [1f6eb, 1f6ec], [1f6f4, 1f6fc], [1f7e0, 1f7eb], [1f7f0, 1f7f0],
    [1f90c, 1f93a], [1f93c, 1f945], [1f947, 1f9ff], [1fa70, 1fa7c],
    [1fa80, 1fa88], [1fa90, 1fabd], [1fabf, 1fac5], [1face, 1fadb],
    [1fae0, 1fae8], [1faf0, 1faf8], [20000, 2fffd], [30000, 3fffd]**/
    ...
    {Empty, 488}, {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 5},
    ...
    {Mixed, 1}, {Empty, 8}, {Mixed, 3}, {Full, 5}, {Empty, 3}, {Mixed, 5},
    ...
    0xfbffffff, 0x000fffff, 0x003fffff, 0xffff0000, 0xfffffffe, 0x7fffffff,
    0xfffffffe, 0xfe7fffff, 0xffffffe0, 0xfffeffff, 0xffff7fff, 0xffff800f,
    ...
    0x003fffff, 0x000001ff, 0x6fef0000, 0x00040007, 0x00270000, 0xffff00f0,
    0x0fffffff, 0x00000010, 0x00008000, 0x07fe4000, 0xffff0007, 0x0fffffff,
    0x000301ff, 0x0000003f, 0xffbfe001, 0xdfffffff, 0x000fffff, 0x000f87ff,
    0xff11ffff, 0x7fffffff, 0xfffffffd, 0x9fffffff, 0x3fffffff, 0xffff7800,
    0x040000ff, 0x00600000, 0x00000010, 0xf8000000, 0x0000ffff, 0xf0e7103f,
    0x1ff01800, 0x00010fff, 0xfffff000, 0xf7ffffff, 0xffffffbf, 0x1fff0000,
    0xffff01ff, 0xbfffffff, 0x0fffc03f, 0x01ff01ff, 0x3fffffff, 0x3fffffff};
    }

    const static UnicodeSet w_Set{const_cast<UnicodeSet::run_t *>(__w_Set_runs), 102, 0, const_cast<UnicodeSet::bitquad_t *>(__w_Set_quads), 84, 0};
