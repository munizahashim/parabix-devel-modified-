...
namespace UCD {
    namespace SCX_ns {
        ...
        [3100, 3104], [3130, 3130], [318f, 318f], [31e4, 31ef],
        [321f, 321f], [a48d, a48f], [a4c7, a4cf], [a62c, a63f],
        [a6f8, a6ff], [a7cb, a7cf], [a7d2, a7d2], [a7d4, a7d4],
        [a7da, a7f1], [a82d, a82f], [a83a, a83f], [a878, a87f],
        ...
        [fbc3, fbd2], [fd90, fd91], [fdc8, fdce], [fdd0, fdef],
        ...
        {Full, 2}, {Empty, 1}, {Mixed, 7}, {Empty, 2}, {Mixed, 2},
        {Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Empty, 3},
        {Mixed, 3}, {Full, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 5},
        {Full, 4}, {Empty, 2}, {Mixed, 2}, {Empty, 2}, {Mixed, 1},
        {Full, 5}, {Empty, 1}, {Mixed, 2}, {Full, 1}, {Empty, 2},
        {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 3},
        {Full, 5}, {Empty, 1}, {Mixed, 1}, {Full, 3}, {Empty, 2},
        {Mixed, 4}, {Full, 2}, {Mixed, 3}, {Empty, 2}, {Mixed, 1},
        {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 8},
        ...
        {Full, 81}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 33},
        {Mixed, 1}, {Full, 126}, {Empty, 18}, {Mixed, 1}, {Full, 269},
        {Empty, 17}, {Mixed, 3}, {Empty, 1}, {Mixed, 3}, {Empty, 2},
        {Mixed, 3}, {Full, 21}, {Empty, 2}, {Mixed, 1}, {Full, 3},
        {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 2},
        {Mixed, 1}, {Empty, 191}, {Mixed, 1}, {Empty, 38}, {Mixed, 1},
        {Full, 1}, {Mixed, 1}, {Full, 278}, {Mixed, 1}, {Empty, 9},
        {Mixed, 3}, {Empty, 11}, {Mixed, 1}, {Full, 72}, {Empty, 3},
        {Mixed, 3}, {Full, 146}, {Empty, 1}, {Mixed, 2}, {Empty, 3},
        {Mixed, 1}, {Full, 1}, {Empty, 7}, {Mixed, 1}, {Empty, 1},
        {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
        {Full, 4}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Full, 4},
        {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Empty, 1},
        {Mixed, 3}, {Empty, 10}, {Mixed, 1}, {Empty, 8}, {Mixed, 1},
        {Empty, 21}, {Mixed, 2}, {Full, 34}, {Mixed, 1}, {Full, 7},
        {Mixed, 2}, {Full, 6}, {Empty, 1}, {Mixed, 2}, {Full, 9},
        {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Full, 39}, {Mixed, 1},
        ...
        {Empty, 10}, {Mixed, 6}, {Empty, 4}, {Mixed, 1}, {Empty, 1},
        ...
        0x00022000, 0x0c100200, 0x9f9fc220, 0xfff90030, 0x00022000,
        0x000f0220, 0x00000030, 0x03800011, 0xd0040000, 0x00a07b80,
        0xffe3003f, 0x00000001, 0x78000000, 0xf0000000, 0x00000829,
        0xc0000050, 0x0c00c0a0, 0x00000100, 0x0001e000, 0x01000000,
        ...
        0x00008000, 0x0000fff0, 0x80000000, 0x0000e000, 0x0000ff80,
        ...
        0x0000ff00, 0xfc000000, 0x0000ffff, 0xfffffc00, 0x0000ffff,
        0xfffff000, 0xff800000, 0x0003c000, 0x7fc00000, 0x0000dff8,
        0xfc00fe00, 0x00200000, 0x0000ff00, 0xff800000, 0xffe00001,
        0x00040000, 0x80000000, 0x40004280, 0x0000fc00, 0xfc00f800,
        0x00066010, 0x04120200, 0x1f7ec660, 0xffe0e030, 0x10000000,
        0xfffffffc, 0xfc00ff00, 0x00c00000, 0xc0000000, 0xfc00ffe0,
        0xffffe000, 0xfc000000, 0xfffffc00, 0x18000000, 0x0000f000,
        0xffffff80, 0xf0000000, 0x7ff80000, 0x00900d80, 0x06400000,
        0xfc00ff80, 0x00000300, 0x03000000, 0xffffffe0, 0x0000ff00,
        0x0000fff8, 0xfe000000, 0x00000200, 0x00800000, 0x0000ffc0,
        ...
        0x0000ffff, 0xfff80000, 0xfe008000, 0xffffff80, 0xfe000000,
        ...
        0x9010ffff, 0xfffffff8, 0xfff8ffff, 0x0000ff0f, 0xf0000000,
        ...
        0x000000c0, 0x00003000, 0x07fff000, 0xffff0001, 0x80000000,
        0x06000080, 0xfffff824, 0xc000e000, 0xffff3c00, 0x0000ffff,
        0xffff8000, 0x7c000000, 0x80009080, 0xff800060, 0x3c00f000,
        0x0001ffff, 0xffe00000, 0x00000001, 0xc0000000, 0x00000010,
        0xf5080169, 0x5569157b, 0xa1080869, 0xf0000400, 0xf0000411,
        0xfffcffff, 0x0000f000, 0xfff00000, 0x00018000, 0x00010001,
        0xffc00000, 0xffffc000, 0x0000003f, 0x0000fff8, 0xf0000000,
        0xfffcfe00, 0xffffffc0, 0x1f000000, 0xe000e000, 0xfff00000,
        0xfe000000, 0xfffef000, 0x0000f000, 0xfc00ff00, 0x0000ff00,
        0xfffcc000, 0xfff00000, 0xe0e0c000, 0x0000ff80, 0xf800e000,
        0xfc00ffc0, 0xff80ff00, 0x00080000, 0xfffff800, 0xfc00ffff,
        0xfe000000, 0xc0000000, 0x0000fffc, 0xfffffffe, 0xc0000000,
        0xfffff800, 0xfffffffd, 0xffff0000};
        }

        const static UnicodeSet zzzz_Ext{const_cast<UnicodeSet::run_t *>(__zzzz_Ext_runs), 422, 0, const_cast<UnicodeSet::bitquad_t *>(__zzzz_Ext_quads), 408, 0};
        ...
        [2e44, 2e5d], [2ff0, 2ffb], [3000, 3000], [3004, 3004],
        ...
        [1d1ae, 1d1ea], [1d2e0, 1d2f3], [1d300, 1d356], [1d372, 1d378],
        ...
        [1d7ce, 1d7ff], [1ec71, 1ecb4], [1ed01, 1ed3d], [1f000, 1f02b],
        [1f030, 1f093], [1f0a0, 1f0ae], [1f0b1, 1f0bf], [1f0c1, 1f0cf],
        [1f0d1, 1f0f5], [1f100, 1f1ad], [1f1e6, 1f1ff], [1f201, 1f202],
        [1f210, 1f23b], [1f240, 1f248], [1f260, 1f265], [1f300, 1f6d7],
        ...
        {Empty, 712}, {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Empty, 29},
        {Mixed, 2}, {Empty, 660}, {Mixed, 4}, {Empty, 3}, {Mixed, 5},
        {Empty, 3}, {Mixed, 1}, {Empty, 12}, {Mixed, 1}, {Empty, 1},
        {Mixed, 2}, {Empty, 1642}, {Mixed, 1}, {Full, 3}, {Mixed, 1},
        {Empty, 1}, {Full, 7}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 1},
        {Mixed, 3}, {Full, 1}, {Mixed, 1}, {Empty, 7}, {Mixed, 1},
        ...
        {Full, 4}, {Mixed, 1}, {Full, 1}, {Mixed, 2}, {Empty, 24608},
        ...
        0xffcfffff, 0xffbfffff, 0x3ffffff7, 0x0fff0000, 0x00040011,
        0x00400001, 0xffffff00, 0x80000000, 0xfffe0000, 0x0000f000,
        0x07fe0000, 0x80000000, 0xffffff00, 0x00000003, 0x00000700,
        0x08000000, 0x00000c00, 0x03ff0000, 0xffff0000, 0xfff7ff9f,
        ...
        0xfffff018, 0xffffc3ff, 0x000007ff, 0x000fffff, 0x007fffff,
        ...
        0xe0ffffff, 0x1fff1fff, 0x000fffff, 0x01ffffff, 0x00010fff,
        0xffff0fff, 0x03ff00ff, 0xffff00ff, 0x00033fff, 0x000fffff,
        0x1f1f3fff, 0xffff007f, 0x07ff1fff, 0x03ff003f, 0x007f00ff,
        0xfff7ffff, 0x000007ff, 0x03ff0000, 0x00000002};
        }

        const static UnicodeSet zyyy_Ext{const_cast<UnicodeSet::run_t *>(__zyyy_Ext_runs), 137, 0, const_cast<UnicodeSet::bitquad_t *>(__zyyy_Ext_quads), 109, 0};
        ...
        {Mixed, 2}, {Empty, 1722}, {Mixed, 1}, {Empty, 30983}};
        ...
        0x07fdffff, 0x7fffffff};
        }

        const static UnicodeSet latn_Ext{const_cast<UnicodeSet::run_t *>(__latn_Ext_runs), 54, 0, const_cast<UnicodeSet::bitquad_t *>(__latn_Ext_quads), 37, 0};
        ...
        [10e60, 10e7e], [1ee00, 1ee03], [1ee05, 1ee1f], [1ee21, 1ee22],
        ...
        const static UnicodeSet arab_Ext{const_cast<UnicodeSet::run_t *>(__arab_Ext_runs), 33, 0, const_cast<UnicodeSet::bitquad_t *>(__arab_Ext_quads), 22, 0};
        ...
        [ff9e, ff9f], [1b001, 1b11f], [1b150, 1b152], [1f200, 1f200]**/
        ...
        {Empty, 1411}, {Mixed, 1}, {Full, 8}, {Empty, 1}, {Mixed, 1},
        {Empty, 517}, {Mixed, 1}, {Empty, 30831}};
        ...
        0x00070000, 0x00000001};
        }

        const static UnicodeSet hira_Ext{const_cast<UnicodeSet::run_t *>(__hira_Ext_runs), 18, 0, const_cast<UnicodeSet::bitquad_t *>(__hira_Ext_quads), 12, 0};
        ...
        [1b000, 1b000], [1b120, 1b122], [1b164, 1b167]**/
        ...
        {Full, 1}, {Empty, 1410}, {Mixed, 2}, {Empty, 8}, {Mixed, 1},
        ...
        0x00000001, 0x00000007, 0x000000f0};
        }

        const static UnicodeSet kana_Ext{const_cast<UnicodeSet::run_t *>(__kana_Ext_runs), 23, 0, const_cast<UnicodeSet::bitquad_t *>(__kana_Ext_quads), 13, 0};
        ...
        [1d360, 1d371], [1f250, 1f251], [20000, 2a6df], [2a700, 2b738],
        ...
        0x0003000c, 0x0003ffff, 0x00030000, 0x01ffffff, 0x3fffffff,
        0xffff0003, 0x00000001, 0x3fffffff, 0x000007ff};
        }

        const static UnicodeSet hani_Ext{const_cast<UnicodeSet::run_t *>(__hani_Ext_runs), 63, 0, const_cast<UnicodeSet::bitquad_t *>(__hani_Ext_quads), 29, 0};
