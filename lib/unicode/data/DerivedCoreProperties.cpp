...
namespace UCD {
    namespace ALPHA_ns {
        ...
        [0bd0, 0bd0], [0bd7, 0bd7], [0c00, 0c03], [0c05, 0c0c],
        ...
        [0cdd, 0cde], [0ce0, 0ce3], [0cf1, 0cf2], [0d00, 0d0c],
        ...
        [105b3, 105b9], [105bb, 105bc], [10600, 10736], [10740, 10755],
        ...
        [11000, 11045], [11071, 11075], [11082, 110b8], [110c2, 110c2],
        ...
        [11237, 11237], [1123e, 1123e], [11280, 11286], [11288, 11288],
        ...
        [1145f, 11461], [11480, 114c1], [114c4, 114c5], [114c7, 114c7],
        [11580, 115b5], [115b8, 115be], [115d8, 115dd], [11600, 1163e],
        [11640, 11640], [11644, 11644], [11680, 116b5], [116b8, 116b8],
        [11700, 1171a], [1171d, 1172a], [11740, 11746], [11800, 11838],
        ...
        [11a50, 11a97], [11a9d, 11a9d], [11ab0, 11af8], [11c00, 11c08],
        ...
        [12480, 12543], [12f90, 12ff0], [13000, 1342e], [14400, 14646],
        ...
        [16fe0, 16fe1], [16fe3, 16fe3], [16ff0, 16ff1], [17000, 187f7],
        [18800, 18cd5], [18d00, 18d08], [1aff0, 1aff3], [1aff5, 1affb],
        [1affd, 1affe], [1b000, 1b122], [1b150, 1b152], [1b164, 1b167],
        [1b170, 1b2fb], [1bc00, 1bc6a], [1bc70, 1bc7c], [1bc80, 1bc88],
        [1bc90, 1bc99], [1bc9e, 1bc9e], [1d400, 1d454], [1d456, 1d49c],
        ...
        [1df00, 1df1e], [1e000, 1e006], [1e008, 1e018], [1e01b, 1e021],
        [1e023, 1e024], [1e026, 1e02a], [1e100, 1e12c], [1e137, 1e13d],
        [1e14e, 1e14e], [1e290, 1e2ad], [1e2c0, 1e2eb], [1e7e0, 1e7e6],
        [1e7e8, 1e7eb], [1e7ed, 1e7ee], [1e7f0, 1e7fe], [1e800, 1e8c4],
        [1e900, 1e943], [1e947, 1e947], [1e94b, 1e94b], [1ee00, 1ee03],
        ...
        [1f130, 1f149], [1f150, 1f169], [1f170, 1f189], [20000, 2a6df],
        ...
        {Mixed, 1}, {Empty, 2}, {Mixed, 8}, {Full, 2}, {Mixed, 6},
        {Full, 1}, {Mixed, 3}, {Full, 2}, {Mixed, 1}, {Empty, 1},
        {Mixed, 2}, {Empty, 2}, {Mixed, 2}, {Full, 1}, {Mixed, 5},
        {Empty, 4}, {Full, 2}, {Mixed, 2}, {Full, 2}, {Mixed, 1},
        ...
        {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 2}, {Full, 28},
        ...
        {Empty, 57}, {Mixed, 1}, {Empty, 7}, {Mixed, 2}, {Empty, 6},
        {Full, 1}, {Mixed, 2}, {Empty, 9}, {Mixed, 2}, {Full, 1},
        {Mixed, 1}, {Empty, 39}, {Mixed, 1}, {Full, 6}, {Mixed, 1},
        {Empty, 1}, {Full, 2}, {Mixed, 1}, {Empty, 37}, {Mixed, 6},
        {Empty, 19}, {Mixed, 4}, {Empty, 115}, {Full, 1335}, {Empty, 1},
        ...
        0xfffffffc, 0x01ffffff, 0xffff0004, 0x000001ff, 0x0007ffff,
        0xffff00f0, 0x0047ffff, 0x1400c01e, 0xfffbffff, 0x409fffff,
        ...
        0xfffffdbf, 0x017b7fff, 0x007fffff, 0x00010000, 0x03ffffff,
        0x00007fff, 0x0000000f, 0xffff0000, 0x0001ffff, 0x00007fff,
        0x0000007f, 0x01ffffff, 0x7fffffff, 0xffff0000, 0x7fffffff,
        0xffff0000, 0x00003fff, 0x0000ffff, 0x0000000f, 0xe0fffff8,
        0x0000ffff, 0xffff87ff, 0xffff80ff, 0x0003000b, 0x00ffffff,
        0x003fffff, 0x000001ff, 0x6fef0000, 0x00000007, 0x00070000,
        ...
        0x00000ff7, 0x7fffffff, 0xf9ffff7f, 0x000007db, 0x3f801fff,
        0x00004000, 0xffff0000, 0x00003fff, 0x00000fff, 0x7fff6f7f,
        0x0000001f, 0x0000088f, 0xffffffef, 0x0af7fe96, 0xaa96ea84,
        0x5ef7f796, 0x0ffffbff, 0x0ffffbee, 0xffff0000, 0xffff03ff,
        0xffff03ff, 0x000003ff, 0x01ffffff, 0x3fffffff, 0xffff0003,
        0x00000001, 0x3fffffff, 0x000007ff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 386, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 408, 0};
...
PropertyObject * get_ALPHA_PropertyObject() {  return & ALPHA_ns::property_object; }
    namespace CI_ns {
        ...
        [10d24, 10d27], [10eab, 10eac], [10f46, 10f50], [10f82, 10f85],
        ...
        [11d95, 11d95], [11d97, 11d97], [11ef3, 11ef4], [13430, 13438],
        [16af0, 16af4], [16b30, 16b36], [16b40, 16b43], [16f4f, 16f4f],
        [16f8f, 16f9f], [16fe0, 16fe1], [16fe3, 16fe4], [1aff0, 1aff3],
        ...
        [1e023, 1e024], [1e026, 1e02a], [1e130, 1e13d], [1e2ae, 1e2ae],
        [1e2ec, 1e2ef], [1e8d0, 1e8d6], [1e944, 1e94b], [1f3fb, 1f3ff],
        ...
        {Empty, 17}, {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 4},
        ...
        {Empty, 511}, {Mixed, 1}, {Empty, 100}, {Mixed, 2}, {Empty, 146},
        {Full, 1}, {Mixed, 2}, {Empty, 16}, {Mixed, 3}, {Empty, 4},
        {Mixed, 1}, {Empty, 61}, {Full, 1}, {Mixed, 1}, {Full, 1},
        {Mixed, 3}, {Empty, 42}, {Mixed, 2}, {Empty, 7}, {Mixed, 1},
        {Empty, 11}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 46},
        {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 84}, {Mixed, 1},
        {Empty, 24672}, {Mixed, 1}, {Full, 3}, {Empty, 4}, {Full, 7},
        {Mixed, 1}, {Empty, 6128}};
        const static UnicodeSet::bitquad_t  __codepoint_set_quads[] = {
        ...
        0x00007fc0, 0x1ff20000, 0x00003f40, 0x03000000, 0x02a00000,
        ...
        0x87000000, 0x00000060, 0x000000f0, 0x00001800, 0x0001ffc0,
        ...
        0x80000000, 0x000007f8, 0x00000003, 0x18000000, 0x00000001,
        0x001f1fc0, 0xff000000, 0x4000005c, 0x85f80000, 0x0000000d,
        0xb03c0000, 0x30000001, 0xa7f80000, 0x00000001, 0x00bf2800,
        0xe0000000, 0x00000fbc, 0x06ff8000, 0x58000000, 0x00000008,
        0x0cf00000, 0x00000001, 0x000007fe, 0x79f80000, 0x0e7e0080,
        0x037ffc00, 0xbf7f0000, 0xfffc0000, 0x006dfcff, 0xb47e0000,
        0x000000bf, 0x00a30000, 0x00180000, 0x01ff0000, 0x001f0000,
        0x007f0000, 0x0000000f, 0x00008000, 0xffff8000, 0x0000001b,
        ...
        0x3fff0000, 0x00004000, 0x0000f000, 0x007f0000, 0x00000ff0,
        0xf8000000, 0x00000002, 0x0000ffff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 252, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 258, 0};
...
PropertyObject * get_CWU_PropertyObject() {  return & CWU_ns::property_object; }
    namespace CASED_ns {
        ...
        [a7d0, a7d1], [a7d3, a7d3], [a7d5, a7d9], [a7f5, a7f6],
        ...
        [1d7c4, 1d7cb], [1df00, 1df09], [1df0b, 1df1e], [1e900, 1e943],
        ...
        {Mixed, 10}, {Empty, 57}, {Mixed, 1}, {Empty, 79}, {Full, 2},
        ...
        0x03eb07ff, 0x07600000, 0xffff0000, 0xf7ffffff, 0xffff01ff,
        ...
        0xfffdfc5f, 0xffffff3f, 0xf7fffffd, 0xf7ffffff, 0xffdfffff,
        0xffdfffff, 0xffff7fff, 0xffff7fff, 0xfffffdff, 0xfffffdff,
        0x00000ff7, 0x7ffffbff, 0x0000000f, 0xffff0000, 0xffff03ff,
        0xffff03ff, 0x000003ff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 101, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 87, 0};
...
PropertyObject * get_DI_PropertyObject() {  return & DI_ns::property_object; }
    namespace GR_BASE_ns {
        ...
        [0ce6, 0cef], [0cf1, 0cf2], [0d02, 0d0c], [0d0e, 0d10],
        ...
        [2ff0, 2ffb], [3000, 3029], [3030, 303f], [3041, 3096],
        [309b, 30ff], [3105, 312f], [3131, 318e], [3190, 31e3],
        [31f0, 321e], [3220, a48c], [a490, a4c6], [a4d0, a62b],
        [a640, a66e], [a673, a673], [a67e, a69d], [a6a0, a6ef],
        [a6f2, a6f7], [a700, a7ca], [a7d0, a7d1], [a7d3, a7d3],
        [a7d5, a7d9], [a7f2, a801], [a803, a805], [a807, a80a],
        ...
        [fb43, fb44], [fb46, fbc2], [fbd3, fd8f], [fd92, fdc7],
        [fdcf, fdcf], [fdf0, fdff], [fe10, fe19], [fe30, fe52],
        ...
        [108f4, 108f5], [108fb, 1091b], [1091f, 10939], [1093f, 1093f],
        ...
        [10cfa, 10d23], [10d30, 10d39], [10e60, 10e7e], [10e80, 10ea9],
        [10ead, 10ead], [10eb0, 10eb1], [10f00, 10f27], [10f30, 10f45],
        [10f51, 10f59], [10f70, 10f81], [10f86, 10f89], [10fb0, 10fcb],
        [10fe0, 10ff6], [11000, 11000], [11002, 11037], [11047, 1104d],
        [11052, 1106f], [11071, 11072], [11075, 11075], [11082, 110b2],
        [110b7, 110b8], [110bb, 110bc], [110be, 110c1], [110d0, 110e8],
        [110f0, 110f9], [11103, 11126], [1112c, 1112c], [11136, 11147],
        ...
        [11a9a, 11aa2], [11ab0, 11af8], [11c00, 11c08], [11c0a, 11c2f],
        [11c3e, 11c3e], [11c40, 11c45], [11c50, 11c6c], [11c70, 11c8f],
        [11ca9, 11ca9], [11cb1, 11cb1], [11cb4, 11cb4], [11d00, 11d06],
        [11d08, 11d09], [11d0b, 11d30], [11d46, 11d46], [11d50, 11d59],
        [11d60, 11d65], [11d67, 11d68], [11d6a, 11d8e], [11d93, 11d94],
        [11d96, 11d96], [11d98, 11d98], [11da0, 11da9], [11ee0, 11ef2],
        [11ef5, 11ef8], [11fb0, 11fb0], [11fc0, 11ff1], [11fff, 12399],
        [12400, 1246e], [12470, 12474], [12480, 12543], [12f90, 12ff2],
        [13000, 1342e], [14400, 14646], [16800, 16a38], [16a40, 16a5e],
        [16a60, 16a69], [16a6e, 16abe], [16ac0, 16ac9], [16ad0, 16aed],
        ...
        [1bc9f, 1bc9f], [1cf50, 1cfc3], [1d000, 1d0f5], [1d100, 1d126],
        ...
        [1df00, 1df1e], [1e100, 1e12c], [1e137, 1e13d], [1e140, 1e149],
        [1e14e, 1e14f], [1e290, 1e2ad], [1e2c0, 1e2eb], [1e2f0, 1e2f9],
        [1e2ff, 1e2ff], [1e7e0, 1e7e6], [1e7e8, 1e7eb], [1e7ed, 1e7ee],
        ...
        [1fb94, 1fbca], [1fbf0, 1fbf9], [20000, 2a6df], [2a700, 2b738],
        ...
        {Full, 1}, {Mixed, 1}, {Empty, 2}, {Full, 1}, {Mixed, 25},
        {Empty, 2}, {Mixed, 8}, {Empty, 4}, {Full, 1}, {Mixed, 3},
        ...
        {Full, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Empty, 8},
        {Mixed, 6}, {Empty, 2}, {Mixed, 6}, {Empty, 9}, {Mixed, 1},
        {Empty, 5}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 28},
        {Mixed, 1}, {Empty, 3}, {Full, 3}, {Mixed, 1}, {Full, 6},
        {Mixed, 1}, {Empty, 81}, {Mixed, 1}, {Full, 2}, {Mixed, 1},
        {Full, 33}, {Mixed, 1}, {Empty, 126}, {Full, 18}, {Mixed, 1},
        {Empty, 269}, {Full, 17}, {Mixed, 3}, {Full, 1}, {Mixed, 3},
        ...
        {Mixed, 1}, {Empty, 4}, {Mixed, 1}, {Full, 2}, {Mixed, 2},
        ...
        {Empty, 35}, {Mixed, 1}, {Empty, 15}, {Full, 1}, {Mixed, 2},
        {Empty, 9}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Empty, 39},
        ...
        {Empty, 2}, {Full, 10}, {Mixed, 6}, {Full, 4}, {Mixed, 1},
        {Full, 1}, {Mixed, 2}, {Empty, 32}, {Full, 1335}, {Empty, 1},
        {Full, 129}, {Mixed, 1}, {Full, 6}, {Mixed, 1}, {Full, 180},
        {Mixed, 1}, {Full, 233}, {Mixed, 1}, {Empty, 96}, {Full, 16},
        {Mixed, 1}, {Empty, 47}, {Full, 154}, {Mixed, 1}, {Empty, 28517}};
        const static UnicodeSet::bitquad_t  __codepoint_set_quads[] = {
        ...
        0xff80ffc3, 0xfffddffd, 0x63effdff, 0x60000d9b, 0x0006ffc3,
        ...
        0x3fffffff, 0xfbffffff, 0x000fffff, 0x003fffff, 0x0fff0000,
        0xffff03ff, 0xfffffffe, 0xf87fffff, 0xffffffe0, 0xfffeffff,
        0xffff7fff, 0xffff000f, 0x7fffffff, 0xffff1fff, 0xffff007f,
        ...
        0xafffffa3, 0x00000003, 0x5a06ffff, 0x03ff00f2, 0x4f037fff,
        0x0ffffffe, 0x5807ffff, 0x03ff001e, 0x00001fff, 0x0340d7ff,
        0x000003ff, 0x07ffffff, 0xffff0043, 0x0000007f, 0x09007fff,
        0x8007ffff, 0xff6ff27f, 0xa1beffff, 0x03ff0077, 0xfffffcff,
        0xf00fffff, 0x0000001e, 0xfffff801, 0x8607ffff, 0xf181007f,
        0xfc8003ff, 0xffff0007, 0x01ffffff, 0xfffffdff, 0x4000ffff,
        0xffff003f, 0xffff1fff, 0x0000ffff, 0x00120200, 0xfffffb7f,
        0x0001ffff, 0x03ff0040, 0xfffffdbf, 0x01587fff, 0x000003ff,
        0x01e7ffff, 0x00010000, 0x8003ffff, 0x03ffffff, 0x001f7fff,
        0x0000000f, 0xffff0000, 0x0007ffff, 0x00007fff, 0x0000007f,
        0x01ffffff, 0x7fffffff, 0xffffc3ff, 0x7fffffff, 0xffff03ff,
        0x00203fff, 0xff80ffff, 0xfbff003f, 0xe0fffffb, 0x0000ffff,
        0x07ffffff, 0xffff07ff, 0xfff800ff, 0x0003000f, 0x00ffffff,
        0x003fffff, 0x000001ff, 0x6fef0000, 0x00000007, 0x00070000,
        0xffff00f0, 0x0fffffff, 0x1fff07ff, 0x93ff01ff, 0xffff0000,
        0x0000000f, 0x003fffff, 0xfffffe7f, 0x00003c5f, 0xfffff018,
        0xffffc3ff, 0x000007ff, 0x00000023, 0x000fffff, 0x007fffff,
        0x01ffffff, 0xffdfffff, 0xdfffffff, 0xebffde64, 0xffffffef,
        0xdfdfe7bf, 0x7bffffff, 0xfffdfc5f, 0xffffff3f, 0xffffcfff,
        0x07800000, 0xffdfe000, 0x00000fef, 0x7fffffff, 0x3f801fff,
        0x0000c3ff, 0xffff0000, 0x00003fff, 0x83ff0fff, 0x7fff6f7f,
        ...
        0xffff0007, 0x0fffffff, 0x000301ff, 0x0000003f, 0xe0ffffff,
        0x1fff1fff, 0x000fffff, 0x01ffffff, 0x00010fff, 0xffff0fff,
        0x03ff00ff, 0xffff00ff, 0x00033fff, 0x000fffff, 0x1f1f3fff,
        0xffff007f, 0x07ff1fff, 0x03ff003f, 0x007f00ff, 0xfff7ffff,
        0x000007ff, 0x03ff0000, 0x01ffffff, 0x3fffffff, 0xffff0003,
        0x00000001, 0x3fffffff, 0x000007ff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 408, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 463, 0};
...
PropertyObject * get_GR_BASE_PropertyObject() {  return & GR_BASE_ns::property_object; }
    namespace GR_EXT_ns {
        ...
        [0eb1, 0eb1], [0eb4, 0ebc], [0ec8, 0ecd], [0f18, 0f19],
        ...
        [116ab, 116ab], [116ad, 116ad], [116b0, 116b5], [116b7, 116b7],
        [1171d, 1171f], [11722, 11725], [11727, 1172b], [1182f, 11837],
        [11839, 1183a], [11930, 11930], [1193b, 1193c], [1193e, 1193e],
        ...
        [1da3b, 1da6c], [1da75, 1da75], [1da84, 1da84], [1da9b, 1da9f],
        [1daa1, 1daaf], [1e000, 1e006], [1e008, 1e018], [1e01b, 1e021],
        [1e023, 1e024], [1e026, 1e02a], [1e130, 1e136], [1e2ae, 1e2ae],
        [1e2ec, 1e2ef], [1e8d0, 1e8d6], [1e944, 1e94a], [e0020, e007f],
        [e0100, e01ef]**/
        ...
        {Empty, 11}, {Mixed, 1}, {Empty, 4}, {Mixed, 1}, {Empty, 1},
        ...
        0x1ff20000, 0x00003f00, 0x03000000, 0x02a00000, 0x7ffe0000,
        ...
        0x00001800, 0x0001ffc0, 0x0000003c, 0x00000002, 0xff000000,
        0x0000007f, 0x80190000, 0x00000003, 0x06780000, 0x00000004,
        ...
        0x58010000, 0x00000008, 0x0cf00000, 0x00000001, 0x000007fe,
        0x79f80000, 0x0e7e0080, 0x037ffc00, 0xbf7f0000, 0xfffc0000,
        0x006dfcff, 0xb47e0000, 0x000000bf, 0x00a30000, 0x00180000,
        0x001f0000, 0x007f0000, 0x00008000, 0x00078000, 0x00000010,
        0x60000000, 0xffff3fff, 0x0000007f, 0xf807c3a0, 0x00000fe7,
        0x00003c00, 0x0000001c, 0xf87fffff, 0x00201fff, 0xf8000010,
        0x0000fffe, 0xf9ffff7f, 0x000007db, 0x007f0000, 0x00004000,
        0x0000f000, 0x007f0000, 0x000007f0, 0x0000ffff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 203, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 209, 0};
...
PropertyObject * get_GR_LINK_PropertyObject() {  return & GR_LINK_ns::property_object; }
    namespace IDC_ns {
        ...
        [0e84, 0e84], [0e86, 0e8a], [0e8c, 0ea3], [0ea5, 0ea5],
        [0ea7, 0ebd], [0ec0, 0ec4], [0ec6, 0ec6], [0ec8, 0ecd],
        ...
        [2160, 2188], [2c00, 2ce4], [2ceb, 2cf3], [2d00, 2d25],
        [2d27, 2d27], [2d2d, 2d2d], [2d30, 2d67], [2d6f, 2d6f],
        [2d7f, 2d96], [2da0, 2da6], [2da8, 2dae], [2db0, 2db6],
        [2db8, 2dbe], [2dc0, 2dc6], [2dc8, 2dce], [2dd0, 2dd6],
        [2dd8, 2dde], [2de0, 2dff], [3005, 3007], [3021, 302f],
        [3031, 3035], [3038, 303c], [3041, 3096], [3099, 309f],
        ...
        [10f00, 10f1c], [10f27, 10f27], [10f30, 10f50], [10f70, 10f85],
        ...
        [12f90, 12ff0], [13000, 1342e], [14400, 14646], [16800, 16a38],
        ...
        [1b000, 1b122], [1b150, 1b152], [1b164, 1b167], [1b170, 1b2fb],
        ...
        [1da9b, 1da9f], [1daa1, 1daaf], [1df00, 1df1e], [1e000, 1e006],
        [1e008, 1e018], [1e01b, 1e021], [1e023, 1e024], [1e026, 1e02a],
        [1e100, 1e12c], [1e130, 1e13d], [1e140, 1e149], [1e14e, 1e14e],
        [1e290, 1e2ae], [1e2c0, 1e2f9], [1e7e0, 1e7e6], [1e7e8, 1e7eb],
        [1e7ed, 1e7ee], [1e7f0, 1e7fe], [1e800, 1e8c4], [1e8d0, 1e8d6],
        [1e900, 1e94b], [1e950, 1e959], [1ee00, 1ee03], [1ee05, 1ee1f],
        ...
        [1eea1, 1eea3], [1eea5, 1eea9], [1eeab, 1eebb], [1fbf0, 1fbf9],
        [20000, 2a6df], [2a700, 2b738], [2b740, 2b81d], [2b820, 2cea1],
        [2ceb0, 2ebe0], [2f800, 2fa1d], [30000, 3134a], [e0100, e01ef]**/
        ...
        {Full, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 3}, {Empty, 1},
        {Mixed, 4}, {Empty, 1}, {Mixed, 5}, {Full, 1}, {Mixed, 1},
        {Empty, 83}, {Full, 7}, {Mixed, 1}, {Full, 1}, {Mixed, 1},
        {Full, 1}, {Mixed, 4}, {Full, 1}, {Empty, 16}, {Mixed, 3},
        ...
        {Mixed, 3}, {Empty, 2}, {Full, 9}, {Mixed, 5}, {Empty, 2},
        ...
        {Mixed, 1}, {Full, 1}, {Mixed, 3}, {Empty, 34}, {Mixed, 1},
        {Empty, 7}, {Mixed, 2}, {Empty, 6}, {Full, 1}, {Mixed, 2},
        {Empty, 9}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Empty, 39},
        {Mixed, 1}, {Full, 6}, {Mixed, 1}, {Empty, 1}, {Full, 2},
        ...
        {Full, 154}, {Mixed, 1}, {Empty, 22381}, {Full, 7}, {Mixed, 1},
        {Empty, 6128}};
        const static UnicodeSet::bitquad_t  __codepoint_set_quads[] = {
        ...
        0x0006ffcf, 0xfffddfff, 0x80f07ddf, 0xfc00ffcf, 0xfc7fffee,
        0x2ffbffff, 0xff5f847f, 0x000cffc0, 0xfffffffe, 0x07ffffff,
        0x03ff7fff, 0xfffff7d6, 0x3fffffaf, 0xf3ff3f5f, 0x03000001,
        ...
        0x3f3fffff, 0xaaff3f3f, 0x3fffffff, 0x5fdfffff, 0x0fcf1fdc,
        0x1fdc1fff, 0x80000000, 0x00100001, 0x80020000, 0x1fff0000,
        0x1fff0000, 0x0001ffe2, 0x3f2ffc84, 0xf3fffd50, 0x000043e0,
        0x000001ff, 0x000ff81f, 0xffff20bf, 0x800080ff, 0x007fffff,
        0x7f7f7f7f, 0x7f7f7f7f, 0x000000e0, 0x1f3efffe, 0xfffffffe,
        0xfe7fffff, 0xfffffffe, 0xf7ffffff, 0xffffffe0, 0xfffeffff,
        ...
        0x004fffff, 0x17ffde1f, 0xfffbffff, 0x40ffffff, 0xbfffbd7f,
        0xffff01ff, 0x03ff07ff, 0xfff99fef, 0xfbedfdff, 0xe081399f,
        0x001f1fcf, 0xc3ff07ff, 0x00000003, 0x03ff00bf, 0xff3fffff,
        0x3f000001, 0x03ff0011, 0x01ffffff, 0x000003ff, 0xe7ffffff,
        ...
        0x00007fff, 0x0000000f, 0xffff0000, 0x0001ffff, 0x00007fff,
        0x0000007f, 0x01ffffff, 0x7fffffff, 0xffff03ff, 0x7fffffff,
        0xffff03ff, 0x001f3fff, 0x007fffff, 0x03ff000f, 0xe0fffff8,
        0x0000ffff, 0xffff87ff, 0xffff80ff, 0x0003001b, 0x00ffffff,
        0x003fffff, 0x000001ff, 0x6fef0000, 0x00000007, 0x00070000,
        0xffff00f0, 0x0fffffff, 0x1fff07ff, 0x63ff01ff, 0xffff3fff,
        ...
        0x0000fffe, 0x7fffffff, 0xf9ffff7f, 0x000007db, 0x3fff1fff,
        0x000043ff, 0xffff0000, 0x00007fff, 0x03ffffff, 0x7fff6f7f,
        0x007f001f, 0x03ff0fff, 0xffffffef, 0x0af7fe96, 0xaa96ea84,
        0x5ef7f796, 0x0ffffbff, 0x0ffffbee, 0x03ff0000, 0x01ffffff,
        0x3fffffff, 0xffff0003, 0x00000001, 0x3fffffff, 0x000007ff,
        0x0000ffff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 388, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 416, 0};
...
PropertyObject * get_IDC_PropertyObject() {  return & IDC_ns::property_object; }
    namespace IDS_ns {
        ...
        [12400, 1246e], [12480, 12543], [12f90, 12ff0], [13000, 1342e],
        ...
        [1e2c0, 1e2eb], [1e7e0, 1e7e6], [1e7e8, 1e7eb], [1e7ed, 1e7ee],
        ...
        [1eeab, 1eebb], [20000, 2a6df], [2a700, 2b738], [2b740, 2b81d],
        ...
        {Mixed, 1}, {Full, 33}, {Mixed, 1}, {Empty, 126}, {Full, 18},
        ...
        {Full, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 3}, {Full, 10},
        {Mixed, 10}, {Empty, 57}, {Mixed, 1}, {Empty, 15}, {Full, 1},
        {Mixed, 2}, {Empty, 9}, {Mixed, 2}, {Full, 1}, {Mixed, 1},
        {Empty, 39}, {Mixed, 1}, {Full, 6}, {Mixed, 1}, {Empty, 1},
        ...
        0x00000003, 0x001fffff, 0x80000780, 0x00000003, 0x0000ffff,
        ...
        0xffff0000, 0x01ffffff, 0xfffffdff, 0x00007fff, 0x00000001,
        0xfffc0000, 0x0000ffff, 0xfffffb7f, 0x0001ffff, 0x00000040,
        0xfffffdbf, 0x010003ff, 0x0007ffff, 0x00010000, 0x03ffffff,
        0x00007fff, 0x0000000f, 0xffff0000, 0x0001ffff, 0x00007fff,
        0x0000007f, 0x01ffffff, 0x7fffffff, 0xffff0000, 0x7fffffff,
        0xffff0000, 0x00003fff, 0x0000ffff, 0x0000000f, 0xe0fffff8,
        ...
        0xfffdfc5f, 0xffffff3f, 0xf7fffffd, 0xf7ffffff, 0xffdfffff,
        0xffdfffff, 0xffff7fff, 0xffff7fff, 0xfffffdff, 0xfffffdff,
        0x00000ff7, 0x7fffffff, 0x3f801fff, 0x00004000, 0xffff0000,
        0x00003fff, 0x00000fff, 0x7fff6f7f, 0x0000001f, 0x0000080f,
        0xffffffef, 0x0af7fe96, 0xaa96ea84, 0x5ef7f796, 0x0ffffbff,
        0x0ffffbee, 0x01ffffff, 0x3fffffff, 0xffff0003, 0x00000001,
        0x3fffffff, 0x000007ff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 369, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 402, 0};
...
PropertyObject * get_IDS_PropertyObject() {  return & IDS_ns::property_object; }
    namespace LOWER_ns {
        ...
        [a7f6, a7f6], [a7f8, a7fa], [ab30, ab5a], [ab5c, ab68],
        [ab70, abbf], [fb00, fb06], [fb13, fb17], [ff41, ff5a],
        [10428, 1044f], [104d8, 104fb], [10597, 105a1], [105a3, 105b1],
        [105b3, 105b9], [105bb, 105bc], [10780, 10780], [10783, 10785],
        [10787, 107b0], [107b2, 107ba], [10cc0, 10cf2], [118c0, 118df],
        ...
        [1d7cb, 1d7cb], [1df00, 1df09], [1df0b, 1df1e], [1e922, 1e943]**/
        ...
        {Empty, 57}, {Mixed, 1}, {Empty, 80}, {Mixed, 2}, {Empty, 30901}};
        const static UnicodeSet::bitquad_t  __codepoint_set_quads[] = {
        ...
        0x95ffaaaa, 0xaaba50aa, 0xaaa082aa, 0x02aa050a, 0x07400000,
        0xffff0000, 0xf7ffffff, 0xffff01ff, 0x00f8007f, 0x07fffffe,
        0xffffff00, 0x0000ffff, 0xff000000, 0x0fffffff, 0xff800000,
        ...
        0x7ffffbff, 0xfffffffc, 0x0000000f};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 70, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 128, 0};
...
PropertyObject * get_UPPER_PropertyObject() {  return & UPPER_ns::property_object; }
    namespace XIDC_ns {
        ...
        [11200, 11211], [11213, 11237], [1123e, 1123e], [11280, 11286],
        ...
        [1da3b, 1da6c], [1da75, 1da75], [1da84, 1da84], [1da9b, 1da9f],
        [1daa1, 1daaf], [1df00, 1df1e], [1e000, 1e006], [1e008, 1e018],
        [1e01b, 1e021], [1e023, 1e024], [1e026, 1e02a], [1e100, 1e12c],
        [1e130, 1e13d], [1e140, 1e149], [1e14e, 1e14e], [1e290, 1e2ae],
        [1e2c0, 1e2f9], [1e7e0, 1e7e6], [1e7e8, 1e7eb], [1e7ed, 1e7ee],
        ...
        [2a700, 2b738], [2b740, 2b81d], [2b820, 2cea1], [2ceb0, 2ebe0],
        [2f800, 2fa1d], [30000, 3134a], [e0100, e01ef]**/
        ...
        0x000001ff, 0x000ff81f, 0xffff20bf, 0x800080ff, 0x007fffff,
        0x7f7f7f7f, 0x7f7f7f7f, 0x000000e0, 0x1f3efffe, 0xfffffffe,
        0xe67fffff, 0xfffffffe, 0xf7ffffff, 0xffffffe0, 0xfffeffff,
        0x00007fff, 0xffff0000, 0x00001fff, 0xffff0000, 0x3fffffff,
        0xffff1fff, 0x00000fff, 0xbff0ffff, 0x0003ffff, 0xff800000,
        0xfffffffc, 0xfffff9ff, 0x03eb07ff, 0xfffc0000, 0x000010ff,
        0x000fffff, 0x03ff003f, 0xe8ffffff, 0xffff3fff, 0x000fffff,
        ...
        0x03ff00ff, 0x00031bff, 0x1fffffff, 0xffff0080, 0x0001ffff,
        ...
        0x0001ffff, 0x00007fff, 0x0000007f, 0x01ffffff, 0x7fffffff,
        0xffff03ff, 0x7fffffff, 0xffff03ff, 0x001f3fff, 0x007fffff,
        0x03ff000f, 0xe0fffff8, 0x0000ffff, 0xffff87ff, 0xffff80ff,
        0x0003001b, 0x00ffffff, 0x003fffff, 0x000001ff, 0x6fef0000,
        0x00000007, 0x00070000, 0xffff00f0, 0x0fffffff, 0x1fff07ff,
        0x63ff01ff, 0xffff3fff, 0x0000007f, 0xf807e3e0, 0x00000fe7,
        ...
        0x00201fff, 0xf8000010, 0x0000fffe, 0x7fffffff, 0xf9ffff7f,
        0x000007db, 0x3fff1fff, 0x000043ff, 0xffff0000, 0x00007fff,
        0x03ffffff, 0x7fff6f7f, 0x007f001f, 0x03ff0fff, 0xffffffef,
        0x0af7fe96, 0xaa96ea84, 0x5ef7f796, 0x0ffffbff, 0x0ffffbee,
        0x03ff0000, 0x01ffffff, 0x3fffffff, 0xffff0003, 0x00000001,
        0x3fffffff, 0x000007ff, 0x0000ffff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 390, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 418, 0};
...
PropertyObject * get_XIDC_PropertyObject() {  return & XIDC_ns::property_object; }
    namespace XIDS_ns {
        ...
        [11ee0, 11ef2], [11fb0, 11fb0], [12000, 12399], [12400, 1246e],
        [12480, 12543], [12f90, 12ff0], [13000, 1342e], [14400, 14646],
        [16800, 16a38], [16a40, 16a5e], [16a70, 16abe], [16ad0, 16aed],
        [16b00, 16b2f], [16b40, 16b43], [16b63, 16b77], [16b7d, 16b8f],
        ...
        [1d6c2, 1d6da], [1d6dc, 1d6fa], [1d6fc, 1d714], [1d716, 1d734],
        [1d736, 1d74e], [1d750, 1d76e], [1d770, 1d788], [1d78a, 1d7a8],
        [1d7aa, 1d7c2], [1d7c4, 1d7cb], [1df00, 1df1e], [1e100, 1e12c],
        ...
        {Empty, 1}, {Mixed, 12}, {Empty, 1}, {Mixed, 2}, {Empty, 2},
        ...
        {Empty, 3}, {Mixed, 5}, {Empty, 10}, {Mixed, 1}, {Empty, 5},
        {Mixed, 1}, {Empty, 2}, {Full, 28}, {Mixed, 1}, {Empty, 3},
        {Full, 3}, {Mixed, 1}, {Full, 6}, {Mixed, 1}, {Empty, 81},
        {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 33}, {Mixed, 1},
        ...
        {Full, 10}, {Mixed, 10}, {Empty, 57}, {Mixed, 1}, {Empty, 15},
        {Full, 1}, {Mixed, 2}, {Empty, 9}, {Mixed, 2}, {Full, 1},
        {Mixed, 1}, {Empty, 39}, {Mixed, 1}, {Full, 6}, {Mixed, 1},
        {Empty, 1}, {Full, 2}, {Mixed, 1}, {Empty, 37}, {Mixed, 6},
        ...
        0x0007ffff, 0x00010000, 0x03ffffff, 0x00007fff, 0x0000000f,
        0xffff0000, 0x0001ffff, 0x00007fff, 0x0000007f, 0x01ffffff,
        ...
        0x6fef0000, 0x00000007, 0x00070000, 0xffff00f0, 0x0fffffff,
        0x1fff07ff, 0x03ff01ff, 0xffdfffff, 0xdfffffff, 0xebffde64,
        0xffffffef, 0xdfdfe7bf, 0x7bffffff, 0xfffdfc5f, 0xffffff3f,
        0xf7fffffd, 0xf7ffffff, 0xffdfffff, 0xffdfffff, 0xffff7fff,
        0xffff7fff, 0xfffffdff, 0xfffffdff, 0x00000ff7, 0x7fffffff,
        0x3f801fff, 0x00004000, 0xffff0000, 0x00003fff, 0x00000fff,
        0x7fff6f7f, 0x0000001f, 0x0000080f, 0xffffffef, 0x0af7fe96,
        0xaa96ea84, 0x5ef7f796, 0x0ffffbff, 0x0ffffbee, 0x01ffffff,
        0x3fffffff, 0xffff0003, 0x00000001, 0x3fffffff, 0x000007ff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 369, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 405, 0};
