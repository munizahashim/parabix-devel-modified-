...
namespace UCD {
  namespace LB_ns {
    ...
    [2427, 243f], [244b, 245f], [2b74, 2b75], [2b96, 2b96], [2cf4, 2cf8],
    ...
    [3100, 3104], [3130, 3130], [318f, 318f], [31e4, 31ee], [321f, 321f],
    ...
    [10e7f, 10e7f], [10eaa, 10eaa], [10eae, 10eaf], [10eb2, 10efc],
    ...
    [11aa3, 11aaf], [11af9, 11aff], [11b0a, 11bff], [11c09, 11c09],
    ...
    [11f11, 11f11], [11f3b, 11f3d], [11f5a, 11faf], [11fb1, 11fbf],
    [11ff2, 11ffe], [1239a, 123ff], [1246f, 1246f], [12475, 1247f],
    [12544, 12f8f], [12ff3, 12fff], [13456, 143ff], [14647, 167ff],
    ...
    [1bc89, 1bc8f], [1bc9a, 1bc9b], [1bca4, 1ceff], [1cf2e, 1cf2f],
    ...
    [1e300, 1e4cf], [1e4fa, 1e7df], [1e7e7, 1e7e7], [1e7ec, 1e7ec],
    ...
    [1eeaa, 1eeaa], [1eebc, 1eeef], [1eef2, 1efff], [1fb93, 1fb93],
    [1fbcb, 1fbef], [1fbfa, 1fbff], [1fffe, 1ffff], [2fffe, 2ffff],
    ...
    {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Full, 2}, {Empty, 9}, {Mixed, 5},
    ...
    {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 7}, {Empty, 2},
    ...
    {Full, 7}, {Mixed, 6}, {Full, 2}, {Mixed, 6}, {Full, 9}, {Mixed, 4},
    ...
    {Full, 125}, {Empty, 18}, {Mixed, 1}, {Full, 269}, {Empty, 17},
    ...
    {Full, 6}, {Mixed, 6}, {Full, 1}, {Mixed, 1}, {Full, 8}, {Empty, 92},
    {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 31}, {Mixed, 1},
    ...
    0x0000f000, 0xffffff80, 0xfffff800, 0x00300000, 0x00400000, 0x01f00000,
    ...
    0x0000001f, 0x00010000, 0x00008000, 0x00007ff0, 0x80000000, 0x0000e000,
    0x0000ff80, 0xfffff000, 0xff000000, 0xfc14f800, 0x0003ffff, 0xfc00e000,
    ...
    0x0000f000, 0xfc00c000, 0x0000fff0, 0x00000780, 0xf0000000, 0x1f07ff80,
    0xa0800000, 0x00000024, 0x0007fff8, 0x00030000, 0xffff7f00, 0x0000ffff,
    ...
    0x0000ff00, 0x08007ff0, 0x00480800, 0xe4040004, 0xff800000, 0xffc00000,
    ...
    0x03f80000, 0xfc00ff00, 0x80000000, 0xfffcc400, 0x1fffffff, 0x0000ff00,
    ...
    0xfc00f800, 0x00066010, 0x04120200, 0x1f7ec660, 0xffe0e030, 0x10000000,
    0xfffffffc, 0xfc00ff00, 0x00c00000, 0xc0000000, 0xfc00ffe0, 0xffffe000,
    0xfc000000, 0xfffffc00, 0x18000000, 0x0000f000, 0xffffff80, 0xf0000000,
    0x7ff80000, 0x00900d80, 0x06400000, 0xfc00ff80, 0x00000300, 0x03000000,
    0xffffffe0, 0x0000ff00, 0x0000fff8, 0xfe000000, 0xfffffc00, 0x00000200,
    ...
    0x00020000, 0x38000000, 0xfc000000, 0xfffeffff, 0x7ffc0000, 0xfc000000,
    0xffe08000, 0xfffffff0, 0x0000ffff, 0xfff80000, 0xffc00000, 0xffffff80,
    ...
    0xfffcffff, 0x00080000, 0xfffff800, 0xfc00ffff, 0xc0000000, 0xc0000000,
    0xc0000000, 0xfffffffd, 0xffff0000};
    }

    const static UnicodeSet xx_Set{const_cast<UnicodeSet::run_t *>(__xx_Set_runs), 393, 0, const_cast<UnicodeSet::bitquad_t *>(__xx_Set_quads), 387, 0};
    ...
    [0859, 085b], [0898, 089f], [08ca, 08e1], [08e3, 0903], [093a, 093c],
    ...
    [10f46, 10f50], [10f82, 10f85], [11000, 11002], [11038, 11045],
    [11070, 11070], [11073, 11074], [11080, 11082], [110b0, 110ba],
    ...
    [11630, 11640], [116ab, 116b7], [1182c, 1183a], [11930, 11935],
    [11937, 11938], [1193b, 1193d], [11940, 11940], [11942, 11943],
    ...
    [11d93, 11d97], [11ef3, 11ef6], [11f00, 11f01], [11f03, 11f03],
    [11f34, 11f3a], [11f3e, 11f41], [13440, 13440], [13447, 13455],
    ...
    {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 7},
    ...
    {Empty, 15}, {Mixed, 1}, {Empty, 30}, {Mixed, 1}, {Empty, 3},
    ...
    0x200ff800, 0xfbc00000, 0x00003eef, 0x0e000000, 0xff000000, 0xfffffc00,
    ...
    0x40000000, 0x0000ffff, 0x0000ffff, 0x0e000000, 0x20000000, 0x00000001,
    0x07c00000, 0x0000f06e, 0x87000000, 0x00000060, 0x000000f0, 0x00001800,
    0xe0000000, 0x0001ffc0, 0x0000003c, 0x00000007, 0xff000000, 0x0000003f,
    0x00190000, 0x00000007, 0x07ff0000, 0x00000004, 0x00000007, 0x001fff80,
    0x00000060, 0x00080000, 0x00000007, 0xfff80000, 0x0000de01, 0x40fff000,
    0x00000002, 0x80000000, 0x000007ff, 0x0000000f, 0xd8000000, 0x0080199f,
    0x001f1fcc, 0xffe00000, 0x4000007f, 0xffff0000, 0x0000000f, 0xff3f8000,
    0x30000001, 0xffff0000, 0x00000001, 0x00fff800, 0x07fff000, 0x39bf0000,
    ...
    0x00fb7c00, 0x00780000, 0x0000000b, 0xc7f00000, 0x00000003, 0x003fff81,
    ...
    0x007f0000, 0x000007f0, 0x00000002, 0x0000ffff};
    }

    const static UnicodeSet cm_Set{const_cast<UnicodeSet::run_t *>(__cm_Set_runs), 203, 0, const_cast<UnicodeSet::bitquad_t *>(__cm_Set_quads), 214, 0};
    ...
    [1b7d, 1b7e], [1c3b, 1c3f], [1c7e, 1c7f], [2000, 2006], [2008, 200a],
    [2010, 2010], [2012, 2013], [2027, 2027], [2056, 2056], [2058, 205b],
    [205d, 205f], [2cfa, 2cfc], [2cff, 2cff], [2d70, 2d70], [2e0e, 2e15],
    [2e17, 2e17], [2e19, 2e19], [2e2a, 2e2d], [2e30, 2e31], [2e33, 2e34],
    [2e3c, 2e3e], [2e40, 2e41], [2e43, 2e4a], [2e4c, 2e4c], [2e4e, 2e4f],
    [2e5d, 2e5d], [3000, 3000], [a4fe, a4ff], [a60d, a60d], [a60f, a60f],
    ...
    {Empty, 3}, {Mixed, 2}, {Empty, 7}, {Mixed, 1}, {Empty, 11}, {Mixed, 1},
    {Empty, 3}, {Mixed, 1}, {Empty, 6}, {Mixed, 1}, {Empty, 16}, {Mixed, 1},
    {Empty, 7}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 12}, {Mixed, 1},
    {Empty, 20}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 4}, {Mixed, 1},
    ...
    0x00600000, 0x05300000, 0x00000030, 0xec000000, 0x60000001, 0xf8000000,
    ...
    0x00000003, 0x0000000f, 0xe0000160, 0x1b000000, 0x00000200, 0x20000000,
    0x20000000, 0x0c007800, 0x00fffe0c, 0x00000006, 0x70000000, 0x00000070,
    0x0000001e, 0x1c000000, 0x00000006, 0x0000003e, 0x01840000, 0x00000018,
    0x80000000, 0x001f0000, 0x0000c000, 0x00200000, 0x03800000, 0x00000010,
    0x01800000, 0x80000000, 0x00000780};
    }

    const static UnicodeSet ba_Set{const_cast<UnicodeSet::run_t *>(__ba_Set_runs), 134, 0, const_cast<UnicodeSet::bitquad_t *>(__ba_Set_quads), 81, 0};
    ...
    [1c80, 1c88], [1c90, 1cba], [1cbd, 1cc7], [1cd3, 1cd3], [1ce9, 1cec],
    ...
    [29fe, 2b54], [2b5a, 2b73], [2b76, 2b95], [2b97, 2cee], [2cf2, 2cf3],
    ...
    [2e35, 2e39], [2e3f, 2e3f], [2e4b, 2e4b], [2e4d, 2e4d], [2e50, 2e52],
    [4dc0, 4dff], [a4d0, a4fd], [a500, a60c], [a610, a61f], [a62a, a62b],
    [a640, a66e], [a673, a673], [a67e, a69d], [a6a0, a6ef], [a6f2, a6f2],
    [a700, a7ca], [a7d0, a7d1], [a7d3, a7d3], [a7d5, a7d9], [a7f2, a801],
    ...
    [fb50, fbc2], [fbd3, fd3d], [fd40, fd8f], [fd92, fdc7], [fdcf, fdcf],
    [fdf0, fdfb], [fdfd, fdff], [fe70, fe74], [fe76, fefc], [ffe8, ffee],
    ...
    [10c80, 10cb2], [10cc0, 10cf2], [10cfa, 10d23], [10e60, 10e7e],
    [10e80, 10ea9], [10eb0, 10eb1], [10f00, 10f27], [10f30, 10f45],
    ...
    [11c00, 11c08], [11c0a, 11c2e], [11c40, 11c40], [11c5a, 11c6c],
    [11c72, 11c8f], [11d00, 11d06], [11d08, 11d09], [11d0b, 11d30],
    [11d46, 11d46], [11d60, 11d65], [11d67, 11d68], [11d6a, 11d89],
    [11d98, 11d98], [11fb0, 11fb0], [11fc0, 11fdc], [11fe1, 11ff1],
    [12000, 12399], [12400, 1246e], [12480, 12543], [12f90, 12ff2],
    [13000, 13257], [1325e, 13281], [13283, 13285], [1328a, 13378],
    [1337c, 1342e], [13441, 13446], [14400, 145cd], [145d0, 14646],
    [16800, 16a38], [16a40, 16a5e], [16a70, 16abe], [16ad0, 16aed],
    [16b00, 16b2f], [16b3a, 16b43], [16b45, 16b45], [16b5b, 16b61],
    [16b63, 16b77], [16b7d, 16b8f], [16e40, 16e96], [16e99, 16e9a],
    [16f00, 16f4a], [16f50, 16f50], [16f93, 16f9f], [18b00, 18cd5],
    ...
    [1e4d0, 1e4eb], [1e7e0, 1e7e6], [1e7e8, 1e7eb], [1e7ed, 1e7ee],
    [1e7f0, 1e7fe], [1e800, 1e8c4], [1e8c7, 1e8cf], [1e900, 1e943],
    [1e94b, 1e94b], [1ec71, 1ecab], [1ecad, 1ecaf], [1ecb1, 1ecb4],
    ...
    [1f16a, 1f16c], [1f39c, 1f39d], [1f3b5, 1f3b6], [1f3bc, 1f3bc],
    ...
    [1fa00, 1fa53], [1fb00, 1fb92], [1fb94, 1fbca]**/
    ...
    {Empty, 2}, {Mixed, 3}, {Full, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 3},
    ...
    {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Empty, 9}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Empty, 2}, {Full, 1}, {Mixed, 7}, {Empty, 4}, {Mixed, 15},
    {Empty, 1}, {Mixed, 3}, {Empty, 9}, {Full, 1}, {Mixed, 3}, {Full, 1},
    {Mixed, 2}, {Empty, 5}, {Full, 1}, {Mixed, 2}, {Empty, 1}, {Full, 1},
    {Mixed, 2}, {Empty, 1}, {Full, 1}, {Mixed, 1}, {Empty, 10}, {Full, 1},
    {Mixed, 1}, {Empty, 3}, {Full, 2}, {Mixed, 1}, {Empty, 5}, {Mixed, 6},
    {Full, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Empty, 8}, {Mixed, 5},
    {Empty, 3}, {Mixed, 5}, {Empty, 16}, {Mixed, 3}, {Full, 28}, {Mixed, 1},
    {Empty, 3}, {Full, 3}, {Mixed, 1}, {Full, 6}, {Mixed, 1}, {Empty, 81},
    {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 18}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Full, 6}, {Mixed, 1}, {Full, 5}, {Mixed, 2}, {Empty, 125},
    {Full, 14}, {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Empty, 269}, {Full, 17},
    {Mixed, 3}, {Full, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 4}, {Empty, 21},
    {Full, 2}, {Mixed, 1}, {Empty, 3}, {Full, 2}, {Mixed, 1}, {Empty, 1},
    {Mixed, 1}, {Empty, 219}, {Full, 14}, {Mixed, 1}, {Empty, 280},
    {Mixed, 1}, {Empty, 96}, {Full, 3}, {Mixed, 2}, {Empty, 149},
    {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Empty, 1}, {Full, 7}, {Mixed, 1},
    {Full, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 1},
    {Full, 2}, {Mixed, 1}, {Empty, 3}, {Mixed, 2}, {Full, 2}, {Mixed, 2},
    {Empty, 4}, {Full, 2}, {Mixed, 1}, {Full, 1}, {Mixed, 3}, {Full, 1},
    {Mixed, 3}, {Full, 10}, {Mixed, 1}, {Full, 8}, {Mixed, 1}, {Empty, 1},
    {Full, 16}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 35},
    {Mixed, 2}, {Empty, 7}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Empty, 4},
    {Full, 1}, {Mixed, 2}, {Empty, 9}, {Mixed, 2}, {Full, 1}, {Mixed, 1},
    {Empty, 14}, {Mixed, 2}, {Empty, 23}, {Mixed, 1}, {Full, 6}, {Mixed, 1},
    ...
    {Empty, 16}, {Mixed, 2}, {Empty, 7}, {Mixed, 1}, {Empty, 2}, {Mixed, 3},
    {Empty, 3}, {Mixed, 2}, {Empty, 2}, {Mixed, 2}, {Empty, 4}, {Full, 3},
    {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Full, 1}, {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Empty, 7},
    {Full, 2}, {Mixed, 1}, {Empty, 5}, {Full, 4}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Empty, 30753}};
    ...
    0xffff01ff, 0xe7ffffff, 0x000800ff, 0x046fde00, 0x3f3fffff, 0xaaff3f3f,
    0x3fffffff, 0xffdfffff, 0xefcfffdf, 0x5fdcffff, 0x00800000, 0xc100000c,
    0x103ffc0f, 0x1fe3001e, 0x1fff1fe1, 0xffb7fdd7, 0xfffff7f9, 0xb7cfffff,
    ...
    0xfff0ffff, 0x0000007f, 0x000007ff, 0x80000000, 0x0000f000, 0xffe00000,
    ...
    0x00000c00, 0xc0087fff, 0x3fffffff, 0x0004ffff, 0x03eb07ff, 0xfffc0000,
    ...
    0xf7ff800f, 0xffb7f7ff, 0x1bfbfffb, 0x007fffff, 0x003fffff, 0x000000ff,
    0xffffffbf, 0x07fdffff, 0xfffffd3f, 0x91bfffff, 0xff3fffff, 0x7fffffff,
    0x0000ff80, 0xf837ffff, 0x0fffffff, 0x83ffffff, 0xf0ffffff, 0xfffcffff,
    ...
    0x0000000f, 0x7fffffff, 0x000303ff, 0xffff00ff, 0x03fe003f, 0xffff0000,
    0x000003c3, 0xffff0000, 0x00000fff, 0x007fffff, 0xfffffff8, 0x1800ffff,
    0xffff0000, 0x000001ff, 0xfffffff8, 0x0000007f, 0xffff0090, 0x0057ffff,
    0xfffffff8, 0x0007ffff, 0x1400209e, 0x001ffffe, 0xfffbffff, 0xa4000fff,
    0x00000001, 0xbfffbd7f, 0xffff01ff, 0x7fffffff, 0x001fffff, 0xa0008780,
    0x00000003, 0x0000ffff, 0x000000f0, 0x00007fff, 0x0f0001c0, 0x0000ffff,
    0x00000018, 0x030007ff, 0x08000fff, 0x8007fc00, 0xfffffcff, 0x0001ffff,
    0x0000000a, 0xfffff801, 0x0407ffff, 0xf0010041, 0x200003ff, 0xffff0000,
    ...
    0xffff3fff, 0x0000007f, 0x01ffffff, 0x7fffffff, 0xffff0000, 0x7fffffff,
    0xffff0000, 0x00003fff, 0xfc00ffff, 0xf800002f, 0xe0fffffb, 0x0000ffff,
    0x067fffff, 0x000107ff, 0xfff80000, 0x003fffff, 0x6fef0000, 0x1fff07ff,
    0x13ff01ff, 0xffff0000, 0x0000000f, 0x003fffff, 0xfffffe7f, 0x00001c1f,
    0xfffff018, 0xffffc3ff, 0x000007ff, 0x00000023, 0x000fffff, 0x000fffff,
    ...
    0xffdfe000, 0x0000086f, 0x7fffffff, 0x000007e0, 0xffff0000, 0x00003fff,
    0x3f801fff, 0x0000c000, 0xffff0000, 0x00003fff, 0x00000fff, 0xffff0000,
    0x00000fff, 0x7fff6f7f, 0x0000ff9f, 0x0000080f, 0xfffe0000, 0x001eefff,
    0xfffffffe, 0x3fffffff, 0xffffffef, 0x0af7fe96, 0xaa96ea84, 0x5ef7f796,
    0x0ffffbff, 0x0ffffbee, 0x00030000, 0x0000c000, 0x00001c00, 0x30000000,
    0x10600000, 0x00068015, 0xff80007f, 0xfffc001f, 0x000003ff, 0x0ff00000,
    0x03f00000, 0xffff0000, 0xf03fffff, 0x000fffff, 0x001fffff, 0xffff0fff,
    0x03ff00ff, 0xffff00ff, 0x00003fff, 0x00000fff, 0x000fffff, 0xfff7ffff,
    0x000007ff};
    }

    const static UnicodeSet al_Set{const_cast<UnicodeSet::run_t *>(__al_Set_runs), 395, 0, const_cast<UnicodeSet::bitquad_t *>(__al_Set_quads), 433, 0};
    ...
    [10d30, 10d39], [110bd, 110bd], [110cd, 110cd], [110f0, 110f9],
    [11136, 1113f], [111d0, 111d9], [112f0, 112f9], [11450, 11459],
    [114d0, 114d9], [11650, 11659], [116c0, 116c9], [11730, 11739],
    [118e0, 118e9], [11c50, 11c59], [11d50, 11d59], [11da0, 11da9],
    ...
    {Mixed, 1}, {Empty, 709}, {Mixed, 1}, {Empty, 67}, {Mixed, 1},
    {Empty, 27}, {Mixed, 3}, {Empty, 1}, {Mixed, 1}, {Empty, 4}, {Mixed, 1},
    ...
    0x03ff0000, 0x0000ffc0, 0x03ff0000, 0x03ff03ff, 0x03ff0000, 0x03ff03ff,
    0x000003ff, 0x03ff0000, 0x000003ff, 0x03ff0000, 0x03ff0000, 0x000003ff,
    0x03ff0000, 0x20000000, 0x00002000, 0x03ff0000, 0xffc00000, 0x03ff0000,
    0x03ff0000, 0x03ff0000, 0x03ff0000, 0x03ff0000, 0x000003ff, 0x03ff0000,
    0x000003ff, 0x03ff0000, 0x03ff0000, 0x000003ff, 0x000003ff, 0x000003ff,
    0x03ff0000, 0xffffc000, 0x000003ff, 0x03ff0000, 0x03ff0000, 0x03ff0000,
    0x03ff0000};
    }

    const static UnicodeSet nu_Set{const_cast<UnicodeSet::run_t *>(__nu_Set_runs), 116, 0, const_cast<UnicodeSet::bitquad_t *>(__nu_Set_quads), 61, 0};
    ...
    [2e29, 2e29], [2e56, 2e56], [2e58, 2e58], [2e5a, 2e5a], [2e5c, 2e5c],
    [3001, 3002], [3009, 3009], [300b, 300b], [300d, 300d], [300f, 300f],
    [3011, 3011], [3015, 3015], [3017, 3017], [3019, 3019], [301b, 301b],
    [301e, 301f], [fd3e, fd3e], [fe11, fe12], [fe18, fe18], [fe36, fe36],
    [fe38, fe38], [fe3a, fe3a], [fe3c, fe3c], [fe3e, fe3e], [fe40, fe40],
    [fe42, fe42], [fe44, fe44], [fe48, fe48], [fe50, fe50], [fe52, fe52],
    [fe5a, fe5a], [fe5c, fe5c], [fe5e, fe5e], [ff09, ff09], [ff0c, ff0c],
    [ff0e, ff0e], [ff3d, ff3d], [ff5d, ff5d], [ff60, ff61], [ff63, ff64],
    [1325b, 1325d], [13282, 13282], [13287, 13287], [13289, 13289],
    [1337a, 1337b], [13438, 13438], [1343d, 1343d], [1343f, 1343f],
    [145cf, 145cf]**/
    ...
    0x0a000000, 0x20000000, 0x000002a8, 0x15400000, 0xcaa2aa06, 0x40000000,
    0x01060000, 0x55400000, 0x54050115, 0x00005200, 0x20000000, 0x20000000,
    0x0000001b, 0x38000000, 0x00000284, 0x0c000000, 0xa1000000, 0x00008000};
    }

    const static UnicodeSet cl_Set{const_cast<UnicodeSet::run_t *>(__cl_Set_runs), 39, 0, const_cast<UnicodeSet::bitquad_t *>(__cl_Set_quads), 30, 0};
    ...
    [2007, 2007], [2011, 2011], [202f, 202f], [1107f, 1107f],
    [13430, 13436], [13439, 1343b], [16fe4, 16fe4]**/
    ...
    {Empty, 45}, {Mixed, 2}, {Empty, 16}, {Mixed, 2}, {Empty, 1921},
    {Mixed, 1}, {Empty, 285}, {Mixed, 1}, {Empty, 477}, {Mixed, 1},
    {Empty, 31872}};
    const static UnicodeSet::bitquad_t  __gl_Set_quads[] = {
    0x00000001, 0xf0008000, 0x00000007, 0x00041100, 0x06000000, 0x00004000,
    0x00002000, 0x10000000, 0x00020080, 0x00008000, 0x80000000, 0x0e7f0000,
    0x00000010};
    }

    const static UnicodeSet gl_Set{const_cast<UnicodeSet::run_t *>(__gl_Set_runs), 21, 0, const_cast<UnicodeSet::bitquad_t *>(__gl_Set_quads), 13, 0};
    ...
    [11360, 11361], [11900, 11906], [11909, 11909], [1190c, 11913],
    [11915, 11916], [11918, 1192f], [11f04, 11f10], [11f12, 11f33]**/
    ...
    {Mixed, 1}, {Empty, 44}, {Mixed, 2}, {Empty, 46}, {Mixed, 2},
    {Empty, 32518}};
    const static UnicodeSet::bitquad_t  __ak_Set_quads[] = {
    0xffffffe0, 0x000fffff, 0x00001fe0, 0xfffffff0, 0x0007ffff, 0xffffffe0,
    0x00ffffff, 0x00260000, 0xfff99fe0, 0x03edfdff, 0x00000003, 0xff6ff27f,
    0x0000ffff, 0xfffdfff0, 0x000fffff};
    }

    const static UnicodeSet ak_Set{const_cast<UnicodeSet::run_t *>(__ak_Set_runs), 17, 0, const_cast<UnicodeSet::bitquad_t *>(__ak_Set_quads), 15, 0};

    /** Code Point Ranges for VI
    [1b44, 1b44], [a9c0, a9c0], [11046, 11046], [1134d, 1134d],
    [1193e, 1193e], [11f42, 11f42]**/


    namespace {
    const static UnicodeSet::run_t __vi_Set_runs[] = {
    {Empty, 218}, {Mixed, 1}, {Empty, 1139}, {Mixed, 1}, {Empty, 819},
    {Mixed, 1}, {Empty, 23}, {Mixed, 1}, {Empty, 46}, {Mixed, 1},
    {Empty, 48}, {Mixed, 1}, {Empty, 32517}};
    const static UnicodeSet::bitquad_t  __vi_Set_quads[] = {
    0x00000010, 0x00000001, 0x00000040, 0x00002000, 0x40000000, 0x00000004};
    }

    const static UnicodeSet vi_Set{const_cast<UnicodeSet::run_t *>(__vi_Set_runs), 13, 0, const_cast<UnicodeSet::bitquad_t *>(__vi_Set_quads), 6, 0};

    /** Code Point Ranges for ID
    [1b50, 1b59], [1b5c, 1b5c], [1b61, 1b6a], [1b74, 1b7c], [231a, 231b],
    [23f0, 23f3], [2600, 2603], [2614, 2615], [2618, 2618], [261a, 261c],
    [261e, 261f], [2639, 263b], [2668, 2668], [267f, 267f], [26bd, 26c8],
    [26cd, 26cd], [26cf, 26d1], [26d3, 26d4], [26d8, 26d9], [26dc, 26dc],
    [26df, 26e1], [26ea, 26ea], [26f1, 26f5], [26f7, 26f8], [26fa, 26fa],
    [26fd, 2704], [2708, 2709], [2764, 2764], [2e80, 2e99], [2e9b, 2ef3],
    [2f00, 2fd5], [2ff0, 2fff], [3003, 3004], [3006, 3007], [3012, 3013],
    [3020, 3029], [3030, 3034], [3036, 303a], [303d, 303f], [3042, 3042],
    [3044, 3044], [3046, 3046], [3048, 3048], [304a, 3062], [3064, 3082],
    [3084, 3084], [3086, 3086], [3088, 308d], [308f, 3094], [309f, 309f],
    [30a2, 30a2], [30a4, 30a4], [30a6, 30a6], [30a8, 30a8], [30aa, 30c2],
    [30c4, 30e2], [30e4, 30e4], [30e6, 30e6], [30e8, 30ed], [30ef, 30f4],
    [30f7, 30fa], [30ff, 30ff], [3105, 312f], [3131, 318e], [3190, 31e3],
    [31ef, 31ef], [3200, 321e], [3220, 3247], [3250, 4dbf], [4e00, a014],
    [a016, a48c], [a490, a4c6], [a9c1, a9c6], [a9ca, a9cd], [a9d0, a9d9],
    [a9de, a9df], [aa50, aa59], [aa5c, aa5c], [f900, faff], [fe30, fe34],
    [fe45, fe46], [fe49, fe4f], [fe51, fe51], [fe58, fe58], [fe5f, fe66],
    [fe68, fe68], [fe6b, fe6b], [ff02, ff03], [ff06, ff07], [ff0a, ff0b],
    [ff0d, ff0d], [ff0f, ff19], [ff1c, ff1e], [ff20, ff3a], [ff3c, ff3c],
    [ff3e, ff5a], [ff5c, ff5c], [ff5e, ff5e], [ff66, ff66], [ff71, ff9d],
    [ffa0, ffbe], [ffc2, ffc7], [ffca, ffcf], [ffd2, ffd7], [ffda, ffdc],
    [ffe2, ffe4], [11049, 1104d], [11052, 11065], [11950, 11959],
    [11f45, 11f4f], [17000, 187f7], [18800, 18aff], [18d00, 18d08],
    [1b000, 1b122], [1b170, 1b2fb], [1f000, 1f0ff], [1f10d, 1f10f],
    [1f16d, 1f16f], [1f1ad, 1f1e5], [1f200, 1f384], [1f386, 1f39b],
    [1f39e, 1f3b4], [1f3b7, 1f3bb], [1f3bd, 1f3c1], [1f3c5, 1f3c6],
    [1f3c8, 1f3c9], [1f3cd, 1f3fa], [1f400, 1f441], [1f444, 1f445],
    [1f451, 1f465], [1f479, 1f47b], [1f47d, 1f480], [1f484, 1f484],
    [1f488, 1f48e], [1f490, 1f490], [1f492, 1f49f], [1f4a1, 1f4a1],
    ...
    [1f85a, 1f85f], [1f888, 1f88f], [1f8ae, 1f8ff], [1f90d, 1f90e],
    [1f910, 1f917], [1f920, 1f925], [1f927, 1f92f], [1f93a, 1f93b],
    [1f93f, 1f976], [1f978, 1f9b4], [1f9b7, 1f9b7], [1f9ba, 1f9ba],
    [1f9bc, 1f9cc], [1f9d0, 1f9d0], [1f9de, 1f9ff], [1fa54, 1fac2],
    [1fac6, 1faef], [1faf9, 1faff], [1fc00, 1fffd], [20000, 2fffd],
    [30000, 3fffd]**/
    ...
    {Mixed, 2}, {Empty, 70}, {Mixed, 1}, {Empty, 47}, {Mixed, 1},
    {Empty, 645}, {Full, 191}, {Mixed, 1}, {Full, 24}, {Empty, 16},
    {Mixed, 1}, {Empty, 279}, {Full, 9}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
    {Full, 11}, {Mixed, 1}, {Empty, 488}, {Full, 8}, {Mixed, 1}, {Empty, 2},
    {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 12},
    {Mixed, 4}, {Full, 2}, {Mixed, 4}, {Full, 2}, {Mixed, 5}, {Full, 1},
    {Mixed, 2}, {Full, 2}, {Mixed, 1}, {Empty, 1}, {Full, 1}, {Mixed, 2},
    {Full, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Full, 1},
    ...
    0x13ff0000, 0x1ff007fe, 0x0c000000, 0x000f0000, 0xdd30000f, 0x0e000000,
    ...
    0xffffffe0, 0xfffeffff, 0xffff7fff, 0x0000800f, 0x7fffffff, 0xffff00ff,
    0xffdfffff, 0xffff1fff, 0x0000007f, 0xc3ff3c7e, 0x13ff0000, 0x001f0000,
    ...
    0x03ff0000, 0x0000ffe0, 0x00ffffff, 0x000001ff, 0x00000007, 0xffff0000,
    0x0fffffff, 0x0000e000, 0x0000e000, 0xffffe000, 0x0000003f, 0xcfffffdf,
    ...
    0xffe00000, 0x0000f000, 0xfc00ff00, 0x0000ff00, 0xffffc000, 0x00ff6000,
    0x8c00ffbf, 0xff7fffff, 0xf49fffff, 0xc0011fff, 0xfff00000, 0xffffffc7,
    0xfe00ffff, 0x3fffffff, 0x3fffffff, 0x3fffffff};
    }

    const static UnicodeSet id_Set{const_cast<UnicodeSet::run_t *>(__id_Set_runs), 115, 0, const_cast<UnicodeSet::bitquad_t *>(__id_Set_quads), 94, 0};

    /** Code Point Ranges for AS
    [1bc0, 1be5], [aa00, aa28], [11066, 1106f], [11350, 11350],
    [1135e, 1135f], [11ee0, 11ef1], [11f50, 11f59]**/


    namespace {
    const static UnicodeSet::run_t __as_Set_runs[] = {
    {Empty, 222}, {Full, 1}, {Mixed, 1}, {Empty, 1136}, {Full, 1},
    {Mixed, 1}, {Empty, 817}, {Mixed, 1}, {Empty, 22}, {Mixed, 1},
    {Empty, 92}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 32517}};
    const static UnicodeSet::bitquad_t  __as_Set_quads[] = {
    0x0000003f, 0x000001ff, 0x0000ffc0, 0xc0010000, 0x0003ffff, 0x03ff0000};
    }

    const static UnicodeSet as_Set{const_cast<UnicodeSet::run_t *>(__as_Set_runs), 15, 0, const_cast<UnicodeSet::bitquad_t *>(__as_Set_quads), 6, 0};
    ...
    [11003, 11004], [1193f, 1193f], [11941, 11941], [11f02, 11f02]**/


    namespace {
    const static UnicodeSet::run_t __ap_Set_runs[] = {
    {Empty, 2176}, {Mixed, 1}, {Empty, 72}, {Mixed, 2}, {Empty, 45},
    {Mixed, 1}, {Empty, 32519}};
    const static UnicodeSet::bitquad_t  __ap_Set_quads[] = {
    0x00000018, 0x80000000, 0x00000002, 0x00000004};
    }

    const static UnicodeSet ap_Set{const_cast<UnicodeSet::run_t *>(__ap_Set_runs), 7, 0, const_cast<UnicodeSet::bitquad_t *>(__ap_Set_quads), 4, 0};
    ...
    static EnumeratedPropertyObject property_object
        ...
        &ns_Set, &ak_Set, &vi_Set, &id_Set, &as_Set, &vf_Set, &zw_Set,
