...
namespace UCD {
  namespace LB_ns {
    ...
    [e000, f8ff], [fb07, fb12], [fb18, fb1c], [fb37, fb37], [fb3d, fb3d],
    ...
    [105ba, 105ba], [105bd, 105ff], [10737, 1073f], [10756, 1075f],
    ...
    [10eb2, 10eff], [10f28, 10f2f], [10f5a, 10f6f], [10f8a, 10faf],
    ...
    [1165a, 1165f], [1166d, 1167f], [116ba, 116bf], [116ca, 116ff],
    ...
    [11a48, 11a4f], [11aa3, 11aaf], [11af9, 11bff], [11c09, 11c09],
    ...
    [12475, 1247f], [12544, 12f8f], [12ff3, 12fff], [1342f, 1342f],
    ...
    [1affc, 1affc], [1afff, 1afff], [1b123, 1b14f], [1b153, 1b163],
    ...
    [1d1eb, 1d1ff], [1d246, 1d2df], [1d2f4, 1d2ff], [1d357, 1d35f],
    ...
    [1df1f, 1dfff], [1e007, 1e007], [1e019, 1e01a], [1e022, 1e022],
    [1e025, 1e025], [1e02b, 1e0ff], [1e12d, 1e12f], [1e13e, 1e13f],
    [1e14a, 1e14d], [1e150, 1e28f], [1e2af, 1e2bf], [1e2fa, 1e2fe],
    [1e300, 1e7df], [1e7e7, 1e7e7], [1e7ec, 1e7ec], [1e7ef, 1e7ef],
    ...
    [1eebc, 1eeef], [1eef2, 1efff], [1fb93, 1fb93], [1fbcb, 1fbef],
    ...
    {Mixed, 1}, {Full, 2}, {Empty, 1}, {Mixed, 7}, {Empty, 2}, {Mixed, 2},
    {Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Empty, 3}, {Mixed, 3},
    {Full, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 5}, {Full, 4}, {Empty, 2},
    {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Full, 5}, {Empty, 1}, {Mixed, 2},
    {Full, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Full, 1},
    {Mixed, 3}, {Full, 5}, {Empty, 1}, {Mixed, 1}, {Full, 3}, {Empty, 2},
    {Mixed, 4}, {Full, 2}, {Mixed, 3}, {Empty, 2}, {Mixed, 1}, {Empty, 2},
    {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 8}, {Mixed, 6}, {Full, 2},
    {Mixed, 6}, {Full, 9}, {Mixed, 1}, {Full, 5}, {Mixed, 1}, {Empty, 1},
    ...
    {Full, 269}, {Empty, 17}, {Mixed, 3}, {Empty, 1}, {Mixed, 3},
    ...
    {Mixed, 1}, {Full, 278}, {Mixed, 1}, {Empty, 9}, {Mixed, 3},
    ...
    {Full, 8}, {Empty, 92}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 31},
    ...
    0x0000001f, 0x00010000, 0x00008000, 0x0000fff0, 0x80000000, 0x0000e000,
    ...
    0x0000ff00, 0x0000fff8, 0xfe000000, 0x00000200, 0x00800000, 0x0000ffc0,
    0x0000e000, 0x00030000, 0xff800100, 0x00000480, 0x4b800000, 0xfc00ff00,
    0x00000240, 0xfe048000, 0xfffffc00, 0xfe000000, 0xfffeffff, 0x7ffc0000,
    0xfc000000, 0xffe08000, 0xfffffff0, 0x0000ffff, 0xfff80000, 0xfe008000,
    0xffffff80, 0xfe000000, 0x80000000, 0x00003c00, 0x80000000, 0x0000fc00,
    0xffc0c000, 0x0400ffc0, 0x1f000004, 0xffff0000, 0xf8000000, 0x00007800,
    0x00007f00, 0xfffcffe0, 0xff000000, 0xffc00000, 0xfffffe00, 0x9010ffff,
    0xfffffff8, 0xfff8ffff, 0x0000ff0f, 0xf0000000, 0xe000f800, 0x0c00fe00,
    0xfffffff0, 0x0000c000, 0x0000ff80, 0xfffffff0, 0xffc00000, 0x00000180,
    0xfffff800, 0xffffffc0, 0xfff00000, 0xff800000, 0xfe000000, 0x00200000,
    0x20000000, 0x1400219b, 0x00000010, 0x20201840, 0x84000000, 0x000203a0,
    0x000000c0, 0x00003000, 0x07fff000, 0xffff0001, 0x80000000, 0x06000080,
    0xfffff824, 0xc000e000, 0xffff3c00, 0x0000ffff, 0xffff8000, 0x7c000000,
    ...
    const static UnicodeSet xx_Set{const_cast<UnicodeSet::run_t *>(__xx_Set_runs), 386, 0, const_cast<UnicodeSet::bitquad_t *>(__xx_Set_quads), 376, 0};
    ...
    [0cd5, 0cd6], [0ce2, 0ce3], [0d00, 0d03], [0d3b, 0d3c], [0d3e, 0d44],
    ...
    [1920, 192b], [1930, 193b], [1a17, 1a1b], [1a7f, 1a7f], [1ab0, 1ace],
    [1b00, 1b04], [1b34, 1b44], [1b6b, 1b73], [1b80, 1b82], [1ba1, 1bad],
    [1be6, 1bf3], [1c24, 1c37], [1cd0, 1cd2], [1cd4, 1ce8], [1ced, 1ced],
    [1cf4, 1cf4], [1cf7, 1cf9], [1dc0, 1dff], [200c, 200c], [200e, 200f],
    [202a, 202e], [2066, 206f], [20d0, 20f0], [2cef, 2cf1], [2d7f, 2d7f],
    [2de0, 2dff], [302a, 302f], [3035, 3035], [3099, 309a], [a66f, a672],
    ...
    {Empty, 612}, {Mixed, 2}, {Empty, 146}, {Full, 1}, {Mixed, 2},
    ...
    0x00603ddf, 0x0000000c, 0x0000000f, 0xd8000000, 0x00803ddf, 0x0000000c,
    ...
    0xfff70000, 0x039021ff, 0x0000d000, 0x00007c00, 0x0000ffc0, 0xffff0000,
    ...
    0x00000007, 0xfff80000, 0x0000de01, 0x40fff000, 0x80000000, 0x000007ff,
    0x0000000f, 0xd8000000, 0x0080399f, 0x001f1fcc, 0xffe00000, 0x4000007f,
    0xffff0000, 0x0000000f, 0xff3f8000, 0x30000001, 0xffff0000, 0x00000001,
    0x00fff800, 0x07fff000, 0x79bf0000, 0x0000000d, 0xfcfe0000, 0x00000011,
    0x000007fe, 0x7bf80000, 0x0ffe0080, 0x03fffc00, 0xff7f8000, 0xfffc0000,
    0x007ffeff, 0xb47e0000, 0x000000bf, 0x00fb7c00, 0x00780000, 0x001f0000,
    0x007f0000, 0xfffe8000, 0x000780ff, 0x00030000, 0x60000000, 0x0000000f,
    0xffff3fff, 0x0000007f, 0xffffe3e0, 0x00000fe7, 0x00003c00, 0x0000001c,
    0xf87fffff, 0x00201fff, 0xf8000010, 0x0000fffe, 0xf9ffff7f, 0x000007db,
    0x007f0000, 0x00004000, 0x0000f000, 0x007f0000, 0x000007f0, 0x00000002,
    0x0000ffff};
    }

    const static UnicodeSet cm_Set{const_cast<UnicodeSet::run_t *>(__cm_Set_runs), 195, 0, const_cast<UnicodeSet::bitquad_t *>(__cm_Set_quads), 205, 0};
    ...
    [a6f3, a6f7], [a8ce, a8cf], [a92e, a92f], [a9c7, a9c9], [aa5d, aa5f],
    [aaf0, aaf1], [abeb, abeb], [10100, 10102], [1039f, 1039f],
    [103d0, 103d0], [10857, 10857], [1091f, 1091f], [10a50, 10a57],
    [10af0, 10af5], [10b39, 10b3f], [10ead, 10ead], [11047, 11048],
    ...
    [11a9a, 11a9c], [11aa1, 11aa2], [11c41, 11c45], [11fff, 11fff],
    ...
    [0870, 088e], [0890, 0891], [08a0, 08c9], [08e2, 08e2], [0904, 0939],
    ...
    [0a59, 0a5c], [0a5e, 0a5e], [0a72, 0a74], [0a76, 0a76], [0a85, 0a8d],
    [0a8f, 0a91], [0a93, 0aa8], [0aaa, 0ab0], [0ab2, 0ab3], [0ab5, 0ab9],
    [0abd, 0abd], [0ad0, 0ad0], [0ae0, 0ae1], [0af0, 0af0], [0af9, 0af9],
    [0b05, 0b0c], [0b0f, 0b10], [0b13, 0b28], [0b2a, 0b30], [0b32, 0b33],
    [0b35, 0b39], [0b3d, 0b3d], [0b5c, 0b5d], [0b5f, 0b61], [0b70, 0b77],
    [0b83, 0b83], [0b85, 0b8a], [0b8e, 0b90], [0b92, 0b95], [0b99, 0b9a],
    [0b9c, 0b9c], [0b9e, 0b9f], [0ba3, 0ba4], [0ba8, 0baa], [0bae, 0bb9],
    [0bd0, 0bd0], [0bf0, 0bf8], [0bfa, 0bfa], [0c05, 0c0c], [0c0e, 0c10],
    [0c12, 0c28], [0c2a, 0c39], [0c3d, 0c3d], [0c58, 0c5a], [0c5d, 0c5d],
    [0c60, 0c61], [0c78, 0c80], [0c85, 0c8c], [0c8e, 0c90], [0c92, 0ca8],
    [0caa, 0cb3], [0cb5, 0cb9], [0cbd, 0cbd], [0cdd, 0cde], [0ce0, 0ce1],
    [0cf1, 0cf2], [0d04, 0d0c], [0d0e, 0d10], [0d12, 0d3a], [0d3d, 0d3d],
    [0d4e, 0d4f], [0d54, 0d56], [0d58, 0d61], [0d70, 0d78], [0d7a, 0d7f],
    [0d85, 0d96], [0d9a, 0db1], [0db3, 0dbb], [0dbd, 0dbd], [0dc0, 0dc6],
    [0df4, 0df4], [0e4f, 0e4f], [0f00, 0f00], [0f05, 0f05], [0f13, 0f13],
    [0f15, 0f17], [0f1a, 0f1f], [0f2a, 0f33], [0f36, 0f36], [0f38, 0f38],
    [0f40, 0f47], [0f49, 0f6c], [0f88, 0f8c], [0fc0, 0fc5], [0fc7, 0fcc],
    [0fce, 0fcf], [0fd4, 0fd8], [104c, 104f], [10a0, 10c5], [10c7, 10c7],
    [10cd, 10cd], [10d0, 10ff], [1200, 1248], [124a, 124d], [1250, 1256],
    [1258, 1258], [125a, 125d], [1260, 1288], [128a, 128d], [1290, 12b0],
    [12b2, 12b5], [12b8, 12be], [12c0, 12c0], [12c2, 12c5], [12c8, 12d6],
    [12d8, 1310], [1312, 1315], [1318, 135a], [1360, 1360], [1362, 137c],
    [1380, 1399], [13a0, 13f5], [13f8, 13fd], [1401, 167f], [1681, 169a],
    [16a0, 16ea], [16ee, 16f8], [1700, 1711], [171f, 1731], [1740, 1751],
    [1760, 176c], [176e, 1770], [17d9, 17d9], [17f0, 17f9], [1800, 1801],
    [1807, 1807], [180a, 180a], [1820, 1878], [1880, 1884], [1887, 18a8],
    [18aa, 18aa], [18b0, 18f5], [1900, 191e], [1940, 1940], [19e0, 1a16],
    [1a1e, 1a1f], [1b05, 1b33], [1b45, 1b4c], [1b5c, 1b5c], [1b61, 1b6a],
    [1b74, 1b7c], [1b83, 1ba0], [1bae, 1baf], [1bba, 1be5], [1bfc, 1c23],
    [1c4d, 1c4f], [1c5a, 1c7d], [1c80, 1c88], [1c90, 1cba], [1cbd, 1cc7],
    [1cd3, 1cd3], [1ce9, 1cec], [1cee, 1cf3], [1cf5, 1cf6], [1cfa, 1cfa],
    ...
    [232b, 23ef], [23f4, 2426], [2440, 244a], [24ff, 24ff], [254c, 254f],
    ...
    [a67e, a69d], [a6a0, a6ef], [a6f2, a6f2], [a700, a7ca], [a7d0, a7d1],
    [a7d3, a7d3], [a7d5, a7d9], [a7f2, a801], [a803, a805], [a807, a80a],
    [a80c, a822], [a828, a82b], [a830, a837], [a839, a839], [a840, a873],
    [a882, a8b3], [a8f2, a8fb], [a8fd, a8fe], [a90a, a925], [a930, a946],
    [a95f, a95f], [a984, a9b2], [a9c1, a9c6], [a9ca, a9cd], [a9cf, a9cf],
    [a9de, a9df], [aa00, aa28], [aa40, aa42], [aa44, aa4b], [aa5c, aa5c],
    [aae0, aaea], [aaf2, aaf4], [ab01, ab06], [ab09, ab0e], [ab11, ab16],
    [ab20, ab26], [ab28, ab2e], [ab30, ab6b], [ab70, abe2], [fb00, fb06],
    [fb13, fb17], [fb29, fb29], [fb50, fbc2], [fbd3, fd3d], [fd40, fd8f],
    [fd92, fdc7], [fdcf, fdcf], [fdf0, fdfb], [fdfd, fdff], [fe70, fe74],
    ...
    [10f00, 10f27], [10f30, 10f45], [10f51, 10f59], [10f70, 10f81],
    [10f86, 10f89], [10fb0, 10fcb], [10fe0, 10ff6], [11003, 11037],
    [11049, 1104d], [11052, 11065], [11071, 11072], [11075, 11075],
    ...
    [1337c, 1342e], [14400, 145cd], [145d0, 14646], [16800, 16a38],
    [16a40, 16a5e], [16a70, 16abe], [16ad0, 16aed], [16b00, 16b2f],
    [16b3a, 16b43], [16b45, 16b45], [16b5b, 16b61], [16b63, 16b77],
    [16b7d, 16b8f], [16e40, 16e96], [16e99, 16e9a], [16f00, 16f4a],
    [16f50, 16f50], [16f93, 16f9f], [18b00, 18cd5], [1aff0, 1aff3],
    [1aff5, 1affb], [1affd, 1affe], [1bc00, 1bc6a], [1bc70, 1bc7c],
    [1bc80, 1bc88], [1bc90, 1bc99], [1bc9c, 1bc9c], [1cf50, 1cfc3],
    [1d000, 1d0f5], [1d100, 1d126], [1d129, 1d164], [1d16a, 1d16c],
    [1d183, 1d184], [1d18c, 1d1a9], [1d1ae, 1d1ea], [1d200, 1d241],
    [1d245, 1d245], [1d2e0, 1d2f3], [1d300, 1d356], [1d360, 1d378],
    ...
    [1da85, 1da86], [1da8b, 1da8b], [1df00, 1df1e], [1e100, 1e12c],
    ...
    {Mixed, 42}, {Empty, 2}, {Mixed, 1}, {Empty, 5}, {Mixed, 5}, {Empty, 1},
    ...
    {Mixed, 3}, {Full, 10}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 1},
    {Mixed, 4}, {Empty, 1}, {Mixed, 3}, {Empty, 251}, {Full, 2},
    {Empty, 694}, {Mixed, 2}, {Full, 8}, {Mixed, 2}, {Full, 1}, {Mixed, 2},
    {Full, 2}, {Mixed, 1}, {Full, 6}, {Mixed, 4}, {Full, 1}, {Mixed, 3},
    ...
    {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 1}, {Mixed, 2}, {Empty, 3},
    ...
    {Mixed, 3}, {Empty, 2}, {Full, 9}, {Mixed, 5}, {Empty, 2}, {Mixed, 3},
    ...
    {Mixed, 1}, {Empty, 9}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Empty, 2},
    {Full, 1}, {Mixed, 25}, {Empty, 2}, {Mixed, 3}, {Empty, 1}, {Mixed, 4},
    {Empty, 4}, {Full, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 2}, {Empty, 5},
    ...
    {Empty, 10}, {Mixed, 1}, {Empty, 5}, {Mixed, 3}, {Full, 28}, {Mixed, 1},
    ...
    {Full, 2}, {Mixed, 1}, {Empty, 4}, {Mixed, 1}, {Full, 2}, {Mixed, 2},
    ...
    {Full, 1}, {Mixed, 1}, {Empty, 39}, {Mixed, 1}, {Full, 6}, {Mixed, 1},
    ...
    0xffff07ff, 0x00037fff, 0x000003ff, 0x00000004, 0xfffffff0, 0x23ffffff,
    ...
    0x27000000, 0xff000003, 0xfffddfe1, 0x23effdff, 0x60000000, 0x00060003,
    ...
    0x03ffffff, 0x3f3fffff, 0xfffffffe, 0x07fffffe, 0x01ffc7ff, 0x8003ffff,
    ...
    0xc07fffff, 0xffffffe0, 0x000fffff, 0x10001fe0, 0x1ff007fe, 0xfffffff8,
    ...
    0xf0ffffff, 0xcfffffff, 0xfc1fffff, 0xffcfffff, 0xffbfffff, 0x200c7fff,
    0xffff20bf, 0x000080ff, 0x007fffff, 0x7f7f7f7f, 0x7f7f7f7f, 0xcc400000,
    0x83e48000, 0x00072800, 0xffff0000, 0x3fffffff, 0xffff1fff, 0x00000c00,
    0xc0087fff, 0x3fffffff, 0x0004ffff, 0x03eb07ff, 0xfffc0000, 0xfffff7bb,
    0x02ff0f07, 0x000fffff, 0xfffffffc, 0x000fffff, 0x6ffc0000, 0xfffffc00,
    0xffff003f, 0x8000007f, 0xfffffff0, 0x0007ffff, 0xc000bc7e, 0x000001ff,
    0x10000ff7, 0x001c07ff, 0x007e7e7e, 0xffff7f7f, 0xffff0fff, 0x00000007,
    0x00f8007f, 0x00000200, 0xffff0000, 0xfff80007, 0x3fffffff, 0xfffcffff,
    0x000080ff, 0xefff0000, 0xffdf0000, 0x1fffffff, 0x00007f00, 0xffffefff,
    ...
    0x1bfbfffb, 0x007fffff, 0x003fffff, 0x000000ff, 0xffffffbf, 0x07fdffff,
    ...
    0x000303ff, 0xffff00ff, 0x03fe003f, 0xffff0000, 0x000003c3, 0xffff0000,
    0x00000fff, 0x007fffff, 0xfffffff8, 0x00ffffff, 0xfffc3e00, 0x0026003f,
    0xfffffff8, 0x3800ffff, 0xffff2000, 0x000001ff, 0xfffffff8, 0x0000007f,
    0xffff0090, 0x0057ffff, 0xfffffff8, 0x0007ffff, 0x1400209e, 0x001ffffe,
    0xfffbffff, 0x24000fff, 0xbfffbd7f, 0xffff01ff, 0x7fffffff, 0xfff99fe0,
    0x23edfdff, 0xe0010000, 0x00000003, 0x001fffff, 0xa0008780, 0x00000003,
    0x0000ffff, 0x000000f0, 0x00007fff, 0x0f0001c0, 0x0000ffff, 0x00000018,
    0x030007ff, 0x08000fff, 0x8007fc00, 0xff6ff27f, 0x8000ffff, 0x00000002,
    0xfffffcff, 0x0001ffff, 0x0000000a, 0xfffff801, 0x0407ffff, 0xf0010041,
    0x200003ff, 0xffff0000, 0x01ffffff, 0xfffffdff, 0x00007fff, 0xfc000001,
    0xfffc1fff, 0x0000ffff, 0xfffffb7f, 0x0001ffff, 0x00000040, 0xfffffdbf,
    0x010003ff, 0x0187ffff, 0x00010000, 0x1fffffff, 0x0003fffe, 0x03ffffff,
    0x00007fff, 0x0000000f, 0xffff0000, 0x0007ffff, 0xc0ffffff, 0xfffffc3b,
    ...
    0xe0fffffb, 0x0000ffff, 0x067fffff, 0x000107ff, 0xfff80000, 0x003fffff,
    0x6fef0000, 0x1fff07ff, 0x13ff01ff, 0xffff0000, 0x0000000f, 0x003fffff,
    0xfffffe7f, 0x00001c1f, 0xfffff018, 0xffffc3ff, 0x000007ff, 0x00000023,
    0x000fffff, 0x007fffff, 0x01ffffff, 0xffdfffff, 0xdfffffff, 0xebffde64,
    0xffffffef, 0xdfdfe7bf, 0x7bffffff, 0xfffdfc5f, 0xffffff3f, 0x00000fff,
    0x07800000, 0xffdfe000, 0x0000086f, 0x7fffffff, 0x3f801fff, 0x0000c000,
    0xffff0000, 0x00003fff, 0x00000fff, 0x7fff6f7f, 0x0000ff9f, 0x0000080f,
    0xfffe0000, 0x001eefff, 0xfffffffe, 0x3fffffff, 0xffffffef, 0x0af7fe96,
    0xaa96ea84, 0x5ef7f796, 0x0ffffbff, 0x0ffffbee, 0x00030000, 0x0000c000,
    0x00001c00, 0x30000000, 0x10600000, 0x00068015, 0xff80007f, 0xfffc001f,
    0x000003ff, 0x0ff00000, 0x03f00000, 0xffff0000, 0xf03fffff, 0x000fffff,
    0x001fffff, 0xffff0fff, 0x03ff00ff, 0xffff00ff, 0x00003fff, 0x00000fff,
    0x000fffff, 0xfff7ffff, 0x000007ff};
    }

    const static UnicodeSet al_Set{const_cast<UnicodeSet::run_t *>(__al_Set_runs), 394, 0, const_cast<UnicodeSet::bitquad_t *>(__al_Set_quads), 447, 0};
    ...
    [20b6, 20b6], [20bb, 20bb], [20be, 20be], [20c0, 20c0], [2103, 2103],
    [2109, 2109], [a838, a838], [fdfc, fdfc], [fe6a, fe6a], [ff05, ff05],
    [ffe0, ffe0], [11fdd, 11fe0], [1ecac, 1ecac], [1ecb0, 1ecb0]**/
    ...
    {Mixed, 1}, {Empty, 149}, {Mixed, 1}, {Empty, 3}, {Mixed, 2},
    ...
    0x00ff0000, 0x48400080, 0x00000001, 0x00000208, 0x01000000, 0x10000000,
    0x00000400, 0x00000020, 0x00000001, 0xe0000000, 0x00000001, 0x00011000};
    }

    const static UnicodeSet po_Set{const_cast<UnicodeSet::run_t *>(__po_Set_runs), 33, 0, const_cast<UnicodeSet::bitquad_t *>(__po_Set_quads), 18, 0};
    ...
    [13288, 13288], [13379, 13379], [13437, 13437], [145ce, 145ce],
    [1e95e, 1e95f]**/
    ...
    0x03ff0000, 0x03ff0000, 0x000003ff, 0x000003ff, 0x000003ff, 0x03ff0000,
    ...
    [1337a, 1337b], [13438, 13438], [145cf, 145cf]**/
    ...
    0x0000001b, 0x38000000, 0x00000284, 0x0c000000, 0x01000000, 0x00008000};
    }
    ...
    [17000, 187f7], [18800, 18aff], [18d00, 18d08], [1b000, 1b122],
    ...
    [1f9d0, 1f9d0], [1f9de, 1f9ff], [1fa54, 1fac2], [1fac6, 1faef],
    [1faf7, 1faff], [1fc00, 1fffd], [20000, 2fffd], [30000, 3fffd]**/
    ...
    {Empty, 279}, {Full, 9}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 11},
    ...
    {Mixed, 1}, {Full, 3}, {Mixed, 2}, {Empty, 8}, {Full, 31}, {Mixed, 1},
    ...
    0x00ffffff, 0x000001ff, 0x00000007, 0xffff0000, 0x0fffffff, 0x0000e000,
    ...
    0xf49fffff, 0xc0011fff, 0xfff00000, 0xffffffc7, 0xff80ffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff};
    }

    const static UnicodeSet id_Set{const_cast<UnicodeSet::run_t *>(__id_Set_runs), 103, 0, const_cast<UnicodeSet::bitquad_t *>(__id_Set_quads), 86, 0};
    ...
    [1f9cd, 1f9cf], [1f9d1, 1f9dd], [1fac3, 1fac5], [1faf0, 1faf6]**/
    ...
    0x3ffee000, 0x00000038, 0x007f0000};
    }
