...
PropertyObject * get_DEP_PropertyObject() {  return & DEP_ns::property_object; }
    namespace DIA_ns {
        ...
        [0dca, 0dca], [0e47, 0e4c], [0e4e, 0e4e], [0eba, 0eba],
        [0ec8, 0ecc], [0f18, 0f19], [0f35, 0f35], [0f37, 0f37],
        [0f39, 0f39], [0f3e, 0f3f], [0f82, 0f84], [0f86, 0f87],
        [0fc6, 0fc6], [1037, 1037], [1039, 103a], [1063, 1064],
        [1069, 106d], [1087, 108d], [108f, 108f], [109a, 109b],
        [135d, 135f], [1714, 1715], [17c9, 17d3], [17dd, 17dd],
        [1939, 193b], [1a75, 1a7c], [1a7f, 1a7f], [1ab0, 1abe],
        [1ac1, 1acb], [1b34, 1b34], [1b44, 1b44], [1b6b, 1b73],
        ...
        [ffe3, ffe3], [102e0, 102e0], [10780, 10785], [10787, 107b0],
        [107b2, 107ba], [10ae5, 10ae6], [10d22, 10d27], [10efd, 10eff],
        [10f46, 10f50], [10f82, 10f85], [11046, 11046], [11070, 11070],
        [110b9, 110ba], [11133, 11134], [11173, 11173], [111c0, 111c0],
        [111ca, 111cc], [11235, 11236], [112e9, 112ea], [1133c, 1133c],
        [1134d, 1134d], [11366, 1136c], [11370, 11374], [11442, 11442],
        [11446, 11446], [114c2, 114c3], [115bf, 115c0], [1163f, 1163f],
        [116b6, 116b7], [1172b, 1172b], [11839, 1183a], [1193d, 1193e],
        [11943, 11943], [119e0, 119e0], [11a34, 11a34], [11a47, 11a47],
        [11a99, 11a99], [11c3f, 11c3f], [11d42, 11d42], [11d44, 11d45],
        [11d97, 11d97], [13447, 13455], [16af0, 16af4], [16b30, 16b36],
        ...
        {Mixed, 3}, {Empty, 1}, {Mixed, 1}, {Empty, 3}, {Mixed, 1},
        ...
        {Mixed, 1}, {Empty, 36}, {Mixed, 2}, {Empty, 25}, {Mixed, 1},
        {Empty, 17}, {Mixed, 1}, {Empty, 13}, {Mixed, 1}, {Empty, 2},
        ...
        {Mixed, 1}, {Empty, 7}, {Mixed, 1}, {Empty, 7}, {Mixed, 2},
        {Empty, 4}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 1},
        {Mixed, 1}, {Empty, 12}, {Mixed, 1}, {Empty, 8}, {Mixed, 1},
        {Empty, 1}, {Mixed, 1}, {Empty, 181}, {Mixed, 1}, {Empty, 436},
        {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 34}, {Mixed, 1},
        {Empty, 2}, {Mixed, 1}, {Empty, 511}, {Mixed, 1}, {Empty, 248},
        {Full, 1}, {Mixed, 2}, {Empty, 16}, {Mixed, 3}, {Empty, 115},
        {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Empty, 5}, {Mixed, 1},
        ...
        0x18000000, 0x00002000, 0x00000400, 0x00005f80, 0x04000000,
        0x00001f00, 0x03000000, 0xc2a00000, 0x000000dc, 0x00000040,
        0x06800000, 0x00003e18, 0x0c00bf80, 0xe0000000, 0x00300000,
        0x200ffe00, 0x0e000000, 0x9fe00000, 0x7fff0000, 0x00000ffe,
        0x00100000, 0x00000010, 0x000ff800, 0x00000c00, 0x00c00000,
        0x3f000000, 0xffff0000, 0x039021ff, 0xfffff000, 0x000007ff,
        0x0000fff0, 0xffe00000, 0xa0000000, 0xe000e003, 0x6000e000,
        ...
        0x00000060, 0x000000fc, 0xe0000000, 0x0001ffc0, 0x0000003c,
        0x00000040, 0x00010000, 0x06000000, 0x00180000, 0x00080000,
        0x00001c01, 0x00600000, 0x00000600, 0x10000000, 0x00002000,
        0x001f1fc0, 0x00000044, 0x0000000c, 0x80000000, 0x00000001,
        0x80000000, 0x00c00000, 0x00000800, 0x06000000, 0x60000000,
        0x00000008, 0x00000001, 0x00100000, 0x00000080, 0x02000000,
        0x80000000, 0x00000034, 0x00800000, 0x003fff80, 0x001f0000,
        0x007f0000, 0xffff8000, 0x00030000, 0x6fef0000, 0xffff3fff,
        0x0000007f, 0xf807e380, 0x00000fe7, 0x00003c00, 0xffff0000,
        0x00003fff, 0x007f0000, 0x00004000, 0x0000f000, 0x007f0000,
        0x00000770};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 224, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 161, 0};
...
PropertyObject * get_DIA_PropertyObject() {  return & DIA_ns::property_object; }
    namespace EXT_ns {
        ...
        [10781, 10782], [1135d, 1135d], [115c6, 115c8], [11a98, 11a98],
        [16b42, 16b43], [16fe0, 16fe1], [16fe3, 16fe3], [1e13c, 1e13d],
        [1e944, 1e946]**/
        ...
        {Empty, 675}, {Mixed, 1}, {Empty, 64}, {Mixed, 1}, {Empty, 93},
        {Mixed, 1}, {Empty, 19}, {Mixed, 1}, {Empty, 37}, {Mixed, 1},
        {Empty, 645}, {Mixed, 1}, {Empty, 36}, {Mixed, 1}, {Empty, 905},
        {Mixed, 1}, {Empty, 64}, {Mixed, 1}, {Empty, 30901}};
        const static UnicodeSet::bitquad_t  __codepoint_set_quads[] = {
        ...
        0x00010000, 0x20000000, 0x00180000, 0x00010000, 0x00000006,
        0x20000000, 0x000001c0, 0x01000000, 0x0000000c, 0x0000000b,
        0x30000000, 0x00000070};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 59, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 32, 0};
...
PropertyObject * get_ID_COMPAT_MATH_START_PropertyObject() {  return & ID_COMPAT_MATH_START_ns::property_object; }
    namespace IDEO_ns {
        ...
        {Full, 38}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 290},
        ...
        0x00ffffff, 0x003fffff, 0x000001ff, 0xffff0000, 0x0fffffff,
        0x03ffffff, 0x3fffffff, 0xffff0003, 0xffff0001, 0x3fffffff,
        0x3fffffff, 0xffff07ff, 0x0000ffff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 45, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 18, 0};
...
PropertyObject * get_NCHAR_PropertyObject() {  return & NCHAR_ns::property_object; }
    namespace OALPHA_ns {
        ...
        [0bc6, 0bc8], [0bca, 0bcc], [0bd7, 0bd7], [0c00, 0c04],
        [0c3e, 0c44], [0c46, 0c48], [0c4a, 0c4c], [0c55, 0c56],
        [0c62, 0c63], [0c81, 0c83], [0cbe, 0cc4], [0cc6, 0cc8],
        [0cca, 0ccc], [0cd5, 0cd6], [0ce2, 0ce3], [0cf3, 0cf3],
        [0d00, 0d03], [0d3e, 0d44], [0d46, 0d48], [0d4a, 0d4c],
        [0d57, 0d57], [0d62, 0d63], [0d81, 0d83], [0dcf, 0dd4],
        [0dd6, 0dd6], [0dd8, 0ddf], [0df2, 0df3], [0e31, 0e31],
        [0e34, 0e3a], [0e4d, 0e4d], [0eb1, 0eb1], [0eb4, 0eb9],
        [0ebb, 0ebc], [0ecd, 0ecd], [0f71, 0f83], [0f8d, 0f97],
        [0f99, 0fbc], [102b, 1036], [1038, 1038], [103b, 103e],
        [1056, 1059], [105e, 1060], [1062, 1064], [1067, 106d],
        [1071, 1074], [1082, 108d], [108f, 108f], [109a, 109d],
        [1712, 1713], [1732, 1733], [1752, 1753], [1772, 1773],
        [17b6, 17c8], [1885, 1886], [18a9, 18a9], [1920, 192b],
        [1930, 1938], [1a17, 1a1b], [1a55, 1a5e], [1a61, 1a74],
        [1abf, 1ac0], [1acc, 1ace], [1b00, 1b04], [1b35, 1b43],
        [1b80, 1b82], [1ba1, 1ba9], [1bac, 1bad], [1be7, 1bf1],
        [1c24, 1c36], [1de7, 1df4], [24b6, 24e9], [2de0, 2dff],
        [a674, a67b], [a69e, a69f], [a802, a802], [a80b, a80b],
        [a823, a827], [a880, a881], [a8b4, a8c3], [a8c5, a8c5],
        [a8ff, a8ff], [a926, a92a], [a947, a952], [a980, a983],
        [a9b4, a9bf], [a9e5, a9e5], [aa29, aa36], [aa43, aa43],
        [aa4c, aa4d], [aa7b, aa7d], [aab0, aab0], [aab2, aab4],
        [aab7, aab8], [aabe, aabe], [aaeb, aaef], [aaf5, aaf5],
        [abe3, abea], [fb1e, fb1e], [10376, 1037a], [10a01, 10a03],
        [10a05, 10a06], [10a0c, 10a0f], [10d24, 10d27], [10eab, 10eac],
        ...
        [1171d, 1172a], [1182c, 11838], [11930, 11935], [11937, 11938],
        [1193b, 1193c], [11940, 11940], [11942, 11942], [119d1, 119d7],
        [119da, 119df], [119e4, 119e4], [11a01, 11a0a], [11a35, 11a39],
        ...
        [11f3e, 11f40], [16f4f, 16f4f], [16f51, 16f87], [16f8f, 16f92],
        ...
        {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 10}, {Mixed, 7},
        ...
        {Mixed, 1}, {Empty, 10}, {Mixed, 4}, {Empty, 639}, {Mixed, 1},
        ...
        0x00000004, 0xc0000000, 0x00801dc7, 0x0000001f, 0xc0000000,
        0x00601ddf, 0x0000000c, 0x0000000e, 0xc0000000, 0x00601ddf,
        0x0008000c, 0x0000000f, 0xc0000000, 0x00801ddf, 0x0000000c,
        0x0000000e, 0xff5f8000, 0x000c0000, 0x07f20000, 0x00002000,
        0x1bf20000, 0x00002000, 0xfffe0000, 0xfeffe00f, 0x1fffffff,
        ...
        0x001ffffe, 0x80000000, 0x00007001, 0x0000001f, 0xffe00000,
        ...
        0xc0000000, 0x0080199f, 0x0000000c, 0xffe00000, 0x0000003b,
        0xffff0000, 0x00000003, 0x7f3f8000, 0x30000000, 0x7fff0000,
        0x00000001, 0x003ff800, 0xe0000000, 0x000007ff, 0x01fff000,
        0x19bf0000, 0x00000005, 0xfcfe0000, 0x00000010, 0x000007fe,
        0x7be00000, 0x0ffe0000, 0x00fffc00, 0x7f7f8000, 0xfffc0000,
        0x007ffeff, 0xb47e0000, 0x0000008b, 0x007b7c00, 0x00780000,
        0x0000000b, 0xc7f00000, 0x00000001, 0xfffe8000, 0x000780ff,
        0x00030000, 0x40000000, 0xf9ffff7f, 0x000007db, 0x00008000,
        0x00000080, 0xffff0000, 0xffff03ff, 0xffff03ff, 0x000003ff};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 145, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 175, 0};
...
PropertyObject * get_SD_PropertyObject() {  return & SD_ns::property_object; }
    namespace STERM_ns {
        ...
        [1b7d, 1b7e], [1c3b, 1c3c], [1c7e, 1c7f], [203c, 203d],
        [2047, 2049], [2e2e, 2e2e], [2e3c, 2e3c], [2e53, 2e54],
        [3002, 3002], [a4ff, a4ff], [a60e, a60f], [a6f3, a6f3],
        [a6f7, a6f7], [a876, a877], [a8ce, a8cf], [a92f, a92f],
        [a9c8, a9c9], [aa5d, aa5f], [aaf0, aaf1], [abeb, abeb],
        [fe52, fe52], [fe56, fe57], [ff01, ff01], [ff0e, ff0e],
        ...
        {Empty, 4}, {Mixed, 1}, {Empty, 7}, {Mixed, 1}, {Empty, 658},
        {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 2}, {Mixed, 1},
        {Empty, 86}, {Mixed, 1}, {Empty, 39}, {Mixed, 1}, {Empty, 1},
        ...
        {Empty, 1}, {Mixed, 1}, {Empty, 13}, {Mixed, 1}, {Empty, 20},
        {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 600}, {Mixed, 1},
        ...
        0x00000f00, 0xcc000000, 0x60000000, 0x18000000, 0xc0000000,
        0x30000000, 0x00000380, 0x10004000, 0x00180000, 0x00000004,
        0x80000000, 0x0000c000, 0x00880000, 0x00c00000, 0x0000c000,
        0x00008000, 0x00000300, 0xe0000000, 0x00030000, 0x00000800,
        0x00c40000, 0x80004002, 0x00000002, 0x00c00000, 0x03e00000,
        0x000003c0, 0x00000180, 0xc0000000, 0x00000003, 0x0000000e,
        0xc0002060, 0x1b000000, 0x00000200, 0x00001800, 0x00fffe0c,
        0x00000006, 0x70000000, 0x00000050, 0x0000000c, 0x18000000,
        0x00000006, 0x01800000, 0x00000018, 0x0000c000, 0x00200000,
        0x01800000, 0x00000010, 0x01000000, 0x80000000, 0x00000100};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 121, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 65, 0};
...
PropertyObject * get_STERM_PropertyObject() {  return & STERM_ns::property_object; }
    namespace TERM_ns {
        ...
        [1aa8, 1aab], [1b5a, 1b5b], [1b5d, 1b5f], [1b7d, 1b7e],
        [1c3b, 1c3f], [1c7e, 1c7f], [203c, 203d], [2047, 2049],
        ...
        [10af0, 10af5], [10b3a, 10b3f], [10b99, 10b9c], [10f55, 10f59],
        [10f86, 10f89], [11047, 1104d], [110be, 110c1], [11141, 11143],
        [111c5, 111c6], [111cd, 111cd], [111de, 111df], [11238, 1123c],
        [112a9, 112a9], [1144b, 1144d], [1145a, 1145b], [115c2, 115c5],
        [115c9, 115d7], [11641, 11642], [1173c, 1173e], [11944, 11944],
        ...
        {Mixed, 1}, {Empty, 29}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
        ...
        {Empty, 16}, {Mixed, 1}, {Empty, 7}, {Mixed, 1}, {Empty, 1},
        {Mixed, 2}, {Empty, 12}, {Mixed, 2}, {Empty, 19}, {Mixed, 1},
        {Empty, 2}, {Mixed, 1}, {Empty, 40}, {Mixed, 1}, {Empty, 559},
        {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
        {Empty, 25}, {Mixed, 1}, {Empty, 623}, {Mixed, 1}, {Empty, 239},
        {Mixed, 1}, {Empty, 31019}};
        const static UnicodeSet::bitquad_t  __codepoint_set_quads[] = {
        0x8c005002, 0x40000000, 0x00000080, 0x00000200, 0x00000008,
        0xe8001000, 0x00100000, 0x000017ff, 0x03000000, 0x7fff0000,
        0x40000000, 0x00000030, 0x0c000000, 0x0007e100, 0x00000c00,
        0x000001fe, 0x00004000, 0x00003800, 0x00600000, 0x04700000,
        0x0000033c, 0x00000030, 0x00000f00, 0xec000000, 0x60000000,
        0xf8000000, 0xc0000000, 0x30000000, 0x00000380, 0x10004000,
        0x0018d002, 0x00000006, 0xc0000000, 0x0000e000, 0x00f80000,
        0x00c00000, 0x0000c000, 0x00008000, 0x00000380, 0xe0000000,
        0x80000000, 0x00030000, 0x00000800, 0x00f70000, 0x8c005002,
        0x00000012, 0x80000000, 0x00010000, 0x00800000, 0x80000000,
        0x00c00000, 0x003f0000, 0xfc000000, 0x1e000000, 0x03e00000,
        0x000003c0, 0x00003f80, 0xc0000000, 0x00000003, 0x0000000e,
        0xc0002060, 0x1f000000, 0x00000200, 0x0c003800, 0x00fffe3c,
        0x00000006, 0x70000000, 0x00000050, 0x0000000c, 0x18000000,
        0x00000006, 0x0000000e, 0x00020000, 0x01800000, 0x00000018,
        0x001f0000, 0x0000c000, 0x00200000, 0x03800000, 0x00000010,
        0x01800000, 0x80000000, 0x00000780};
        }

        const static UnicodeSet codepoint_set{const_cast<UnicodeSet::run_t *>(__codepoint_set_runs), 147, 0, const_cast<UnicodeSet::bitquad_t *>(__codepoint_set_quads), 83, 0};
