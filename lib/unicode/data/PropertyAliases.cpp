...
namespace UCD {
    const static std::vector<std::string> property_enum_name = {
        ...
        "na", "na1", "Name_Alias", "scx", "age", "blk", "sc", "bc", "bpt",
        "ccc", "dt", "ea", "gc", "GCB", "hst", "InCB", "InPC", "InSC", "jg",
        "jt", "lb", "NFC_QC", "NFD_QC", "NFKC_QC", "NFKD_QC", "nt", "SB",
        "vo", "WB", "AHex", "Alpha", "Bidi_C", "Bidi_M", "Cased", "CE",
        "CI", "Comp_Ex", "CWCF", "CWCM", "CWKCF", "CWL", "CWT", "CWU",
        "Dash", "Dep", "DI", "Dia", "EBase", "EComp", "EMod", "Emoji",
        "EPres", "Ext", "ExtPict", "Gr_Base", "Gr_Ext", "Gr_Link", "Hex",
        "Hyphen", "ID_Compat_Math_Continue", "ID_Compat_Math_Start", "IDC",
        "Ideo", "IDS", "IDSB", "IDST", "IDSU", "Join_C", "LOE", "Lower",
        "Math", "NChar", "OAlpha", "ODI", "OGr_Ext", "OIDC", "OIDS",
        "OLower", "OMath", "OUpper", "Pat_Syn", "Pat_WS", "PCM", "QMark",
        "Radical", "RI", "SD", "STerm", "Term", "UIdeo", "Upper", "VS",
