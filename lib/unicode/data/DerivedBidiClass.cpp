...
namespace UCD {
  namespace BC_ns {
    ...
    [3040, 3098], [309d, 309f], [30a1, 30fa], [30fc, 31bf], [31e4, 31ee],
    ...
    [11f41, 11f41], [11f43, 11fd4], [11ff2, 1343f], [13441, 13446],
    [13456, 16aef], [16af5, 16b2f], [16b37, 16f4e], [16f50, 16f8e],
    [16f93, 16fe1], [16fe3, 16fe3], [16fe5, 1bc9c], [1bc9f, 1bc9f],
    [1bca4, 1ceff], [1cf2e, 1cf2f], [1cf47, 1d166], [1d16a, 1d172],
    ...
    [1e137, 1e2ad], [1e2af, 1e2eb], [1e2f0, 1e2fe], [1e300, 1e4eb],
    [1e4f0, 1e7ff], [1f02c, 1f02f], [1f094, 1f09f], [1f0af, 1f0b0],
    ...
    [1fbfa, 1fffd], [20000, 2fffd], [30000, 3fffd], [40000, 4fffd],
    ...
    {Mixed, 4}, {Full, 2}, {Mixed, 2}, {Full, 3}, {Mixed, 6}, {Full, 5},
    ...
    {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 10}, {Mixed, 4}, {Full, 3},
    {Mixed, 2}, {Full, 162}, {Mixed, 1}, {Full, 436}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Full, 32}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 2},
    {Mixed, 1}, {Full, 612}, {Mixed, 2}, {Full, 146}, {Empty, 1},
    {Mixed, 2}, {Full, 16}, {Mixed, 3}, {Full, 1}, {Mixed, 1}, {Empty, 2},
    ...
    {Empty, 1}, {Mixed, 3}, {Full, 42}, {Mixed, 2}, {Full, 2}, {Mixed, 1},
    {Full, 4}, {Mixed, 1}, {Full, 11}, {Mixed, 1}, {Full, 1}, {Mixed, 1},
    {Full, 15}, {Mixed, 1}, {Full, 24}, {Empty, 65}, {Mixed, 1}, {Empty, 2},
    ...
    0xe1ffffff, 0xfffffffe, 0xf7ffffff, 0xffff7ff0, 0x9fffffff, 0x0000ffff,
    ...
    0x4fc3ffff, 0xcffffffe, 0x5807ffff, 0xfffffffe, 0xffffe000, 0xff40d7ff,
    0x1fffffff, 0xfffff043, 0xf9007fff, 0xa7ffffff, 0xfffffff7, 0xf30fffff,
    0xfffffffe, 0xfffff981, 0x8607ffff, 0xf181ff7f, 0xfc8003ff, 0xc080ffff,
    0x0003ffff, 0xff920300, 0x4b81ffff, 0xffffff40, 0xff5cffff, 0xffe7ffff,
    0xfffffffc, 0xf83fffff, 0xfffffffa, 0x001fffff, 0xfffc0000, 0xffc0007e,
    0xffe0ffff, 0xff80ffff, 0xffff7fff, 0xfff87fff, 0xffffffeb, 0x9fffffff,
    0xfffffff0, 0x0000c000, 0xffffff80, 0x0007fc7f, 0xfffff018, 0xffffc3ff,
    0xfffff9ff, 0xffffffc0, 0xff800000, 0xf7ffffff, 0xffdfffff, 0xffff7fff,
    ...
    0xffff0fff, 0x0000f000, 0xfff00000, 0x00018000, 0x00010001, 0xffc00000,
    0xffff0000, 0xffff7fff, 0xffff03ff, 0xffffdfff, 0xffffffc0, 0x0f000000,
    0xe000e000, 0x07800000, 0xfc000000, 0xfffef000, 0x0000f000, 0xfc00ff00,
    0x0000ff00, 0xfffcc000, 0xfff00000, 0xe000c000, 0x0000fe00, 0x40000000,
    0xf0003fc0, 0xfe00fe00, 0x00080000, 0xfffff800, 0xfc00ffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff};
    }

    const static UnicodeSet l_Set{const_cast<UnicodeSet::run_t *>(__l_Set_runs), 333, 0, const_cast<UnicodeSet::bitquad_t *>(__l_Set_quads), 309, 0};
    ...
    0x08000000, 0x0000800f, 0x60000000, 0xffff0000, 0x70000000, 0xfffe0000,
    ...
    0x00002000, 0x0000003f, 0xf0ffffff, 0x1fff1fff, 0xf87fffff, 0x03ffffff,
    ...
    0x06ff8000, 0x58000000, 0x00000008, 0x0cf00000, 0x00000001, 0x0000067e,
    0x79f80000, 0x0e7e0080, 0x037ffc00, 0x3f7f0000, 0xfffc0000, 0x006dfcff,
    ...
    const static UnicodeSet nsm_Set{const_cast<UnicodeSet::run_t *>(__nsm_Set_runs), 207, 0, const_cast<UnicodeSet::bitquad_t *>(__nsm_Set_quads), 214, 0};
