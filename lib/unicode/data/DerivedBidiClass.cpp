...
namespace UCD {
  namespace BC_ns {
    ...
    [119e1, 11a00], [11a07, 11a08], [11a0b, 11a32], [11a39, 11a3a],
    [11a3f, 11a46], [11a48, 11a50], [11a57, 11a58], [11a5c, 11a89],
    [11a97, 11a97], [11a9a, 11c2f], [11c37, 11c37], [11c3e, 11c91],
    [11ca8, 11ca9], [11cb1, 11cb1], [11cb4, 11cb4], [11cb7, 11d30],
    [11d37, 11d39], [11d3b, 11d3b], [11d3e, 11d3e], [11d46, 11d46],
    [11d48, 11d8f], [11d92, 11d94], [11d96, 11d96], [11d98, 11ef2],
    [11ef5, 11fd4], [11ff2, 16aef], [16af5, 16b2f], [16b37, 16f4e],
    [16f50, 16f8e], [16f93, 16fe1], [16fe3, 16fe3], [16fe5, 1bc9c],
    [1bc9f, 1bc9f], [1bca4, 1ceff], [1cf2e, 1cf2f], [1cf47, 1d166],
    [1d16a, 1d172], [1d183, 1d184], [1d18c, 1d1a9], [1d1ae, 1d1e8],
    [1d1eb, 1d1ff], [1d246, 1d2ff], [1d357, 1d6da], [1d6dc, 1d714],
    ...
    [1e019, 1e01a], [1e022, 1e022], [1e025, 1e025], [1e02b, 1e12f],
    [1e137, 1e2ad], [1e2af, 1e2eb], [1e2f0, 1e2fe], [1e300, 1e7ff],
    [1f02c, 1f02f], [1f094, 1f09f], [1f0af, 1f0b0], [1f0c0, 1f0c0],
    [1f0d0, 1f0d0], [1f0f6, 1f0ff], [1f110, 1f12e], [1f130, 1f169],
    [1f170, 1f1ac], [1f1ae, 1f25f], [1f266, 1f2ff], [1f6d8, 1f6dc],
    ...
    {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 10}, {Mixed, 1}, {Full, 6},
    {Mixed, 2}, {Full, 599}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 32},
    ...
    {Mixed, 2}, {Full, 7}, {Mixed, 1}, {Full, 11}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Full, 40}, {Empty, 65}, {Mixed, 1}, {Empty, 2}, {Mixed, 6},
    {Full, 1}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 5}, {Mixed, 1},
    {Full, 4}, {Empty, 30}, {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Empty, 2},
    {Mixed, 3}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Full, 2},
    {Empty, 10}, {Mixed, 6}, {Empty, 4}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
    ...
    0x07ffffff, 0x00200000, 0xffffff80, 0xfffff800, 0xf0000000, 0x000003ff,
    0x00001000, 0x00300000, 0x00400000, 0x01fc781f, 0x7fffffff, 0xc0000000,
    0x04000000, 0xfff00000, 0xffc00000, 0xf000ffff, 0x000000e0, 0x1f3ec3fe,
    0xe1ffffff, 0xfffffffe, 0xf7ffffff, 0xfffffff0, 0x9fffffff, 0x0000ffff,
    ...
    0x9fffffff, 0xfffffff0, 0x0000c000, 0xffffff80, 0x0007fc7f, 0xfffff018,
    0xffffc3ff, 0xfffff9ff, 0xffffffc0, 0xff800000, 0xf7ffffff, 0xffdfffff,
    0xffff7fff, 0xfffffdff, 0x00003ff7, 0x07800000, 0xffdfe000, 0x07ffffef,
    0xffff0001, 0x06000080, 0xfffff824, 0xff80ffff, 0xffffbfff, 0x7fff0fff,
    0x0000f000, 0xfff00000, 0x00018000, 0x00010001, 0xffc00000, 0xffff0000,
    0xffff7fff, 0xffff03ff, 0xffffdfff, 0xffffffc0, 0x1f000000, 0xe000e000,
    ...
    0xff80ff00, 0x00080000, 0xfffff800, 0xfc00ffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff};
    }

    const static UnicodeSet l_Set{const_cast<UnicodeSet::run_t *>(__l_Set_runs), 327, 0, const_cast<UnicodeSet::bitquad_t *>(__l_Set_quads), 302, 0};
    ...
    [10a3b, 10a3e], [10a40, 10ae4], [10ae7, 10b38], [10b40, 10cff],
    [10d40, 10e5f], [10e7f, 10eaa], [10ead, 10f2f], [10f70, 10f81],
    [10f86, 10fff], [1e800, 1e8cf], [1e8d7, 1e943], [1e94b, 1ec6f],
    [1ecc0, 1ecff], [1ed50, 1edff], [1ef00, 1efff]**/


    namespace {
    const static UnicodeSet::run_t __r_Set_runs[] = {
    {Empty, 44}, {Mixed, 3}, {Full, 1}, {Empty, 14}, {Full, 1}, {Mixed, 4},
    {Empty, 189}, {Mixed, 1}, {Empty, 1751}, {Mixed, 3}, {Empty, 101},
    {Full, 8}, {Mixed, 1}, {Full, 7}, {Mixed, 2}, {Full, 5}, {Mixed, 1},
    {Full, 1}, {Mixed, 1}, {Full, 14}, {Empty, 2}, {Full, 9}, {Mixed, 1},
    {Full, 1}, {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Empty, 1}, {Mixed, 2},
    {Full, 3}, {Empty, 1728}, {Full, 6}, {Mixed, 1}, {Full, 3}, {Mixed, 1},
    {Full, 24}, {Mixed, 1}, {Empty, 2}, {Full, 2}, {Empty, 2}, {Mixed, 1},
    {Full, 5}, {Empty, 8}, {Full, 8}, {Empty, 30848}};
    const static UnicodeSet::bitquad_t  __r_Set_quads[] = {
    0x00010000, 0x40000000, 0xffffff49, 0xdc3007ff, 0x043fffff, 0xffffc110,
    0xf1ffffff, 0x00008000, 0xa0000000, 0xfffffdff, 0x0000ffff, 0x7fffffff,
    0xffff0f91, 0x78ffffff, 0xffffff9f, 0x01ffffff, 0x80000000, 0xffffe7ff,
    0x0000ffff, 0xffff0000, 0xffffffc3, 0xff80ffff, 0xfffff80f, 0x0000ffff,
    0xffff0000};
    }

    const static UnicodeSet r_Set{const_cast<UnicodeSet::run_t *>(__r_Set_runs), 45, 0, const_cast<UnicodeSet::bitquad_t *>(__r_Set_quads), 25, 0};
    ...
    [08e2, 08e2], [10d30, 10d39], [10e60, 10e7e]**/
    ...
    {Mixed, 1}, {Empty, 9}, {Mixed, 1}, {Empty, 32652}};
    const static UnicodeSet::bitquad_t  __an_Set_quads[] = {
    0x0000003f, 0x00001bff, 0x20000000, 0x00030000, 0x00000004, 0x03ff0000,
    0x7fffffff};
    }

    const static UnicodeSet an_Set{const_cast<UnicodeSet::run_t *>(__an_Set_runs), 15, 0, const_cast<UnicodeSet::bitquad_t *>(__an_Set_quads), 7, 0};
    ...
    [a828, a82b], [a874, a877], [ab6a, ab6b], [fd3e, fd4f], [fdcf, fdcf],
    [fdfd, fdff], [fe10, fe19], [fe30, fe4f], [fe51, fe51], [fe54, fe54],
    [fe56, fe5e], [fe60, fe61], [fe64, fe66], [fe68, fe68], [fe6b, fe6b],
    [ff01, ff02], [ff06, ff0a], [ff1b, ff20], [ff3b, ff40], [ff5b, ff65],
    [ffe2, ffe4], [ffe8, ffee], [fff9, fffd], [10101, 10101],
    [10140, 1018c], [10190, 1019c], [101a0, 101a0], [1091f, 1091f],
    [10b39, 10b3f], [11052, 11065], [11660, 1166c], [11fd5, 11fdc],
    [11fe1, 11ff1], [16fe2, 16fe2], [1d1e9, 1d1ea], [1d200, 1d241],
    ...
    {Mixed, 2}, {Empty, 639}, {Mixed, 1}, {Empty, 783}, {Mixed, 1},
    ...
    0xfe000000, 0xfffc0000, 0x0000003f, 0x00001fff, 0x1fe00000, 0x0003fffe,
    0x00000004, 0x00000600, 0x00000023, 0x007fffff, 0x08000000, 0x00200000,
    0x00008000, 0x00000200, 0x00000008, 0x00030000, 0xffff0fff, 0x000fffff,
    0xfffe7fff, 0xfffefffe, 0x003fffff, 0x0000f800, 0x00008000, 0x0000fc00,
    0x00002000, 0x0000003f, 0xe0ffffff, 0x1fff1fff, 0x000fffff, 0x01ffffff,
    ...
    const static UnicodeSet on_Set{const_cast<UnicodeSet::run_t *>(__on_Set_runs), 183, 0, const_cast<UnicodeSet::bitquad_t *>(__on_Set_quads), 139, 0};
    ...
    [11a98, 11a99], [11c30, 11c36], [11c38, 11c3d], [11c92, 11ca7],
    ...
    const static UnicodeSet nsm_Set{const_cast<UnicodeSet::run_t *>(__nsm_Set_runs), 199, 0, const_cast<UnicodeSet::bitquad_t *>(__nsm_Set_quads), 206, 0};
    ...
    [074b, 07a5], [07b1, 07bf], [0860, 088f], [0892, 0897], [08a0, 08c9],
    [fb50, fd3d], [fd50, fdce], [fdf0, fdfc], [fe70, fefe], [10d00, 10d23],
    ...
    {Full, 2}, {Mixed, 1}, {Empty, 5}, {Full, 1}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Empty, 1939}, {Mixed, 1}, {Full, 14}, {Mixed, 2},
    {Full, 3}, {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Full, 3}, {Mixed, 1},
    ...
    0x0000ffff, 0xfffff800, 0xfffe003f, 0x00fcffff, 0x000003ff, 0xffff0000,
    0x3fffffff, 0xffff0000, 0x00007fff, 0x1fff0000, 0xffff0000, 0x7fffffff,
    0xfc00ff0f, 0xffff0000, 0xfffe003f, 0x0000ffff, 0xffff0000, 0x0000ffff,
    0xfffcffff};
    }

    const static UnicodeSet al_Set{const_cast<UnicodeSet::run_t *>(__al_Set_runs), 38, 0, const_cast<UnicodeSet::bitquad_t *>(__al_Set_quads), 25, 0};
