...
namespace UCD {
  namespace INSC_ns {
    ...
    [11448, 1144f], [1145a, 1145d], [11462, 11480], [114c5, 114cf],
    [114da, 1157f], [115b6, 115b7], [115c1, 115d7], [115de, 115ff],
    [11641, 1164f], [1165a, 1167f], [116b9, 116bf], [116ca, 116ff],
    [1171b, 1171c], [1172c, 1172f], [1173c, 1173f], [11747, 117ff],
    [1183b, 118ff], [11907, 11908], [1190a, 1190b], [11914, 11914],
    [11917, 11917], [11936, 11936], [11939, 1193a], [11944, 1194f],
    [1195a, 1199f], [119a8, 119a9], [119d8, 119d9], [119e2, 119e3],
    [119e5, 119ff], [11a40, 11a44], [11a46, 11a46], [11a48, 11a4f],
    [11a9a, 11a9c], [11a9e, 11bff], [11c09, 11c09], [11c37, 11c37],
    ...
    [11f3b, 11f3d], [11f43, 11f4f], [11f5a, 10ffff]**/
    ...
    {Mixed, 1}, {Full, 1}, {Empty, 1}, {Mixed, 2}, {Full, 1}, {Mixed, 3},
    {Full, 5}, {Empty, 1}, {Mixed, 1}, {Full, 6}, {Mixed, 3}, {Full, 2},
    {Mixed, 3}, {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 11},
    {Mixed, 6}, {Full, 2}, {Mixed, 6}, {Full, 9}, {Mixed, 4}, {Full, 32517}};
    ...
    0xfc00f800, 0x00066010, 0x04120200, 0x3f7fc660, 0xffe0e030, 0x3c00ff00,
    0xfffffffc, 0x00000001, 0xfc00ffe0, 0x00c00000, 0xc0fffffe, 0xfc00fffe,
    0xfe000000, 0xfffffc00, 0x18000000, 0xf000f000, 0xffffff80, 0xf8000000,
    0x00900d80, 0x06400000, 0xfc00fff0, 0x00000300, 0x03000000, 0xffffffec,
    0x0000ff5f, 0xdc000000, 0x00000200, 0x00800000, 0x0000fffe, 0x0003e000,
    0x00030000, 0xff800100, 0x00000480, 0x4b800000, 0xfc00ff00, 0x00000240,
    0xff048000, 0xfffffc00, 0xff800000, 0x00020000, 0x38000000, 0xfc00fff8};
    }

    const static UnicodeSet other_Set{const_cast<UnicodeSet::run_t *>(__other_Set_runs), 119, 0, const_cast<UnicodeSet::bitquad_t *>(__other_Set_quads), 156, 0};
    ...
    [11443, 11444], [1145f, 1145f], [114bf, 114c0], [115bc, 115bd],
    [1163d, 1163d], [116ab, 116ab], [11837, 11837], [1193b, 1193c],
    [119de, 119de], [11a35, 11a38], [11a96, 11a96], [11c3c, 11c3d],
    [11cb5, 11cb6], [11d40, 11d40], [11d95, 11d95], [11f00, 11f01]**/
    ...
    {Empty, 1}, {Mixed, 1}, {Empty, 11}, {Mixed, 1}, {Empty, 32519}};
    ...
    0x00100000, 0x80000000, 0x00000007, 0xc0000000, 0x80000018, 0x80000000,
    0x00000001, 0x30000000, 0x20000000, 0x00000800, 0x00800000, 0x18000000,
    0x40000000, 0x01e00000, 0x00400000, 0x30000000, 0x00600000, 0x00000001,
    0x00200000, 0x00000003};
    }

    const static UnicodeSet bindu_Set{const_cast<UnicodeSet::run_t *>(__bindu_Set_runs), 99, 0, const_cast<UnicodeSet::bitquad_t *>(__bindu_Set_quads), 56, 0};
    ...
    0x02000000, 0x00800000, 0x40000000, 0x00000002, 0x00400000, 0x00000008};
    }

    const static UnicodeSet visarga_Set{const_cast<UnicodeSet::run_t *>(__visarga_Set_runs), 73, 0, const_cast<UnicodeSet::bitquad_t *>(__visarga_Set_quads), 36, 0};
    ...
    0x04000000, 0x00000008, 0x00000004};
    }

    const static UnicodeSet nukta_Set{const_cast<UnicodeSet::run_t *>(__nukta_Set_runs), 55, 0, const_cast<UnicodeSet::bitquad_t *>(__nukta_Set_quads), 27, 0};
    ...
    [11070, 11070], [11134, 11134], [112ea, 112ea], [1172b, 1172b],
    ...
    {Empty, 8}, {Mixed, 1}, {Empty, 20}, {Mixed, 1}, {Empty, 803},
    {Mixed, 1}, {Empty, 5}, {Mixed, 1}, {Empty, 13}, {Mixed, 1},
    {Empty, 33}, {Mixed, 1}, {Empty, 15}, {Mixed, 1}, {Empty, 7},
    ...
    0x00300000, 0x00100000, 0x00020000, 0x04000000, 0x00000400, 0x000c0000,
    0x00001000, 0x00080000, 0x00002000, 0x00010000, 0x00100000, 0x00000400,
    0x00000800, 0x20000000, 0x00100000, 0x00000010, 0x00000002};
    }

    const static UnicodeSet pure_killer_Set{const_cast<UnicodeSet::run_t *>(__pure_killer_Set_runs), 43, 0, const_cast<UnicodeSet::bitquad_t *>(__pure_killer_Set_quads), 23, 0};
    ...
    [11a99, 11a99], [11d45, 11d45], [11d97, 11d97], [11f42, 11f42]**/
    ...
    const static UnicodeSet invisible_stacker_Set{const_cast<UnicodeSet::run_t *>(__invisible_stacker_Set_runs), 27, 0, const_cast<UnicodeSet::bitquad_t *>(__invisible_stacker_Set_quads), 13, 0};
    ...
    [11360, 11361], [11400, 1140d], [11481, 1148e], [11580, 1158d],
    ...
    [11d67, 11d68], [11d6a, 11d6b], [11f04, 11f10]**/
    ...
    {Empty, 2}, {Mixed, 1}, {Empty, 2}, {Mixed, 1}, {Empty, 4}, {Mixed, 1},
    ...
    {Empty, 2}, {Mixed, 1}, {Empty, 12}, {Mixed, 1}, {Empty, 32519}};
    ...
    0x00000001, 0x0000000f, 0x03ff0000, 0x00199fe0, 0x00000003, 0x00003fff,
    0x00007ffe, 0x00003fff, 0x0f000000, 0x00003fff, 0x000003ff, 0x000003ff,
    0x0000027f, 0x00003cff, 0x00000001, 0x00010000, 0x00003dff, 0x00000b7f,
    0x00000dbf, 0x0001fff0};
    }

    const static UnicodeSet vowel_independent_Set{const_cast<UnicodeSet::run_t *>(__vowel_independent_Set_runs), 97, 0, const_cast<UnicodeSet::bitquad_t *>(__vowel_independent_Set_quads), 62, 0};
    ...
    [11362, 11363], [11435, 11441], [114b0, 114be], [115af, 115b5],
    ...
    0x007ff000, 0x01bf0000, 0x3cfe0000, 0x00000010, 0x000007fe, 0x0ffe0000,
    0x0f7f8000, 0x001f0000, 0xb47e0000, 0x00000008, 0x001b7c00, 0x00780000,
    0xc7f00000, 0x00000001};
    }

    const static UnicodeSet vowel_dependent_Set{const_cast<UnicodeSet::run_t *>(__vowel_dependent_Set_runs), 115, 0, const_cast<UnicodeSet::bitquad_t *>(__vowel_dependent_Set_quads), 104, 0};
    ...
    [11332, 11333], [11335, 11339], [1140e, 11434], [1148f, 114af],
    [1158e, 115ae], [1160e, 1162f], [1168a, 116aa], [116b8, 116b8],
    [11700, 1171a], [11740, 11746], [1180a, 1182b], [1190c, 11913],
    [11915, 11916], [11918, 1192f], [119ae, 119d0], [11a0b, 11a32],
    [11a5c, 11a83], [11c0e, 11c2e], [11c72, 11c8f], [11d0c, 11d30],
    [11d6c, 11d89], [11ee0, 11ef1], [11f12, 11f33]**/
    ...
    {Mixed, 1}, {Empty, 5}, {Mixed, 2}, {Empty, 6}, {Mixed, 2}, {Empty, 3},
    {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Full, 1}, {Mixed, 1}, {Empty, 11},
    {Mixed, 2}, {Empty, 1}, {Mixed, 2}, {Empty, 3}, {Mixed, 2}, {Empty, 1},
    {Mixed, 2}, {Empty, 10}, {Mixed, 3}, {Empty, 32518}};
    ...
    0x7fffffff, 0xffe00000, 0x03edfdff, 0xffffc000, 0x001fffff, 0xffff8000,
    0x0000ffff, 0xffffc000, 0x00007fff, 0xffffc000, 0x0000ffff, 0xfffffc00,
    0x010007ff, 0x07ffffff, 0x0000007f, 0xfffffc00, 0x00000fff, 0xff6ff000,
    0x0000ffff, 0xffffc000, 0x0001ffff, 0xfffff800, 0x0007ffff, 0xf0000000,
    0x0000000f, 0xffffc000, 0x00007fff, 0xfffc0000, 0x0000ffff, 0xfffff000,
    0x0001ffff, 0xfffff000, 0x000003ff, 0x0003ffff, 0xfffc0000, 0x000fffff};
    }

    const static UnicodeSet consonant_Set{const_cast<UnicodeSet::run_t *>(__consonant_Set_runs), 110, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_Set_quads), 132, 0};
    ...
    [0d4e, 0d4e], [11941, 11941], [11d46, 11d46], [11f02, 11f02]**/


    namespace {
    const static UnicodeSet::run_t __consonant_preceding_repha_Set_runs[] = {
    {Empty, 106}, {Mixed, 1}, {Empty, 2143}, {Mixed, 1}, {Empty, 31},
    {Mixed, 1}, {Empty, 13}, {Mixed, 1}, {Empty, 32519}};
    const static UnicodeSet::bitquad_t  __consonant_preceding_repha_Set_quads[] = {
    0x00004000, 0x00000002, 0x00000040, 0x00000004};
    }

    const static UnicodeSet consonant_preceding_repha_Set{const_cast<UnicodeSet::run_t *>(__consonant_preceding_repha_Set_runs), 9, 0, const_cast<UnicodeSet::bitquad_t *>(__consonant_preceding_repha_Set_quads), 4, 0};
    ...
    [0a71, 0a71], [0afb, 0afb], [11237, 11237], [11a98, 11a98]**/


    namespace {
    const static UnicodeSet::run_t __gemination_mark_Set_runs[] = {
    {Empty, 83}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 2105},
    {Mixed, 1}, {Empty, 66}, {Mixed, 1}, {Empty, 32555}};
    const static UnicodeSet::bitquad_t  __gemination_mark_Set_quads[] = {
    0x00020000, 0x08000000, 0x00800000, 0x01000000};
    }

    const static UnicodeSet gemination_mark_Set{const_cast<UnicodeSet::run_t *>(__gemination_mark_Set_runs), 9, 0, const_cast<UnicodeSet::bitquad_t *>(__gemination_mark_Set_quads), 4, 0};
    ...
    [1123e, 1123e], [11366, 1136c], [11370, 11374]**/
    ...
    0x00001fff, 0x03ff0000, 0x000003ff, 0x03ff0000};
    }

    const static UnicodeSet number_Set{const_cast<UnicodeSet::run_t *>(__number_Set_runs), 87, 0, const_cast<UnicodeSet::bitquad_t *>(__number_Set_quads), 46, 0};
