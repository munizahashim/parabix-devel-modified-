...
namespace UCD {
  namespace INPC_ns {
    ...
    [0bd8, 0bff], [0c05, 0c3b], [0c3d, 0c3d], [0c45, 0c45], [0c49, 0c49],
    [0c4e, 0c54], [0c57, 0c61], [0c64, 0c80], [0c84, 0cbb], [0cbd, 0cbd],
    [0cc5, 0cc5], [0cc9, 0cc9], [0cce, 0cd4], [0cd7, 0ce1], [0ce4, 0cff],
    [0d04, 0d3a], [0d3d, 0d3d], [0d45, 0d45], [0d49, 0d49], [0d4f, 0d56],
    [0d58, 0d61], [0d64, 0d80], [0d84, 0dc9], [0dcb, 0dce], [0dd5, 0dd5],
    [0dd7, 0dd7], [0de0, 0df1], [0df4, 0e2f], [0e3b, 0e3f], [0e46, 0e46],
    [0e4f, 0eaf], [0ebd, 0ebf], [0ec5, 0ec7], [0ece, 0f17], [0f1a, 0f34],
    [0f36, 0f36], [0f38, 0f38], [0f3a, 0f3d], [0f40, 0f70], [0f85, 0f85],
    [0f88, 0f8c], [0f98, 0f98], [0fbd, 0fc5], [0fc7, 102a], [1039, 1039],
    [103f, 1055], [105a, 105d], [1061, 1061], [1065, 1066], [106e, 1070],
    [1075, 1081], [108e, 108e], [1090, 1099], [109e, 1711], [1716, 1731],
    ...
    [1cf5, 1cf6], [1cf8, 1dfa], [1dfc, 20ef], [20f1, a801], [a803, a805],
    [a807, a80a], [a80c, a822], [a828, a82b], [a82d, a87f], [a882, a8b3],
    [a8c6, a8df], [a8f2, a8fe], [a900, a92a], [a92e, a946], [a954, a97f],
    ...
    [11047, 1106f], [11071, 11072], [11075, 1107f], [11083, 110af],
    [110bb, 110c1], [110c3, 110ff], [11103, 11126], [11133, 11133],
    ...
    {Full, 7}, {Mixed, 2}, {Full, 3}, {Mixed, 5}, {Full, 1}, {Mixed, 1},
    {Full, 12}, {Mixed, 1}, {Full, 2}, {Mixed, 2}, {Full, 3}, {Mixed, 2},
    {Full, 1}, {Mixed, 1}, {Full, 10}, {Mixed, 1}, {Full, 32520}};
    ...
    0xff0007ff, 0x1fffffff, 0xfffff000, 0xf8000fff, 0x4640ffff, 0xfffffff0,
    0x0301ffff, 0xffffffee, 0xfffff801, 0x8007ffff, 0xf001ffff, 0xfe00000f,
    0x00807fff, 0x0003ffff, 0xff800100, 0x4b81ffff, 0xffffff20, 0xff8483ff,
    0xff87ffff};
    }

    const static UnicodeSet na_Set{const_cast<UnicodeSet::run_t *>(__na_Set_runs), 95, 0, const_cast<UnicodeSet::bitquad_t *>(__na_Set_quads), 145, 0};
    ...
    [1083, 1083], [1087, 108c], [108f, 108f], [109a, 109c], [1715, 1715],
    [1734, 1734], [17b6, 17b6], [17c7, 17c8], [1923, 1924], [1929, 192b],
    [1930, 1931], [1933, 1938], [19b0, 19b4], [19b8, 19b9], [19bb, 19c0],
    [19c8, 19c9], [1a1a, 1a1a], [1a57, 1a57], [1a61, 1a61], [1a63, 1a64],
    [1a6d, 1a6d], [1b04, 1b04], [1b35, 1b35], [1b44, 1b44], [1b82, 1b82],
    [1ba1, 1ba1], [1ba7, 1ba7], [1baa, 1baa], [1be7, 1be7], [1bea, 1bec],
    [1bee, 1bee], [1bf2, 1bf3], [1c24, 1c26], [1c2a, 1c2b], [1ce1, 1ce1],
    [1cf7, 1cf7], [a823, a824], [a827, a827], [a880, a881], [a8b4, a8c3],
    [a952, a953], [a983, a983], [a9b4, a9b5], [aa33, aa33], [aa4d, aa4d],
    [aa7b, aa7b], [aa7d, aa7d], [aab1, aab1], [aaba, aaba], [aabd, aabd],
    [aaef, aaef], [aaf5, aaf5], [abe3, abe4], [abe6, abe7], [abe9, abea],
    [abec, abec], [11000, 11000], [11002, 11002], [11082, 11082],
    [110b0, 110b0], [110b2, 110b2], [110b7, 110b8], [11145, 11146],
    [11182, 11182], [111b3, 111b3], [111b5, 111b5], [111c0, 111c0],
    [1122c, 1122e], [11235, 11235], [112e0, 112e0], [112e2, 112e2],
    [11302, 11303], [1133e, 1133f], [11341, 11344], [1134d, 1134d],
    [11357, 11357], [11362, 11363], [11435, 11435], [11437, 11437],
    [11440, 11441], [11445, 11445], [114b0, 114b0], [114b2, 114b2],
    [114bd, 114bd], [114c1, 114c1], [115af, 115af], [115b1, 115b1],
    [115be, 115be], [11630, 11632], [1163b, 1163c], [1163e, 1163e],
    [116ac, 116ac], [116af, 116af], [116b6, 116b6], [11720, 11721],
    [1182c, 1182c], [1182e, 1182e], [11838, 11838], [11930, 11934],
    [1193d, 1193d], [11940, 11940], [119d1, 119d1], [119d3, 119d3],
    [119dc, 119df], [11a39, 11a39], [11a57, 11a58], [11a97, 11a97],
    ...
    {Empty, 3}, {Mixed, 2}, {Empty, 10}, {Mixed, 1}, {Empty, 3}, {Mixed, 2},
    {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 4}, {Mixed, 3},
    {Empty, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 1},
    {Empty, 5}, {Mixed, 1}, {Empty, 1113}, {Mixed, 1}, {Empty, 2},
    {Mixed, 3}, {Empty, 3}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Empty, 3},
    {Mixed, 3}, {Empty, 1}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 7},
    {Mixed, 1}, {Empty, 800}, {Mixed, 1}, {Empty, 3}, {Mixed, 2},
    {Empty, 4}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Empty, 2}, {Mixed, 1},
    ...
    {Empty, 3}, {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 1},
    ...
    0x1c009f88, 0x00200000, 0x00100000, 0x00400000, 0x00000180, 0x01fb0e18,
    0xfb1f0000, 0x00000301, 0x04000000, 0x00800000, 0x0000201a, 0x00000010,
    0x00200000, 0x00000010, 0x00000004, 0x00000482, 0x000c5c80, 0x00000c70,
    0x00800002, 0x00000098, 0x00000003, 0xfff00000, 0x0000000f, 0x000c0000,
    0x00000008, 0x00300000, 0x00080000, 0x00002000, 0x28000000, 0x24020000,
    0x00208000, 0x000016d8, 0x00000005, 0x00000004, 0x01850000, 0x00000060,
    0x00000004, 0x00280000, 0x00000001, 0x00207000, 0x00000005, 0x0000000c,
    0xc0000000, 0x0080201e, 0x0000000c, 0x00a00000, 0x00000023, 0x20050000,
    0x00000002, 0x40028000, 0x58070000, 0x00409000, 0x00000003, 0x01005000,
    0x201f0000, 0x00000001, 0xf00a0000, 0x02000000, 0x01800000, 0x00800000,
    0x40008000, 0x00100200, 0x00000040, 0x00587c00, 0x00400000};
    }

    const static UnicodeSet right_Set{const_cast<UnicodeSet::run_t *>(__right_Set_runs), 117, 0, const_cast<UnicodeSet::bitquad_t *>(__right_Set_quads), 101, 0};
    ...
    [11370, 11374], [1143e, 1143f], [11443, 11444], [1145e, 1145e],
    ...
    [11729, 1172b], [11833, 11837], [1193b, 1193c], [1193f, 1193f],
    [11941, 11941], [119da, 119db], [11a01, 11a01], [11a04, 11a09],
    [11a35, 11a38], [11a3a, 11a3a], [11a51, 11a51], [11a54, 11a56],
    [11a84, 11a89], [11a96, 11a96], [11a98, 11a98], [11c30, 11c31],
    [11c38, 11c3d], [11cb3, 11cb3], [11cb5, 11cb6], [11d31, 11d35],
    [11d3a, 11d3a], [11d3c, 11d3d], [11d3f, 11d41], [11d43, 11d43],
    [11d90, 11d91], [11d95, 11d95], [11ef3, 11ef3]**/
    ...
    {Mixed, 3}, {Empty, 1}, {Mixed, 2}, {Empty, 5}, {Mixed, 2}, {Empty, 2},
    {Mixed, 2}, {Empty, 6}, {Mixed, 1}, {Empty, 3}, {Mixed, 2}, {Empty, 2},
    {Mixed, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 7}, {Mixed, 1}, {Empty, 7},
    {Mixed, 2}, {Empty, 3}, {Mixed, 1}, {Empty, 1}, {Mixed, 3}, {Empty, 1},
    {Mixed, 1}, {Empty, 12}, {Mixed, 1}, {Empty, 3}, {Mixed, 1}, {Empty, 3},
    ...
    0x0000007c, 0x00190000, 0x00000003, 0x00600000, 0x00000007, 0x00112380,
    0x00000003, 0x70000000, 0x0000880c, 0x40d30000, 0x80000000, 0x000001e0,
    0x00000003, 0x00000001, 0x001f1fc0, 0xc0000000, 0x40000018, 0x84000000,
    0x00000001, 0x30000000, 0x26000000, 0x00000001, 0x003c2800, 0x80000000,
    0x00000e8c, 0x00f80000, 0x98000000, 0x00000002, 0x0c000000, 0x000003f2,
    0x05e00000, 0x00720000, 0x014003f0, 0x3f030000, 0x00680000, 0xb43e0000,
    0x0000000b, 0x00230000, 0x00080000};
    }

    const static UnicodeSet top_Set{const_cast<UnicodeSet::run_t *>(__top_Set_runs), 121, 0, const_cast<UnicodeSet::bitquad_t *>(__top_Set_quads), 117, 0};
    ...
    [0c62, 0c63], [0cbc, 0cbc], [0ce2, 0ce3], [0d43, 0d44], [0d62, 0d63],
    ...
    [111c9, 111ca], [111cc, 111cc], [1122f, 1122f], [112e3, 112e4],
    ...
    [11d44, 11d44], [11d47, 11d47], [11ef4, 11ef4]**/
    ...
    0x10000000, 0x0000000c, 0x00000018, 0x0000000c, 0x00500000, 0x07000000,
    ...
    0x00080000, 0x0fc00000, 0x00001600, 0x00008000, 0x00000618, 0x18000000,
    0x3f000000, 0x00000044, 0x01f80000, 0x0000000c, 0x803c0000, 0x30000001,
    0x81f80000, 0x00830000, 0x20000000, 0x00000130, 0x06078000, 0x00000008,
    0x00f00000, 0x00000001, 0x0000040c, 0x78180000, 0x0e0c0000, 0x003ffc00,
    0x807c0000, 0xfffc0000, 0x0005fcff, 0x00400000, 0x00000094, 0x00100000};
    }

    const static UnicodeSet bottom_Set{const_cast<UnicodeSet::run_t *>(__bottom_Set_runs), 113, 0, const_cast<UnicodeSet::bitquad_t *>(__bottom_Set_quads), 96, 0};
