...
namespace UCD {
  namespace INPC_ns {
    ...
    [11641, 116aa], [116b8, 1171c], [1172c, 1182b], [1183b, 1192f],
    [11936, 11936], [11939, 1193a], [1193e, 1193e], [11944, 119d0],
    [119d8, 119d9], [119e1, 119e3], [119e5, 11a00], [11a0b, 11a32],
    [11a3f, 11a50], [11a5c, 11a83], [11a99, 11c2e], [11c37, 11c37],
    [11c40, 11c91], [11ca8, 11ca8], [11cb7, 11d30], [11d37, 11d39],
    [11d3b, 11d3b], [11d3e, 11d3e], [11d45, 11d45], [11d48, 11d89],
    [11d8f, 11d8f], [11d92, 11d92], [11d97, 11ef2], [11ef7, 11eff],
    [11f04, 11f33], [11f3b, 11f3d], [11f42, 10ffff]**/
    ...
    {Full, 2}, {Mixed, 2}, {Full, 3}, {Mixed, 6}, {Full, 5}, {Mixed, 2},
    ...
    {Full, 1}, {Mixed, 1}, {Full, 10}, {Mixed, 4}, {Full, 32517}};
    ...
    0xfffff800, 0xfffffff0, 0x27ffffff, 0xff7fc660, 0xffe0e033, 0x001fffff,
    0xbfffff80, 0x0000ffff, 0xfffffff0, 0x00c07fff, 0xcffffffe, 0x0000ffff,
    0xfffffffe, 0xff0007ff, 0x1fffffff, 0xfffff000, 0xf8000fff, 0x4640ffff,
    0xfffffff0, 0x0301ffff, 0xffffffee, 0xfffff801, 0x8007ffff, 0xf001ffff,
    0xfe00000f, 0x00807fff, 0x0003ffff, 0xff800100, 0x4b81ffff, 0xffffff20,
    0xff8483ff, 0xff87ffff, 0xfffffff0, 0x380fffff, 0xfffffffc};
    }

    const static UnicodeSet na_Set{const_cast<UnicodeSet::run_t *>(__na_Set_runs), 95, 0, const_cast<UnicodeSet::bitquad_t *>(__na_Set_quads), 149, 0};
    ...
    [0d02, 0d03], [0d3e, 0d42], [0d57, 0d57], [0d82, 0d83], [0dcf, 0dd1],
    ...
    {Mixed, 1}, {Empty, 10}, {Mixed, 4}, {Empty, 32517}};
    ...
    0xc0000000, 0x00800007, 0x0000000c, 0x81038000, 0x000c0000, 0x000d0000,
    ...
    0x0000000c, 0xc0000000, 0x0080201e, 0x0000000c, 0x00a00000, 0x00000023,
    0x20050000, 0x00000002, 0x40028000, 0x58070000, 0x00409000, 0x00000003,
    0x01005000, 0x201f0000, 0x00000001, 0xf00a0000, 0x02000000, 0x01800000,
    0x00800000, 0x40008000, 0x00100200, 0x00000040, 0x00587c00, 0x00400000,
    0x00000008, 0x00300000, 0x00000002};
    }

    const static UnicodeSet right_Set{const_cast<UnicodeSet::run_t *>(__right_Set_runs), 115, 0, const_cast<UnicodeSet::bitquad_t *>(__right_Set_quads), 105, 0};
    ...
    [11cb1, 11cb1], [11ef5, 11ef5], [11f3e, 11f3f]**/
    ...
    {Empty, 17}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 32518}};
    ...
    0x00040000, 0x00000010, 0x00020000, 0x00200000, 0xc0000000};
    }

    const static UnicodeSet left_Set{const_cast<UnicodeSet::run_t *>(__left_Set_runs), 73, 0, const_cast<UnicodeSet::bitquad_t *>(__left_Set_quads), 41, 0};
    ...
    [11d90, 11d91], [11d95, 11d95], [11ef3, 11ef3], [11f00, 11f02],
    [11f36, 11f37], [11f40, 11f40]**/
    ...
    0x000001e0, 0x00000003, 0x00000001, 0x001f1fc0, 0xc0000000, 0x40000018,
    0x84000000, 0x00000001, 0x30000000, 0x26000000, 0x00000001, 0x003c2800,
    0x80000000, 0x00000e8c, 0x00f80000, 0x98000000, 0x00000002, 0x0c000000,
    0x000003f2, 0x05e00000, 0x00720000, 0x014003f0, 0x3f030000, 0x00680000,
    0xb43e0000, 0x0000000b, 0x00230000, 0x00080000, 0x00000007, 0x00c00000,
    0x00000001};
    }

    const static UnicodeSet top_Set{const_cast<UnicodeSet::run_t *>(__top_Set_runs), 121, 0, const_cast<UnicodeSet::bitquad_t *>(__top_Set_quads), 121, 0};
    ...
    [112e3, 112e4], [112e9, 112ea], [1133b, 1133c], [11438, 1143d],
    [11442, 11442], [11446, 11446], [114b3, 114b8], [114c2, 114c3],
    [115b2, 115b5], [115bf, 115c0], [115dc, 115dd], [11633, 11638],
    [1163f, 1163f], [116b0, 116b1], [116b7, 116b7], [1171d, 1171d],
    [11724, 11725], [11728, 11728], [1182f, 11832], [11839, 1183a],
    [11943, 11943], [119d4, 119d7], [119e0, 119e0], [11a02, 11a03],
    ...
    {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 32518}};
    ...
    0x18000000, 0x3f000000, 0x00000044, 0x01f80000, 0x0000000c, 0x803c0000,
    0x30000001, 0x81f80000, 0x00830000, 0x20000000, 0x00000130, 0x06078000,
    0x00000008, 0x00f00000, 0x00000001, 0x0000040c, 0x78180000, 0x0e0c0000,
    0x003ffc00, 0x807c0000, 0xfffc0000, 0x0005fcff, 0x00400000, 0x00000094,
    0x00100000, 0x07000000};
    }

    const static UnicodeSet bottom_Set{const_cast<UnicodeSet::run_t *>(__bottom_Set_runs), 115, 0, const_cast<UnicodeSet::bitquad_t *>(__bottom_Set_quads), 98, 0};
