...
namespace UCD {
  namespace AGE_ns {
    const unsigned independent_prop_values = 27;
    ...
    [1f249, 1f24f], [1f252, 1f25f], [1f266, 1f2ff], [1f6d8, 1f6db],
    [1f6ed, 1f6ef], [1f6fd, 1f6ff], [1f777, 1f77a], [1f7da, 1f7df],
    [1f7ec, 1f7ef], [1f7f1, 1f7ff], [1f80c, 1f80f], [1f848, 1f84f],
    [1f85a, 1f85f], [1f888, 1f88f], [1f8ae, 1f8af], [1f8b2, 1f8ff],
    [1fa54, 1fa5f], [1fa6e, 1fa6f], [1fa7d, 1fa7f], [1fa89, 1fa8f],
    [1fabe, 1fabe], [1fac6, 1facd], [1fadc, 1fadf], [1fae9, 1faef],
    [1faf9, 1faff], [1fb93, 1fb93], [1fbcb, 1fbef], [1fbfa, 1fffd],
    ...
    {Mixed, 1}, {Full, 9}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 1},
    {Mixed, 1}, {Empty, 1}, {Mixed, 7}, {Empty, 2}, {Mixed, 2}, {Empty, 2},
    {Mixed, 2}, {Empty, 1}, {Mixed, 3}, {Empty, 3}, {Mixed, 2}, {Empty, 1},
    {Mixed, 1}, {Full, 1}, {Mixed, 2}, {Empty, 1}, {Mixed, 5}, {Full, 4},
    {Empty, 2}, {Mixed, 2}, {Empty, 2}, {Mixed, 1}, {Full, 5}, {Empty, 1},
    {Mixed, 2}, {Full, 1}, {Empty, 2}, {Mixed, 2}, {Empty, 1}, {Mixed, 2},
    {Full, 1}, {Mixed, 3}, {Full, 5}, {Empty, 1}, {Mixed, 1}, {Full, 3},
    {Empty, 2}, {Mixed, 4}, {Full, 2}, {Mixed, 3}, {Empty, 2}, {Mixed, 1},
    {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 2}, {Full, 7}, {Mixed, 6},
    ...
    {Mixed, 3}, {Empty, 2}, {Mixed, 3}, {Full, 21}, {Empty, 2}, {Mixed, 1},
    {Full, 3}, {Empty, 2}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Full, 2},
    {Mixed, 1}, {Empty, 191}, {Mixed, 1}, {Empty, 38}, {Mixed, 1},
    {Full, 1}, {Mixed, 1}, {Full, 278}, {Mixed, 1}, {Empty, 9}, {Mixed, 3},
    ...
    {Mixed, 2}, {Full, 31}, {Mixed, 1}, {Empty, 1335}, {Full, 1},
    ...
    0x1fffffff, 0x0000ff00, 0xfc000000, 0x0000ffff, 0xfffffc00, 0x0000ffff,
    ...
    0xfffffc00, 0x00000200, 0x00800000, 0x0000ffc0, 0x0000e000, 0x00030000,
    0xff800100, 0x00000480, 0x4b800000, 0xfc00ff00, 0x00000240, 0xfe048000,
    0xfffffc00, 0xfe000000, 0x00020000, 0x38000000, 0xfc000000, 0xfffeffff,
    ...
    0x0000fc00, 0xffc0c000, 0x0400ffc0, 0x1f000004, 0xffff0000, 0xf8000000,
    ...
    0x0c00fe00, 0xfffffff0, 0x0000c000, 0x0000ff80, 0xfffffff0, 0xffc00000,
    0x00000180, 0xfffff800, 0xffffffc0, 0xfff00000, 0xfff00000, 0xff800000,
    ...
    0xc000e000, 0xffff3c00, 0x0000ffff, 0xffff8000, 0x7c000000, 0x0000ffff,
    0xfc000000, 0x80009080, 0xff800060, 0x3c00f000, 0x0001ffff, 0xffe00000,
    ...
    0xfffef000, 0x0000f000, 0xfc00ff00, 0x0000ff00, 0xfffcc000, 0xfff00000,
    0xe000c000, 0x0000fe00, 0x40000000, 0xf0003fc0, 0xfe00fe00, 0x00080000,
    0xfffff800, 0xfc00ffff, 0x3fffffff, 0xfc000000, 0xc0000000, 0x0000fffc,
    0x0000fffe, 0xc0000000, 0xc0000000, 0x3fffffff, 0x0000f800, 0xffff0000,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff,
    0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0x3fffffff, 0xfffffffd,
    0xffff0000, 0x3fffffff};
    }

    const static UnicodeSet unassigned_Set{const_cast<UnicodeSet::run_t *>(__unassigned_Set_runs), 458, 0, const_cast<UnicodeSet::bitquad_t *>(__unassigned_Set_quads), 434, 0};
