...
namespace UCD {
  namespace CCC_ns {
    ...
    [10ead, 10f45], [10f51, 10f81], [10f86, 11045], [11047, 1106f],
    [11071, 1107e], [11080, 110b8], [110bb, 110ff], [11103, 11132],
    [11135, 11172], [11174, 111bf], [111c1, 111c9], [111cb, 11234],
    [11237, 112e8], [112eb, 1133a], [1133d, 1134c], [1134e, 11365],
    [1136d, 1136f], [11375, 11441], [11443, 11445], [11447, 1145d],
    ...
    [11d98, 16aef], [16af5, 16b2f], [16b37, 16fef], [16ff2, 1bc9d],
    ...
    [1e137, 1e2ad], [1e2af, 1e2eb], [1e2f0, 1e8cf], [1e8d7, 1e943],
    [1e94b, 10ffff]**/
    ...
    {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 2}, {Mixed, 2}, {Full, 1},
    {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 5},
    {Mixed, 1}, {Full, 1}, {Mixed, 3}, {Full, 6}, {Mixed, 1}, {Full, 3},
    ...
    {Mixed, 1}, {Full, 618}, {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 37},
    {Mixed, 1}, {Full, 612}, {Mixed, 1}, {Full, 166}, {Mixed, 3}, {Full, 4},
    {Mixed, 1}, {Full, 109}, {Mixed, 2}, {Full, 7}, {Mixed, 1}, {Full, 11},
    ...
    0x00ffffff, 0x000003ff, 0x00000004, 0xefffffff, 0xffe1dfff, 0xefffffff,
    ...
    0x78ffffff, 0xffffff9f, 0xffffff0f, 0xffffe7ff, 0xfffe003f, 0xffffffc3,
    0xffffffbf, 0x7ffeffff, 0xf9ffffff, 0xfffffff8, 0xffe7ffff, 0xfff7ffff,
    0xfffffbfe, 0xff9fffff, 0xfffff9ff, 0xe7ffffff, 0xffffdfff, 0xffe0e03f,
    0xbfffffbb, 0xfffffff3, 0x7fffffff, 0xfffffffe, 0x7fffffff, 0xff3fffff,
    0xfffff7ff, 0xf9ffffff, 0x9fffffff, 0xfffffff7, 0xfffffffe, 0xffefffff,
    0xffffff7f, 0xfdffffff, 0x7fffffff, 0xffffffcb, 0xff7fffff, 0xffe0ffff,
    0xff80ffff, 0xfffcffff, 0xbfffffff, 0x07f81c1f, 0xfffff018, 0xffffc3ff,
    0xffffffe3, 0x06000080, 0xfffff824, 0xff80ffff, 0xffffbfff, 0xffff0fff,
    0xff80ffff, 0xfffff80f};
    }

    const static UnicodeSet nr_Set{const_cast<UnicodeSet::run_t *>(__nr_Set_runs), 200, 0, const_cast<UnicodeSet::bitquad_t *>(__nr_Set_quads), 146, 0};
    ...
    [112ea, 112ea], [1134d, 1134d], [11442, 11442], [114c2, 114c2],
    [115bf, 115bf], [1163f, 1163f], [116b6, 116b6], [1172b, 1172b],
    [11839, 11839], [1193d, 1193e], [119e0, 119e0], [11a34, 11a34],
    ...
    [10ae6, 10ae6], [10f46, 10f47], [10f4b, 10f4b], [10f4d, 10f50],
    ...
    {Empty, 34}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 1550},
    ...
    0x00002000, 0x04000000, 0x00000040, 0x0001e8c0, 0x00000028, 0xf8000000,
    0x00000c07, 0x007f0000};
    }

    const static UnicodeSet b_Set{const_cast<UnicodeSet::run_t *>(__b_Set_runs), 65, 0, const_cast<UnicodeSet::bitquad_t *>(__b_Set_quads), 44, 0};
    ...
    [0829, 082d], [0898, 0898], [089c, 089f], [08ca, 08ce], [08d4, 08e1],
    ...
    [10d24, 10d27], [10eab, 10eac], [10f48, 10f4a], [10f4c, 10f4c],
    [10f82, 10f82], [10f84, 10f84], [11100, 11102], [11366, 1136c],
    ...
    [1e2ae, 1e2ae], [1e2ec, 1e2ef], [1e944, 1e949]**/
    ...
    {Empty, 109}, {Mixed, 2}, {Empty, 7}, {Mixed, 1}, {Empty, 11},
    {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 50}, {Mixed, 1},
    {Empty, 30901}};
    ...
    0xa46d0000, 0x000006ab, 0x000bf800, 0xfbc00000, 0x00003eef, 0xf1000000,
    ...
    0x00000020, 0x000000f0, 0x00001800, 0x00001700, 0x00000014, 0x00000007,
    0x001f1fc0, 0x40000000, 0x007f0000, 0x000003e0, 0x00003c00, 0x0000001c,
    0xf9ffff7f, 0x000007db, 0x007f0000, 0x00004000, 0x0000f000, 0x000003f0};
    }

    const static UnicodeSet a_Set{const_cast<UnicodeSet::run_t *>(__a_Set_runs), 97, 0, const_cast<UnicodeSet::bitquad_t *>(__a_Set_quads), 66, 0};
