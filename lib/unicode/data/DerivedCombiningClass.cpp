...
namespace UCD {
  namespace CCC_ns {
    ...
    [10ead, 10efc], [10f00, 10f45], [10f51, 10f81], [10f86, 11045],
    [11047, 1106f], [11071, 1107e], [11080, 110b8], [110bb, 110ff],
    ...
    [11d46, 11d96], [11d98, 11f40], [11f43, 16aef], [16af5, 16b2f],
    ...
    {Mixed, 1}, {Full, 5}, {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 2},
    {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 2}, {Mixed, 1}, {Full, 2},
    {Mixed, 1}, {Full, 5}, {Mixed, 1}, {Full, 1}, {Mixed, 3}, {Full, 6},
    {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 6}, {Mixed, 2}, {Full, 2},
    {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 3}, {Mixed, 1}, {Full, 7},
    {Mixed, 1}, {Full, 7}, {Mixed, 2}, {Full, 4}, {Mixed, 1}, {Full, 1},
    {Mixed, 2}, {Full, 1}, {Mixed, 1}, {Full, 12}, {Mixed, 1}, {Full, 8},
    {Mixed, 1}, {Full, 1}, {Mixed, 1}, {Full, 13}, {Mixed, 1}, {Full, 604},
    ...
    0xffffffc3, 0xffffffbf, 0x7ffeffff, 0xf9ffffff, 0xfffffff8, 0xffe7ffff,
    ...
    0xff3fffff, 0xfffff7ff, 0xf9ffffff, 0x9fffffff, 0xfffffff7, 0xfffffffe,
    0xffefffff, 0xffffff7f, 0xfdffffff, 0x7fffffff, 0xffffffcb, 0xff7fffff,
    0xfffffff9, 0xffe0ffff, 0xff80ffff, 0xfffcffff, 0xbfffffff, 0x07f81c1f,
    0xfffff018, 0xffffc3ff, 0xffffffe3, 0x06000080, 0xfffff824, 0xffff7fff,
    0xff80ffff, 0xffffbfff, 0xffff0fff, 0xffff0fff, 0xff80ffff, 0xfffff80f};
    }

    const static UnicodeSet nr_Set{const_cast<UnicodeSet::run_t *>(__nr_Set_runs), 208, 0, const_cast<UnicodeSet::bitquad_t *>(__nr_Set_quads), 150, 0};
    ...
    {Mixed, 1}, {Empty, 8}, {Mixed, 1}, {Empty, 1}, {Mixed, 1}, {Empty, 13},
    {Mixed, 1}, {Empty, 32517}};
    ...
    const static UnicodeSet vr_Set{const_cast<UnicodeSet::run_t *>(__vr_Set_runs), 101, 0, const_cast<UnicodeSet::bitquad_t *>(__vr_Set_quads), 55, 0};
    ...
    [1d18a, 1d18b], [1e4ee, 1e4ee], [1e8d0, 1e8d6]**/
    ...
    {Empty, 1550}, {Mixed, 2}, {Empty, 154}, {Mixed, 1}, {Empty, 30},
    {Mixed, 1}, {Empty, 30905}};
    ...
    0xf8000000, 0x00000c07, 0x00004000, 0x007f0000};
    }

    const static UnicodeSet b_Set{const_cast<UnicodeSet::run_t *>(__b_Set_runs), 69, 0, const_cast<UnicodeSet::bitquad_t *>(__b_Set_quads), 46, 0};
    ...
    [1e130, 1e136], [1e2ae, 1e2ae], [1e2ec, 1e2ef], [1e4ef, 1e4ef],
    [1e944, 1e949]**/
    ...
    {Empty, 15}, {Mixed, 1}, {Empty, 34}, {Mixed, 1}, {Empty, 30901}};
    ...
    0x00008000, 0x000003f0};
    }

    const static UnicodeSet a_Set{const_cast<UnicodeSet::run_t *>(__a_Set_runs), 101, 0, const_cast<UnicodeSet::bitquad_t *>(__a_Set_quads), 68, 0};
