...
public:
    ...
    explicit RegionSelectionKernel(VirtualDriver & driver, Starts starts, Ends ends, StreamSet * const regionSpans);

    explicit RegionSelectionKernel(VirtualDriver & driver, Demarcators, Selectors selectors, StreamSet * const regionSpans);

    explicit RegionSelectionKernel(VirtualDriver & driver, Starts starts, Ends ends, Selectors selectors, StreamSet * const regionSpans);
