 ...
 ** ------------------------------------------------------------------------------------------------------------- */
inline Value * popCountOf(KernelBuilder & b, const unsigned fieldWidth, const unsigned numOfFields, Value * const toCount) {
 ...
 * @brief anyNonZero
 ** ------------------------------------------------------------------------------------------------------------- */
inline Value * splatCarryBit(KernelBuilder & b, const unsigned fieldWidth, const unsigned numOfFields, Value * const value) {
 ...
 ** ------------------------------------------------------------------------------------------------------------- */
void RegionSelectionKernel::generateMultiBlockLogic(KernelBuilder & b, llvm::Value * const numOfStrides) {
...
Value * RegionSelectionKernel::getRegionStarts(KernelBuilder & b, Value * const offset) const {
    if (hasIndependentStartEndStreams()) {
...
Value * RegionSelectionKernel::getNumOfRegionStarts(KernelBuilder & b) const {
    if (hasIndependentStartEndStreams()) {
...
Value * RegionSelectionKernel::getRegionEnds(KernelBuilder & b, Value * const offset) const {
    if (hasIndependentStartEndStreams()) {
...
Value * RegionSelectionKernel::getNumOfRegionEnds(KernelBuilder & b) const {
    if (hasIndependentStartEndStreams()) {
...
Value * RegionSelectionKernel::getSelectorStream(KernelBuilder & b, Value * const offset) const {
...
RegionSelectionKernel::RegionSelectionKernel(LLVMTypeSystemInterface & ts, Starts starts, Ends ends, StreamSet * const regionSpans)
: MultiBlockKernel(ts, NAME_PREFIX "A" + std::to_string(starts.Index) + "." + std::to_string(ends.Index)
// input streams
...
RegionSelectionKernel::RegionSelectionKernel(LLVMTypeSystemInterface & ts, Demarcators demarcators, Selectors selectors, StreamSet * const regionSpans)
: MultiBlockKernel(ts, NAME_PREFIX "S" + std::to_string(demarcators.Index) + "." + std::to_string(selectors.Index)
// input streams
...
RegionSelectionKernel::RegionSelectionKernel(LLVMTypeSystemInterface & ts, Starts starts, Ends ends, Selectors selectors, StreamSet * const regionSpans)
: MultiBlockKernel(ts, NAME_PREFIX "S" + std::to_string(starts.Index) + "." + std::to_string(ends.Index) + "." + std::to_string(selectors.Index)
// input streams
,{Binding{"starts", starts.Stream}
, Binding{"ends", ends.Stream}
, Binding{"selectors", selectors.Stream}}
