...
ShiftForward::ShiftForward(VirtualDriver &driver, StreamSet * inputs, StreamSet * outputs, unsigned shiftAmount)
: PabloKernel(driver, "ShftFwd" + std::to_string(outputs->getNumElements()) + "x1_by" + std::to_string(shiftAmount),
...
ShiftBack::ShiftBack(VirtualDriver &driver, StreamSet * inputs, StreamSet * outputs, unsigned shiftAmount)
: PabloKernel(driver, "ShftBack" + std::to_string(outputs->getNumElements()) + "x1_by" + std::to_string(shiftAmount),
...
IndexedAdvance::IndexedAdvance(VirtualDriver &driver, StreamSet * inputs, StreamSet * index, StreamSet * outputs, unsigned shiftAmount)
: PabloKernel(driver, "IndexedAdvance" + std::to_string(outputs->getNumElements()) + "x1_by" + std::to_string(shiftAmount),
