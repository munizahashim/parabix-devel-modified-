...
ScanIndexGenerator::ScanIndexGenerator(LLVMTypeSystemInterface & ts, StreamSet * scan, StreamSet * output)
: SingleStreamScanKernelTemplate(ts, "ScanIndexGenerator", scan)
{
