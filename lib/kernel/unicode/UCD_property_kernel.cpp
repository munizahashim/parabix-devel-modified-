...
UnicodePropertyKernelBuilder::UnicodePropertyKernelBuilder(VirtualDriver &driver, re::Name * property_value_name, StreamSet * Source, StreamSet * property, pablo::BitMovementMode mode)
: UnicodePropertyKernelBuilder(driver, property_value_name, Source, property, mode, [&]() -> std::string {
...
UnicodePropertyKernelBuilder::UnicodePropertyKernelBuilder(VirtualDriver &driver, re::Name * property_value_name, StreamSet * Source, StreamSet * property, pablo::BitMovementMode mode, std::string && propValueName)
: PabloKernel(driver,
...
UnicodePropertyBasis::UnicodePropertyBasis(VirtualDriver &driver, UCD::EnumeratedPropertyObject * enumObj, StreamSet * Source, StreamSet * PropertyBasis)
: PabloKernel(driver,
