...
void RandomStreamKernel::generateInitializeMethod(KernelBuilder & b) {
...
void RandomStreamKernel::generateDoSegmentMethod(KernelBuilder & b) {
...
RandomStreamKernel::RandomStreamKernel(KernelBuilder & b, unsigned seed, unsigned valueWidth, size_t streamLength)
