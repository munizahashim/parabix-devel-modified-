...
void MarkRepeatedHashvalue::generateMultiBlockLogic(BuilderRef b, Value * const numOfStrides) {
    ...
    // // b->CallPrintInt("phrasesProduced", phrasesProduced);
    // // b->CallPrintInt("cmpPhrasesProduced", cmpPhrasesProduced);
    ...
    // Value * strideBlockOffset = b->CreateAdd(strideNo, sz_BLOCKS_PER_STRIDE);
    ...
    // b->CallPrintInt("keyWordPos", keyWordPos);
    ...
    // b->CallPrintInt("lg.MAX_HASH_BITS", lg.MAX_HASH_BITS);
    // Value * keyLength = b->CreateAdd(b->CreateLShr(hashValue, lg.MAX_HASH_BITS), sz_PHRASE_LEN_OFFSET, "keyLength");
    // b->CallPrintInt("keyLength-old", keyLength);
    // keyLength = b->CreateSelect(b->CreateICmpULT(keyLength, b->getSize(3)), lg.LO, keyLength); >>>>>>>>>>>
    ...
    // b->CallPrintInt("lg.HALF_LENGTH", lg.HALF_LENGTH);
    // b->CallPrintInt("lg.HI", lg.HI);
    // b->CallPrintInt("lg.LO", lg.LO);
    ...
    //     b->CallPrintInt("hashcodePos", hashcodePos);
    ...
    // hashcodePos = b->CreateSub(hashcodePos, sz_ONE);
    // b->CallPrintInt("hashcodePos-last", hashcodePos);
    ...
    // b->CallPrintInt("b->CreateSub(keyLength, lg.LO)", b->CreateSub(keyLength, lg.LO));
    // Value * tableIdxHash = b->CreateAnd(b->CreateLShr(codewordVal, 8), lg.TABLE_MASK, "tableIdx");
    // b->CallPrintInt("lg.PHRASE_SUBTABLE_SIZE", lg.PHRASE_SUBTABLE_SIZE);
    // b->CallPrintInt("subTablePtr", subTablePtr);
    ...
    // b->CallPrintInt("keyLength-updated", keyLength);
    ...
    // b->CallPrintInt("phraseMarkBase", phraseMarkBase);
    ...
    // b->CallPrintInt("b->CreateSub(b->CreateShl(sz_ONE, maskLength), sz_ONE)", mask);
