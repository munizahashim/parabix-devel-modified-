...
namespace UCD {
    ...
    namespace BLK_ns {
        enum value_t {
            ...
            Linear_A, Latin_Ext_F, Cypriot_Syllabary, Imperial_Aramaic,
            ...
            Old_Turkic, Old_Hungarian, Hanifi_Rohingya, Rumi, Yezidi,
            ...
            Grantha, Newa, Tirhuta, Siddham, Modi, Mongolian_Sup, Takri,
            Ahom, Dogra, Warang_Citi, Dives_Akuru, Nandinagari,
            Zanabazar_Square, Soyombo, UCAS_Ext_A, Pau_Cin_Hau,
            Devanagari_Ext_A, Bhaiksuki, Marchen, Masaram_Gondi,
            Gunjala_Gondi, Makasar, Kawi, Lisu_Sup, Tamil_Sup, Cuneiform,
            Cuneiform_Numbers, Early_Dynastic_Cuneiform, Cypro_Minoan,
            Egyptian_Hieroglyphs, Egyptian_Hieroglyph_Format_Controls,
            Anatolian_Hieroglyphs, Bamum_Sup, Mro, Tangsa, Bassa_Vah,
            Pahawh_Hmong, Medefaidrin, Miao, Ideographic_Symbols, Tangut,
            Tangut_Components, Khitan_Small_Script, Tangut_Sup, Kana_Ext_B,
            Kana_Sup, Kana_Ext_A, Small_Kana_Ext, Nushu, Duployan,
            Shorthand_Format_Controls, Znamenny_Music, Byzantine_Music,
            Music, Ancient_Greek_Music, Kaktovik_Numerals, Mayan_Numerals,
            Tai_Xuan_Jing, Counting_Rod, Math_Alphanum, Sutton_SignWriting,
            Latin_Ext_G, Glagolitic_Sup, Cyrillic_Ext_D,
            Nyiakeng_Puachue_Hmong, Toto, Wancho, Nag_Mundari,
            Ethiopic_Ext_B, Mende_Kikakui, Adlam, Indic_Siyaq_Numbers,
            Ottoman_Siyaq_Numbers, Arabic_Math, Mahjong, Domino,
            Playing_Cards, Enclosed_Alphanum_Sup, Enclosed_Ideographic_Sup,
            ...
            CJK_Ext_I, CJK_Compat_Ideographs_Sup, CJK_Ext_G, CJK_Ext_H,
        ...
        const static std::vector<std::string> enum_names = {
            ...
            "Osage", "Elbasan", "Caucasian_Albanian", "Vithkuqi",
            ...
            "Hanifi_Rohingya", "Rumi", "Yezidi", "Arabic_Ext_C",
            ...
            "UCAS_Ext_A", "Pau_Cin_Hau", "Devanagari_Ext_A", "Bhaiksuki",
            "Marchen", "Masaram_Gondi", "Gunjala_Gondi", "Makasar", "Kawi",
            "Lisu_Sup", "Tamil_Sup", "Cuneiform", "Cuneiform_Numbers",
            "Early_Dynastic_Cuneiform", "Cypro_Minoan",
            "Egyptian_Hieroglyphs", "Egyptian_Hieroglyph_Format_Controls",
            "Anatolian_Hieroglyphs", "Bamum_Sup", "Mro", "Tangsa",
            "Bassa_Vah", "Pahawh_Hmong", "Medefaidrin", "Miao",
            ...
            "Shorthand_Format_Controls", "Znamenny_Music",
            "Byzantine_Music", "Music", "Ancient_Greek_Music",
            "Kaktovik_Numerals", "Mayan_Numerals", "Tai_Xuan_Jing",
            "Counting_Rod", "Math_Alphanum", "Sutton_SignWriting",
            "Latin_Ext_G", "Glagolitic_Sup", "Cyrillic_Ext_D",
            "Nyiakeng_Puachue_Hmong", "Toto", "Wancho", "Nag_Mundari",
            "Ethiopic_Ext_B", "Mende_Kikakui", "Adlam",
        ...
        const static std::vector<std::string> value_names = {
            ...
            "Caucasian_Albanian", "Vithkuqi", "Linear_A",
            ...
            "Dogra", "Warang_Citi", "Dives_Akuru", "Nandinagari",
            "Zanabazar_Square", "Soyombo",
            "Unified_Canadian_Aboriginal_Syllabics_Extended_A",
            "Pau_Cin_Hau", "Devanagari_Extended_A", "Bhaiksuki", "Marchen",
            "Masaram_Gondi", "Gunjala_Gondi", "Makasar", "Kawi",
            ...
            "Bamum_Supplement", "Mro", "Tangsa", "Bassa_Vah",
            ...
            "Shorthand_Format_Controls", "Znamenny_Musical_Notation",
            ...
            "Nyiakeng_Puachue_Hmong", "Toto", "Wancho", "Nag_Mundari",
            "Ethiopic_Extended_B", "Mende_Kikakui", "Adlam",
    ...
    namespace SC_ns {
        ...
        const static std::vector<std::string> value_names = {
            ...
            "Nag_Mundari", "Katakana_Or_Hiragana"};
        const static std::vector<std::string> aliases = {{
            "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
            "", "", "", "", "", "", "", "", "", "Qaai", "", "", "", "", "",
    ...
    namespace LB_ns {
        enum value_t {
            ...
            SY, NU, CL, NL, GL, AI, BB, HL, SA, JL, JV, JT, NS, AK, VI, ID,
            AS, VF, ZW, ZWJ, B2, IN, WJ, EB, CJ, H2, H3, SG, CB, AP, RI, EM};
        const static std::vector<std::string> enum_names = {
            "XX", "CM", "BA", "LF", "BK", "CR", "SP", "EX", "QU", "AL",
            "PR", "PO", "OP", "CP", "IS", "HY", "SY", "NU", "CL", "NL",
            "GL", "AI", "BB", "HL", "SA", "JL", "JV", "JT", "NS", "AK",
            "VI", "ID", "AS", "VF", "ZW", "ZWJ", "B2", "IN", "WJ", "EB",
        ...
        const static std::vector<std::string> value_names = {
            ...
            "Nonstarter", "Aksara", "Virama", "Ideographic", "Aksara_Start",
