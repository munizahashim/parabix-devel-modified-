...
namespace UCD {
    enum property_t : int {
        ...
        gc, GCB, hst, InCB, InPC, InSC, jg, jt, lb, NFC_QC, NFD_QC, NFKC_QC,
        NFKD_QC, nt, SB, vo, WB, AHex, Alpha, Bidi_C, Bidi_M, Cased, CE, CI,
        Comp_Ex, CWCF, CWCM, CWKCF, CWL, CWT, CWU, Dash, Dep, DI, Dia,
        EBase, EComp, EMod, Emoji, EPres, Ext, ExtPict, Gr_Base, Gr_Ext,
        Gr_Link, Hex, Hyphen, ID_Compat_Math_Continue, ID_Compat_Math_Start,
        IDC, Ideo, IDS, IDSB, IDST, IDSU, Join_C, LOE, Lower, Math, NChar,
