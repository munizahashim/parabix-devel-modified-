...
public:
    UTF16fieldDepositMask(VirtualDriver & driver,
...
public:
    UTF16_InitialMask(VirtualDriver & driver, kernel::StreamSet * u16final, kernel::StreamSet * u16initial);
protected:
...
public:
    UTF16_SupplementaryBasis(VirtualDriver & driver, kernel::StreamSet * u32basis, kernel::StreamSet * u16_SMP_basis);
protected:
    void generatePabloMethod() override;
};
...
public:
    UTF16assembly(VirtualDriver & driver,
