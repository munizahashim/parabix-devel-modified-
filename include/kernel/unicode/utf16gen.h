...
public:
    UTF16fieldDepositMask(LLVMTypeSystemInterface & ts,
                          kernel::StreamSet * u32basis, kernel::StreamSet * u16fieldMask, kernel::StreamSet * extractionMask,
...
public:
    UTF16_InitialMask(LLVMTypeSystemInterface & ts, kernel::StreamSet * u16final, kernel::StreamSet * u16initial);
protected:
...
public:
    UTF16_SupplementaryBasis(LLVMTypeSystemInterface & ts, kernel::StreamSet * u32basis, kernel::StreamSet * u16_SMP_basis);
protected:
    void generatePabloMethod() override;
};
...
public:
    UTF16assembly(LLVMTypeSystemInterface & ts,
